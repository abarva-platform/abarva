...
| | |
| --- | --- |
| Document ID | `CTR-MH-002-PRICING` |
...
| Incorporates | `CTR-MH-002-MSA` |

This Pricing Exhibit is incorporated into the Master Services Agreement `CTR-MH-002-MSA` at Section 4.1 of the Agreement.
...
2.2 At renewal, any increase in unit price is capped at, and shall not exceed, **4%** over the preceding term.
