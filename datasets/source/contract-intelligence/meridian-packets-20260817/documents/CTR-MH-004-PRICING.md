# Pricing Exhibit — Supply Chain Finance Erp Master Agreement
...
| | |
| --- | --- |
| Document ID | `CTR-MH-004-PRICING` |
...
This Pricing Exhibit is incorporated into the Master Services Agreement `CTR-MH-004-MSA` at Section 4.1 of the Agreement.

## 1. Rate Table

| Line | SKU | Description | Unit | Quantity | Unit Price | Annual Line Total |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `SUPPLY_CHAIN_FINAN-SUB` | Supply Chain Finance Erp subscription and production entitlements | annual subscription | 1 | $7,139,520.00 | $7,139,520.00 |
| 2 | `SUPPLY_CHAIN_FINAN-SUPPORT` | Supply Chain Finance Erp support, maintenance and service desk coverage | annual support | 1 | $1,784,880.00 | $1,784,880.00 |
| 3 | `SUPPLY_CHAIN_FINAN-SERVICES` | Supply Chain Finance Erp implementation, integration and transition services | annual services pool | 1 | $991,600.00 | $991,600.00 |
| | | | | | **Total Annual Value** | **$9,916,000.00** |
