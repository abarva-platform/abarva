...
| | |
| --- | --- |
| Document ID | `CTR-MH-001-AMEND-001` |
...
| Incorporates | `CTR-MH-001-MSA`, `CTR-MH-001-ORDER`, `CTR-MH-001-PRICING` |

This Amendment No. 1 (this "**Amendment**") is made effective as of 2027-11-30 and amends the
Master Services Agreement `CTR-MH-001-MSA` dated 2023-09-01 (the "**Agreement**").
...
1.2 Written notice of non-renewal is due by **2027-11-30**, being 367 days before expiry as required by Section 5.2 of the Agreement.
1.3 Absent such notice, the Agreement renews for a further twelve (12) months.

## 2. Amended Pricing

2.1 The annual contract value stated at Section 4.1 of the Agreement is hereby deleted in its entirety and replaced with **$89,631,360.00** for the renewal term, being an increase of 4% and the maximum permitted under Section 2.2 of the Pricing Exhibit.
...
3.1 In Section 4.2 of the Agreement, the words "net 45 days" are deleted in its entirety and replaced with "net 60 days".
