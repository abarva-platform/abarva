# Service Level Schedule — Healthcare Platform Services Master Agreement
...
This Service Level Schedule is incorporated into the Master Services Agreement `CTR-MH-001-MSA` at Section 3.1 of the Agreement.

## 1. Scope

1.1 This Schedule applies to the covered services ordered under `CTR-MH-001-ORDER`, in the production environment only.
...
| 8 hours (Sev 1) | Supplier executive sponsor and CMIO |
