# Statement of Work — Server Virtualization Master Agreement
...
| Incorporates | `CTR-MH-008-MSA`, `CTR-MH-008-ORDER` |

This Statement of Work is issued under the Master Services Agreement `CTR-MH-008-MSA` and relates to
Order Form `CTR-MH-008-ORDER`.

## 1. Objectives

1.1 Implement and operationalise the server virtualization scope described in the Order Form.
1.2 Achieve production readiness with Integrated Healthcare Demo acceptance under Section 5.

## 2. Scope

2.1 **In scope.** Configuration, integration, data migration, testing and cutover of the server virtualization scope ordered under `CTR-MH-008-ORDER`, together with knowledge transfer to Integrated Healthcare Demo operations staff.
...
4.3 The **Acceptance Authority** for this Statement of Work is the VP Nursing Informatics, or a designee named in writing. No other person may accept a deliverable.
