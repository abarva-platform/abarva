...
| | |
| --- | --- |
| Document ID | `CTR-MH-006-MSA` |
| Contract ID | `CTR-MH-006` |
| Supplier | Synthetic Healthcare Platform Services Supplier 006 LLC ("Supplier 006") |
...
This Master Services Agreement (this "**Agreement**") is entered into as of 2020-02-01 (the "**Effective Date**")
by and between Integrated Healthcare Demonstration System Inc. ("**Integrated Healthcare Demo**") and Synthetic Healthcare Platform Services Supplier 006 LLC ("**Supplier 006**").
...
B. Supplier 006 provides such capabilities and wishes to supply them under the terms below.
...
3.1 Supplier 006 shall provide the Services in accordance with the applicable Order Form, SOW and the Service Level Schedule.
3.2 Changes to scope are effected only through the change control procedure at Section 3.4.
3.3 Supplier 006 shall assign personnel with skills appropriate to the Services.
3.4 Neither party is obliged to accept a change; an unaccepted change leaves the existing scope in force.
3.5 Supplier 006 shall not subcontract any material part of the Services without Integrated Healthcare Demo's prior written consent, shall impose on each subcontractor obligations no less protective than this Agreement, and remains fully liable for the acts and omissions of its subcontractors.

## 4. Fees and Payment

4.1 Fees are set out in the Pricing Exhibit (`CTR-MH-006-PRICING`). Annual contract value at the Effective Date is **$9,311,000.00** (USD).
...
5.1 This Agreement commences on the Effective Date and continues for **94 months**, expiring on 2027-12-01 (the "**Initial Term**").
5.2 The Initial Term renews for successive twelve (12) month periods unless either party gives written notice of non-renewal at least **549 days** before expiry. The current notice deadline is **2026-05-31**.
...
7.1 Supplier 006 retains all right, title and interest in its pre-existing materials.
7.2 Integrated Healthcare Demo retains all right, title and interest in Customer Data.
7.3 Supplier 006 grants Integrated Healthcare Demo a non-exclusive licence to use deliverables for internal business purposes.

## 8. Data Protection and Security

8.1 Supplier 006 shall maintain an information security programme aligned to recognised industry standards.
8.2 The parties shall execute the Business Associate Agreement at `CTR-MH-006-BAA`, which governs all PHI. In the event of conflict regarding PHI, the Business Associate Agreement controls.
...
9.2 Supplier 006 warrants the Services will be performed in a professional and workmanlike manner.
9.3 Except as stated, all implied warranties are disclaimed to the extent permitted by law.

## 10. Indemnification

10.1 Supplier 006 shall indemnify Integrated Healthcare Demo against third-party claims that the Services infringe intellectual property rights.
10.2 The indemnified party shall give prompt notice and reasonable cooperation.

## 11. Limitation of Liability

11.1 Except for the Excluded Claims at Section 11.3, each party's aggregate liability shall not exceed **$18,622,000.00**, being 2 times the annual contract value.
...
12.1 Supplier 006 shall maintain commercial general liability and cyber liability cover of not less than **$5,000,000.00** per occurrence.
...
13.2 Integrated Healthcare Demo may audit Supplier 006's compliance not more than once per twelve (12) months on thirty (30) days notice.
13.3 Records shall be retained for the term plus three (3) years.

## 14. Transition Assistance

14.1 On expiry or termination, Supplier 006 shall provide transition assistance for up to one hundred eighty (180) days at the rates in the Pricing Exhibit.
...
| Integrated Healthcare Demonstration System Inc. | Synthetic Healthcare Platform Services Supplier 006 LLC |
| --- | --- |
