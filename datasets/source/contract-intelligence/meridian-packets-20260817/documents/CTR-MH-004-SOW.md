# Statement of Work — Supply Chain Finance Erp Master Agreement
...
| Incorporates | `CTR-MH-004-MSA`, `CTR-MH-004-ORDER` |

This Statement of Work is issued under the Master Services Agreement `CTR-MH-004-MSA` and relates to
Order Form `CTR-MH-004-ORDER`.

## 1. Objectives

1.1 Implement and operationalise the supply chain finance erp scope described in the Order Form.
1.2 Achieve production readiness with Integrated Healthcare Demo acceptance under Section 5.

## 2. Scope

2.1 **In scope.** Configuration, integration, data migration, testing and cutover of the supply chain finance erp scope ordered under `CTR-MH-004-ORDER`, together with knowledge transfer to Integrated Healthcare Demo operations staff.
...
| ---: | --- | --- | --- | --- |
| 1 | Solution design and integration plan | Written document, PDF | 2024-02-01 | Design addresses every interface listed in the Order Form; written approval by the Acceptance Authority |
| 2 | Non-production environment configured | Working environment plus written test report | 2024-04-01 | Functional test pass rate ≥ 95% with no open severity-1 defect |
| 3 | Production cutover | Working production service plus signed checklist | 2024-08-01 | Go-live checklist signed; no open Sev 1; rollback plan demonstrated |
| 4 | Post-go-live stabilisation and handover | Runbook and operations handover pack | 2024-11-01 | Two consecutive months meeting the Service Level Schedule; runbook accepted by operations |

## 4. Roles and Responsibilities

4.1 Supplier 004 is responsible for providing an engagement lead, a solution architect and implementation consultants, and for the delivery of each deliverable in Section 3.
...
4.3 The **Acceptance Authority** for this Statement of Work is the VP Data & AI Platforms, or a designee named in writing. No other person may accept a deliverable.
