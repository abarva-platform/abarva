...
| | |
| --- | --- |
| Document ID | `CTR-MH-007-PRICING` |
...
| Incorporates | `CTR-MH-007-MSA` |

This Pricing Exhibit is incorporated into the Master Services Agreement `CTR-MH-007-MSA` at Section 4.1 of the Agreement.

## 1. Rate Table

| Line | SKU | Description | Unit | Quantity | Unit Price | Annual Line Total |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HEALTHCARE_PLATFOR-SUB` | Healthcare Platform Services subscription and production entitlements | annual subscription | 1 | $6,698,160.00 | $6,698,160.00 |
| 2 | `HEALTHCARE_PLATFOR-SUPPORT` | Healthcare Platform Services support, maintenance and service desk coverage | annual support | 1 | $1,674,540.00 | $1,674,540.00 |
| 3 | `HEALTHCARE_PLATFOR-SERVICES` | Healthcare Platform Services implementation, integration and transition services | annual services pool | 1 | $930,300.00 | $930,300.00 |
| | | | | | **Total Annual Value** | **$9,303,000.00** |
