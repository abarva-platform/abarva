# Pricing Exhibit — Hr Payroll Workforce Management Master Agreement
...
| | |
| --- | --- |
| Document ID | `CTR-MH-003-PRICING` |
...
This Pricing Exhibit is incorporated into the Master Services Agreement `CTR-MH-003-MSA` at Section 4.1 of the Agreement.

## 1. Rate Table

| Line | SKU | Description | Unit | Quantity | Unit Price | Annual Line Total |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HR_PAYROLL_WORKFOR-SUB` | Hr Payroll Workforce Management subscription and production entitlements | annual subscription | 1 | $10,414,080.00 | $10,414,080.00 |
| 2 | `HR_PAYROLL_WORKFOR-SUPPORT` | Hr Payroll Workforce Management support, maintenance and service desk coverage | annual support | 1 | $2,603,520.00 | $2,603,520.00 |
| 3 | `HR_PAYROLL_WORKFOR-SERVICES` | Hr Payroll Workforce Management implementation, integration and transition services | annual services pool | 1 | $1,446,400.00 | $1,446,400.00 |
| | | | | | **Total Annual Value** | **$14,464,000.00** |
