...
This Service Level Schedule is incorporated into the Master Services Agreement `CTR-MH-007-MSA` at Section 3.1 of the Agreement.

## 1. Scope

1.1 This Schedule applies to the covered services ordered under `CTR-MH-007-ORDER`, in the production environment only.
1.2 Non-production environments are provided on a commercially reasonable basis and carry no service level.

## 2. Availability

2.1 Supplier 007 shall maintain monthly availability of at least **99.50%**.
