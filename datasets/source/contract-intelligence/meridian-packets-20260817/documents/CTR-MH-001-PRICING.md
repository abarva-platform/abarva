# Pricing Exhibit — Healthcare Platform Services Master Agreement
...
| | |
| --- | --- |
| Document ID | `CTR-MH-001-PRICING` |
...
| Incorporates | `CTR-MH-001-MSA` |

This Pricing Exhibit is incorporated into the Master Services Agreement `CTR-MH-001-MSA` at Section 4.1 of the Agreement.

## 1. Rate Table

| Line | SKU | Description | Unit | Quantity | Unit Price | Annual Line Total |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HEALTHCARE_PLATFOR-SUB` | Healthcare Platform Services subscription and production entitlements | annual subscription | 1 | $62,052,480.00 | $62,052,480.00 |
| 2 | `HEALTHCARE_PLATFOR-SUPPORT` | Healthcare Platform Services support, maintenance and service desk coverage | annual support | 1 | $15,513,120.00 | $15,513,120.00 |
| 3 | `HEALTHCARE_PLATFOR-SERVICES` | Healthcare Platform Services implementation, integration and transition services | annual services pool | 1 | $8,618,400.00 | $8,618,400.00 |
| | | | | | **Total Annual Value** | **$86,184,000.00** |
