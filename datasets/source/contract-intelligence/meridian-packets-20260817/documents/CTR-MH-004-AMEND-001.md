# Amendment No. 1 and Renewal Notice — Supply Chain Finance Erp Master Agreement
...
| | |
| --- | --- |
| Document ID | `CTR-MH-004-AMEND-001` |
...
| Incorporates | `CTR-MH-004-MSA`, `CTR-MH-004-ORDER`, `CTR-MH-004-PRICING` |

This Amendment No. 1 (this "**Amendment**") is made effective as of 2028-11-30 and amends the
Master Services Agreement `CTR-MH-004-MSA` dated 2023-12-01 (the "**Agreement**").
...
1.1 The parties confirm the Initial Term expires on 2029-12-01.
1.2 Written notice of non-renewal is due by **2028-11-30**, being 366 days before expiry as required by Section 5.2 of the Agreement.
1.3 Absent such notice, the Agreement renews for a further twelve (12) months.

## 2. Amended Pricing

2.1 The annual contract value stated at Section 4.1 of the Agreement is hereby deleted in its entirety and replaced with **$10,213,480.00** for the renewal term, being an increase of 3% and the maximum permitted under Section 2.2 of the Pricing Exhibit.
