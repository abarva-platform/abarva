# Pricing Exhibit — Server Virtualization Master Agreement
...
| | |
| --- | --- |
| Document ID | `CTR-MH-008-PRICING` |
...
This Pricing Exhibit is incorporated into the Master Services Agreement `CTR-MH-008-MSA` at Section 4.1 of the Agreement.
