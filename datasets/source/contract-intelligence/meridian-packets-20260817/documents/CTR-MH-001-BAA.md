...
This Business Associate Agreement is incorporated into the Master Services Agreement `CTR-MH-001-MSA` at Section 8.2 of the Agreement. Integrated Healthcare Demo is a Covered Entity and Supplier 001 is a Business Associate as those terms are used in the HIPAA Rules.
...
9.1 This Business Associate Agreement takes effect on 2023-09-01 and continues until all PHI is returned or destroyed under Section 10.
...
10.1 On termination, Supplier 001 shall return or destroy all PHI it still maintains in any form, and shall retain no copies, in accordance with Section 14.2 of the Agreement.
