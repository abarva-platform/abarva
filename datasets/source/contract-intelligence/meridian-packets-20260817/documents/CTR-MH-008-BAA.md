# Data Protection Exhibit — Server Virtualization Master Agreement
...
| Incorporates | `CTR-MH-008-MSA` |

This Data Protection Exhibit is incorporated into the Master Services Agreement `CTR-MH-008-MSA` at Section 8.2 of the Agreement.
