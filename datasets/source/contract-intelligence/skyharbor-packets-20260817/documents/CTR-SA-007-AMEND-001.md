# Amendment No. 1 and Renewal Notice — Flight Operations Software Master Agreement
...
| | |
| --- | --- |
| Document ID | `CTR-SA-007-AMEND-001` |
...
| Incorporates | `CTR-SA-007-MSA`, `CTR-SA-007-ORDER`, `CTR-SA-007-PRICING` |

This Amendment No. 1 (this "**Amendment**") is made effective as of 2027-03-02 and amends the
Master Services Agreement `CTR-SA-007-MSA` dated 2020-10-01 (the "**Agreement**").
...
1.1 The parties confirm the Initial Term expires on 2027-09-01.
1.2 Written notice of non-renewal is due by **2027-03-02**, being 183 days before expiry as required by Section 5.2 of the Agreement.
1.3 Absent such notice, the Agreement renews for a further twelve (12) months.

## 2. Amended Pricing

2.1 The annual contract value stated at Section 4.1 of the Agreement is hereby deleted in its entirety and replaced with **$35,020,000.00** for the renewal term, being an increase of 3% and the maximum permitted under Section 2.2 of the Pricing Exhibit.
