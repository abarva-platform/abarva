# Pricing Exhibit — Erp Software Master Agreement
...
| | |
| --- | --- |
| Document ID | `CTR-SA-004-PRICING` |
...
This Pricing Exhibit is incorporated into the Master Services Agreement `CTR-SA-004-MSA` at Section 4.1 of the Agreement.

## 1. Rate Table

| Line | SKU | Description | Unit | Quantity | Unit Price | Annual Line Total |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERP_SOFTWARE-SUB` | Erp Software subscription and production entitlements | annual subscription | 1 | $29,520,000.00 | $29,520,000.00 |
| 2 | `ERP_SOFTWARE-SUPPORT` | Erp Software support, maintenance and service desk coverage | annual support | 1 | $7,380,000.00 | $7,380,000.00 |
| 3 | `ERP_SOFTWARE-SERVICES` | Erp Software implementation, integration and transition services | annual services pool | 1 | $4,100,000.00 | $4,100,000.00 |
