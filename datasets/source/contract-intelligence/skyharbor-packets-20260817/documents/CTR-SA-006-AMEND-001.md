...
| | |
| --- | --- |
| Document ID | `CTR-SA-006-AMEND-001` |
...
| Incorporates | `CTR-SA-006-MSA`, `CTR-SA-006-ORDER`, `CTR-SA-006-PRICING` |

This Amendment No. 1 (this "**Amendment**") is made effective as of 2026-08-31 and amends the
Master Services Agreement `CTR-SA-006-MSA` dated 2023-01-01 (the "**Agreement**").
...
2.1 The annual contract value stated at Section 4.1 of the Agreement is hereby deleted in its entirety and replaced with **$41,475,000.00** for the renewal term, being an increase of 5% and the maximum permitted under Section 2.2 of the Pricing Exhibit.
