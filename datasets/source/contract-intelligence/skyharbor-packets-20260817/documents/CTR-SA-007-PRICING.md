# Pricing Exhibit — Flight Operations Software Master Agreement
...
| | |
| --- | --- |
| Document ID | `CTR-SA-007-PRICING` |
...
This Pricing Exhibit is incorporated into the Master Services Agreement `CTR-SA-007-MSA` at Section 4.1 of the Agreement.

## 1. Rate Table

| Line | SKU | Description | Unit | Quantity | Unit Price | Annual Line Total |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `FLIGHT_OPERATIONS_-SUB` | Flight Operations Software subscription and production entitlements | annual subscription | 1 | $24,480,000.00 | $24,480,000.00 |
| 2 | `FLIGHT_OPERATIONS_-SUPPORT` | Flight Operations Software support, maintenance and service desk coverage | annual support | 1 | $6,120,000.00 | $6,120,000.00 |
| 3 | `FLIGHT_OPERATIONS_-SERVICES` | Flight Operations Software implementation, integration and transition services | annual services pool | 1 | $3,400,000.00 | $3,400,000.00 |
| | | | | | **Total Annual Value** | **$34,000,000.00** |
...
2.2 At renewal, any increase in unit price is capped at, and shall not exceed, **3%** over the preceding term.
