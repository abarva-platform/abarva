# Statement of Work — Enterprise Technology Platform Services Master Agreement
...
| Incorporates | `CTR-SA-003-MSA`, `CTR-SA-003-ORDER` |

This Statement of Work is issued under the Master Services Agreement `CTR-SA-003-MSA` and relates to
Order Form `CTR-SA-003-ORDER`.

## 1. Objectives

1.1 Implement and operationalise the technology platform services scope described in the Order Form.
1.2 Achieve production readiness with Integrated Healthcare Demo acceptance under Section 5.

## 2. Scope

2.1 **In scope.** Configuration, integration, data migration, testing and cutover of the technology platform services scope ordered under `CTR-SA-003-ORDER`, together with knowledge transfer to Integrated Healthcare Demo operations staff.
...
| ---: | --- | --- | --- | --- |
| 1 | Solution design and integration plan | Written document, PDF | 2022-03-01 | Design addresses every interface listed in the Order Form; written approval by the Acceptance Authority |
| 2 | Non-production environment configured | Working environment plus written test report | 2022-05-01 | Functional test pass rate ≥ 95% with no open severity-1 defect |
| 3 | Production cutover | Working production service plus signed checklist | 2022-09-01 | Go-live checklist signed; no open Sev 1; rollback plan demonstrated |
| 4 | Post-go-live stabilisation and handover | Runbook and operations handover pack | 2022-12-01 | Two consecutive months meeting the Service Level Schedule; runbook accepted by operations |

## 4. Roles and Responsibilities

4.1 Supplier 003 is responsible for providing an engagement lead, a solution architect and implementation consultants, and for the delivery of each deliverable in Section 3.
4.2 Integrated Healthcare Demo is responsible for providing a business owner, a technical counterpart, testing resources, and timely decisions on escalated items.
4.3 The **Acceptance Authority** for this Statement of Work is the VP Infrastructure & Cloud, or a designee named in writing. No other person may accept a deliverable.
4.4 Each party shall name its responsible individuals in writing within ten (10) business days of the Effective Date.

## 5. Acceptance

5.1 Integrated Healthcare Demo shall accept or reject each deliverable within ten (10) business days of submission, acting through the Acceptance Authority named at Section 4.3.
...
6.1 **Assumption.** Integrated Healthcare Demo shall provide timely access to environments, data and subject matter experts.
