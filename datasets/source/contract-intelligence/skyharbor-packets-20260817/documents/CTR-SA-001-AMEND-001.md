# Amendment No. 1 and Renewal Notice — Passenger Service System Master Agreement
...
| | |
| --- | --- |
| Document ID | `CTR-SA-001-AMEND-001` |
...
| Incorporates | `CTR-SA-001-MSA`, `CTR-SA-001-ORDER`, `CTR-SA-001-PRICING` |

This Amendment No. 1 (this "**Amendment**") is made effective as of 2028-05-31 and amends the
Master Services Agreement `CTR-SA-001-MSA` dated 2022-01-01 (the "**Agreement**").
...
1.1 The parties confirm the Initial Term expires on 2028-12-01.
1.2 Written notice of non-renewal is due by **2028-05-31**, being 184 days before expiry as required by Section 5.2 of the Agreement.
1.3 Absent such notice, the Agreement renews for a further twelve (12) months.

## 2. Amended Pricing

2.1 The annual contract value stated at Section 4.1 of the Agreement is hereby deleted in its entirety and replaced with **$64,480,000.00** for the renewal term, being an increase of 4% and the maximum permitted under Section 2.2 of the Pricing Exhibit.
