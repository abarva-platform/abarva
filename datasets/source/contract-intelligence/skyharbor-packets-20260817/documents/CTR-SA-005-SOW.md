...
| Incorporates | `CTR-SA-005-MSA`, `CTR-SA-005-ORDER` |

This Statement of Work is issued under the Master Services Agreement `CTR-SA-005-MSA` and relates to
Order Form `CTR-SA-005-ORDER`.
...
2.1 **In scope.** Configuration, integration, data migration, testing and cutover of the managed services scope ordered under `CTR-SA-005-ORDER`, together with knowledge transfer to Integrated Healthcare Demo operations staff.
