...
| | |
| --- | --- |
| Document ID | `CTR-SA-006-PRICING` |
...
This Pricing Exhibit is incorporated into the Master Services Agreement `CTR-SA-006-MSA` at Section 4.1 of the Agreement.

## 1. Rate Table

| Line | SKU | Description | Unit | Quantity | Unit Price | Annual Line Total |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ENTERPRISE_TECHNOL-SUB` | Enterprise Technology Platform Services subscription and production entitlements | annual subscription | 1 | $28,440,000.00 | $28,440,000.00 |
| 2 | `ENTERPRISE_TECHNOL-SUPPORT` | Enterprise Technology Platform Services support, maintenance and service desk coverage | annual support | 1 | $7,110,000.00 | $7,110,000.00 |
| 3 | `ENTERPRISE_TECHNOL-SERVICES` | Enterprise Technology Platform Services implementation, integration and transition services | annual services pool | 1 | $3,950,000.00 | $3,950,000.00 |
| | | | | | **Total Annual Value** | **$39,500,000.00** |
