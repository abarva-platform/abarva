# Pricing Exhibit — Enterprise Technology Platform Services Master Agreement
...
| | |
| --- | --- |
| Document ID | `CTR-SA-003-PRICING` |
...
This Pricing Exhibit is incorporated into the Master Services Agreement `CTR-SA-003-MSA` at Section 4.1 of the Agreement.

## 1. Rate Table

| Line | SKU | Description | Unit | Quantity | Unit Price | Annual Line Total |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ENTERPRISE_TECHNOL-SUB` | Enterprise Technology Platform Services subscription and production entitlements | annual subscription | 1 | $34,560,000.00 | $34,560,000.00 |
| 2 | `ENTERPRISE_TECHNOL-SUPPORT` | Enterprise Technology Platform Services support, maintenance and service desk coverage | annual support | 1 | $8,640,000.00 | $8,640,000.00 |
| 3 | `ENTERPRISE_TECHNOL-SERVICES` | Enterprise Technology Platform Services implementation, integration and transition services | annual services pool | 1 | $4,800,000.00 | $4,800,000.00 |
| | | | | | **Total Annual Value** | **$48,000,000.00** |
...
2.2 At renewal, any increase in unit price is capped at, and shall not exceed, **5%** over the preceding term.
...
4.1 All amounts are stated in USD.
...
| Role | Rate | Unit |
| --- | ---: | --- |
| Engagement Partner | $325.00 | hour |
| Solution Architect | $275.00 | hour |
| Integration Consultant | $210.00 | hour |
| Transition Analyst | $185.00 | hour |

6.1 Professional services under a Statement of Work are charged at the rates above.
6.2 Rates are held for the Initial Term.
