# Service Level Schedule — Flight Operations Software Master Agreement
...
This Service Level Schedule is incorporated into the Master Services Agreement `CTR-SA-007-MSA` at Section 3.1 of the Agreement.

## 1. Scope

1.1 This Schedule applies to the covered services ordered under `CTR-SA-007-ORDER`, in the production environment only.
1.2 Non-production environments are provided on a commercially reasonable basis and carry no service level.

## 2. Availability

2.1 Supplier 007 shall maintain monthly availability of at least **99.95%**.
...
| --- | ---: |
| At or above 99.95% | 0% |
| Below 99.95% but at or above 99.45% | 5% |
| Below 99.45% but at or above 98.45% | 10% |
| Below 98.45% | 25% |

4.2 Aggregate credits in any contract year shall not exceed **30%** of annual fees.
...
4.4 Supplier 007 shall respond to a credit claim within fifteen (15) business days. An unanswered claim is deemed accepted.
...
| 8 hours (Sev 1) | Supplier executive sponsor and SVP Flight Operations |
...
7.1 Supplier 007 shall provide a monthly service report within ten (10) business days of month end.
