# Data Protection Exhibit — Flight Operations Software Master Agreement
...
| Incorporates | `CTR-SA-007-MSA` |

This Data Protection Exhibit is incorporated into the Master Services Agreement `CTR-SA-007-MSA` at Section 8.2 of the Agreement.
...
2.1 Supplier 007 may process Customer Data only on documented instructions from Integrated Healthcare Demo.
...
4.1 Supplier 007 shall not engage a subcontractor with access to Customer Data without imposing obligations no less protective than these.
4.2 Supplier 007 remains liable for the acts and omissions of its subcontractors.
...
8.1 Supplier 007 shall make its policies, books and records available to Integrated Healthcare Demo and, where required, to regulators.
8.2 Audit rights under Section 13.2 of the Agreement apply to this Exhibit.

## 9. Term and Termination

9.1 This Exhibit takes effect on 2020-10-01 and continues until all Customer Data is returned or destroyed under Section 10.
...
10.1 On termination, Supplier 007 shall return or destroy all Customer Data it still maintains in any form, and shall retain no copies, in accordance with Section 14.2 of the Agreement.
