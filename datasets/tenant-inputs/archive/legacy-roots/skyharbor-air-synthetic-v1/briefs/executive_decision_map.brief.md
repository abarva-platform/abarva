# Executive Decision Map Brief

Segment: S12_EXECUTIVE_DECISION_MAP

Purpose: This brief is the human-readable input used to generate the Executive Decision Map records for SkyHarbor Air, a major-carrier-shaped but fully de-identified synthetic global network carrier. It explains the narrative shape before records are emitted, so a CTO can inspect the upstream logic rather than accepting a black-box corpus.
