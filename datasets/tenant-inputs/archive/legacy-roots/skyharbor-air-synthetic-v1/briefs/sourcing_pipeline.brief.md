# Sourcing & Renewal Pipeline Brief

Segment: S15_SOURCING_PIPELINE

Purpose: This brief is the human-readable input used to generate the Sourcing & Renewal Pipeline records for SkyHarbor Air, a major-carrier-shaped but fully de-identified synthetic global network carrier. It explains the narrative shape before records are emitted, so a CTO can inspect the upstream logic rather than accepting a black-box corpus.
