# Engineering Productivity Baseline Brief

Segment: S09_ENGINEERING_PRODUCTIVITY

Purpose: This brief is the human-readable input used to generate the Engineering Productivity Baseline records for SkyHarbor Air, a major-carrier-shaped but fully de-identified synthetic global network carrier. It explains the narrative shape before records are emitted, so a CTO can inspect the upstream logic rather than accepting a black-box corpus.
