# Operational + Financial KPIs Brief

Segment: S14_OPERATIONAL_KPIS

Purpose: This brief is the human-readable input used to generate the Operational + Financial KPIs records for SkyHarbor Air, a major-carrier-shaped but fully de-identified synthetic global network carrier. It explains the narrative shape before records are emitted, so a CTO can inspect the upstream logic rather than accepting a black-box corpus.
