# Enterprise Profile Brief

Segment: S01_ENTERPRISE_PROFILE

Purpose: This brief is the human-readable input used to generate the Enterprise Profile records for SkyHarbor Air, a major-carrier-shaped but fully de-identified synthetic global network carrier. It explains the narrative shape before records are emitted, so a CTO can inspect the upstream logic rather than accepting a black-box corpus.
