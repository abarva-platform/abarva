# AWS Native Estate Brief

Segment: S04_AWS_NATIVE_ESTATE

Purpose: This brief is the human-readable input used to generate the AWS Native Estate records for SkyHarbor Air, a major-carrier-shaped but fully de-identified synthetic global network carrier. It explains the narrative shape before records are emitted, so a CTO can inspect the upstream logic rather than accepting a black-box corpus.
