# Cyber resilience board report 28
...
- Referenced application: FCF-APP-CORE-BANKING-085 (First Capital Core Banking Service 085)
- Referenced initiative: FCF-INIT-013 (Model inventory evidence automation)
- Referenced vendor: Q2, annual exposure $2362000
- Regulatory lens: OCC, FFIEC, GLBA, BSA/AML, SR 11-7 model-risk management and operational resilience.
- Evidence note: Model inventory evidence automation is tied to Finance ERP and Procurement Systems with restructure posture and board/CXO evidence requirements.
