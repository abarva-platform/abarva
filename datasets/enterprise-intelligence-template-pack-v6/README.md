...
| `templates/V6_10_ai_initiatives.csv` | ai_initiative | AI use cases, copilots, agents, adoption, model/tool usage, value, risk, readiness, and scale/hold/stop decisions. |
