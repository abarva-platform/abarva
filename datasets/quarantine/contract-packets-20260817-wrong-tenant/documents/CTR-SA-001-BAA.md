# Data Protection Exhibit — Passenger Service System Master Agreement
...
| Incorporates | `CTR-SA-001-MSA` |

This Data Protection Exhibit is incorporated into the Master Services Agreement `CTR-SA-001-MSA` at Section 8.2 of the Agreement.
...
2.1 Supplier 001 may process Customer Data only on documented instructions from Integrated Healthcare Demo.
...
4.1 Supplier 001 shall not engage a subcontractor with access to Customer Data without imposing obligations no less protective than these.
4.2 Supplier 001 remains liable for the acts and omissions of its subcontractors.
...
8.1 Supplier 001 shall make its policies, books and records available to Integrated Healthcare Demo and, where required, to regulators.
...
10.1 On termination, Supplier 001 shall return or destroy all Customer Data it still maintains in any form, and shall retain no copies, in accordance with Section 14.2 of the Agreement.
