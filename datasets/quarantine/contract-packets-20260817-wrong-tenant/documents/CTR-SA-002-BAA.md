...
| Incorporates | `CTR-SA-002-MSA` |

This Data Protection Exhibit is incorporated into the Master Services Agreement `CTR-SA-002-MSA` at Section 8.2 of the Agreement.
...
2.1 Supplier 002 may process Customer Data only on documented instructions from Integrated Healthcare Demo.
...
4.1 Supplier 002 shall not engage a subcontractor with access to Customer Data without imposing obligations no less protective than these.
4.2 Supplier 002 remains liable for the acts and omissions of its subcontractors.
...
8.1 Supplier 002 shall make its policies, books and records available to Integrated Healthcare Demo and, where required, to regulators.
...
10.1 On termination, Supplier 002 shall return or destroy all Customer Data it still maintains in any form, and shall retain no copies, in accordance with Section 14.2 of the Agreement.
