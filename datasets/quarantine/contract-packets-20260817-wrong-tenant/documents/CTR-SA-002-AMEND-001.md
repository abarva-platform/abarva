...
| | |
| --- | --- |
| Document ID | `CTR-SA-002-AMEND-001` |
...
| Incorporates | `CTR-SA-002-MSA`, `CTR-SA-002-ORDER`, `CTR-SA-002-PRICING` |

This Amendment No. 1 (this "**Amendment**") is made effective as of 2027-05-31 and amends the
Master Services Agreement `CTR-SA-002-MSA` dated 2021-01-01 (the "**Agreement**").
...
2.1 The annual contract value stated at Section 4.1 of the Agreement is hereby deleted in its entirety and replaced with **$65,100,000.00** for the renewal term, being an increase of 5% and the maximum permitted under Section 2.2 of the Pricing Exhibit.
