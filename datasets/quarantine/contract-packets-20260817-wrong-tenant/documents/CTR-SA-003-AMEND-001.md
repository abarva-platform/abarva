# Amendment No. 1 and Renewal Notice — Enterprise Technology Platform Services Master Agreement
...
| | |
| --- | --- |
| Document ID | `CTR-SA-003-AMEND-001` |
...
| Incorporates | `CTR-SA-003-MSA`, `CTR-SA-003-ORDER`, `CTR-SA-003-PRICING` |

This Amendment No. 1 (this "**Amendment**") is made effective as of 2027-05-31 and amends the
Master Services Agreement `CTR-SA-003-MSA` dated 2022-01-01 (the "**Agreement**").
...
1.1 The parties confirm the Initial Term expires on 2027-12-01.
1.2 Written notice of non-renewal is due by **2027-05-31**, being 184 days before expiry as required by Section 5.2 of the Agreement.
1.3 Absent such notice, the Agreement renews for a further twelve (12) months.

## 2. Amended Pricing

2.1 The annual contract value stated at Section 4.1 of the Agreement is hereby deleted in its entirety and replaced with **$50,400,000.00** for the renewal term, being an increase of 5% and the maximum permitted under Section 2.2 of the Pricing Exhibit.
...
3.1 In Section 4.2 of the Agreement, the words "net 30 days" are deleted in its entirety and replaced with "net 45 days".
