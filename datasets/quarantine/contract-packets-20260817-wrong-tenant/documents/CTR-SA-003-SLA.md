...
This Service Level Schedule is incorporated into the Master Services Agreement `CTR-SA-003-MSA` at Section 3.1 of the Agreement.

## 1. Scope

1.1 This Schedule applies to the covered services ordered under `CTR-SA-003-ORDER`, in the production environment only.
