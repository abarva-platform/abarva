# Statement of Work — Erp Software Master Agreement
...
| | |
| --- | --- |
| Document ID | `CTR-SA-004-SOW` |
| Contract ID | `CTR-SA-004` |
| Supplier | Synthetic Erp Software Supplier 004 LLC ("Supplier 004") |
...
| Incorporates | `CTR-SA-004-MSA`, `CTR-SA-004-ORDER` |

This Statement of Work is issued under the Master Services Agreement `CTR-SA-004-MSA` and relates to
Order Form `CTR-SA-004-ORDER`.

## 1. Objectives

1.1 Implement and operationalise the erp software scope described in the Order Form.
1.2 Achieve production readiness with Integrated Healthcare Demo acceptance under Section 5.

## 2. Scope

2.1 **In scope.** Configuration, integration, data migration, testing and cutover of the erp software scope ordered under `CTR-SA-004-ORDER`, together with knowledge transfer to Integrated Healthcare Demo operations staff.
...
4.3 The **Acceptance Authority** for this Statement of Work is the CFO, or a designee named in writing. No other person may accept a deliverable.
