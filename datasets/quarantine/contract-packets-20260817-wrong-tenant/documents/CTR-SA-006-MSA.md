...
This Master Services Agreement (this "**Agreement**") is entered into as of 2023-01-01 (the "**Effective Date**")
by and between Integrated Healthcare Demonstration System Inc. ("**Integrated Healthcare Demo**") and Synthetic Enterprise Technology Platform Services Supplier 006 LLC ("**Supplier 006**").
...
4.1 Fees are set out in the Pricing Exhibit (`CTR-SA-006-PRICING`). Annual contract value at the Effective Date is **$39,500,000.00** (USD).
...
5.1 This Agreement commences on the Effective Date and continues for **47 months**, expiring on 2026-12-01 (the "**Initial Term**").
...
8.2 The parties shall execute the Data Protection Exhibit at `CTR-SA-006-BAA`, which governs Customer Data.
...
11.1 Except for the Excluded Claims at Section 11.3, each party's aggregate liability shall not exceed **$79,000,000.00**, being 2 times the annual contract value.
...
| Integrated Healthcare Demonstration System Inc. | Synthetic Enterprise Technology Platform Services Supplier 006 LLC |
| --- | --- |
