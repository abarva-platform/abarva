# Pricing Exhibit — Managed Operations Services Master Agreement
...
| | |
| --- | --- |
| Document ID | `CTR-SA-008-PRICING` |
...
This Pricing Exhibit is incorporated into the Master Services Agreement `CTR-SA-008-MSA` at Section 4.1 of the Agreement.

## 1. Rate Table

| Line | SKU | Description | Unit | Quantity | Unit Price | Annual Line Total |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MANAGED_OPERATIONS-SUB` | Managed Operations Services subscription and production entitlements | annual subscription | 1 | $24,120,000.00 | $24,120,000.00 |
| 2 | `MANAGED_OPERATIONS-SUPPORT` | Managed Operations Services support, maintenance and service desk coverage | annual support | 1 | $6,030,000.00 | $6,030,000.00 |
| 3 | `MANAGED_OPERATIONS-SERVICES` | Managed Operations Services implementation, integration and transition services | annual services pool | 1 | $3,350,000.00 | $3,350,000.00 |
| | | | | | **Total Annual Value** | **$33,500,000.00** |
