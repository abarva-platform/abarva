# Statement of Work — Passenger Service System Master Agreement
...
| Incorporates | `CTR-SA-001-MSA`, `CTR-SA-001-ORDER` |

This Statement of Work is issued under the Master Services Agreement `CTR-SA-001-MSA` and relates to
Order Form `CTR-SA-001-ORDER`.

## 1. Objectives

1.1 Implement and operationalise the passenger service system scope described in the Order Form.
1.2 Achieve production readiness with Integrated Healthcare Demo acceptance under Section 5.

## 2. Scope

2.1 **In scope.** Configuration, integration, data migration, testing and cutover of the passenger service system scope ordered under `CTR-SA-001-ORDER`, together with knowledge transfer to Integrated Healthcare Demo operations staff.
...
4.1 Supplier 001 is responsible for providing an engagement lead, a solution architect and implementation consultants, and for the delivery of each deliverable in Section 3.
...
4.3 The **Acceptance Authority** for this Statement of Work is the VP Distribution & E-Commerce, or a designee named in writing. No other person may accept a deliverable.
