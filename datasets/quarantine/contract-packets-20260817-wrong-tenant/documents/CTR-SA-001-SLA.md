# Service Level Schedule — Passenger Service System Master Agreement
...
This Service Level Schedule is incorporated into the Master Services Agreement `CTR-SA-001-MSA` at Section 3.1 of the Agreement.

## 1. Scope

1.1 This Schedule applies to the covered services ordered under `CTR-SA-001-ORDER`, in the production environment only.
1.2 Non-production environments are provided on a commercially reasonable basis and carry no service level.

## 2. Availability

2.1 Supplier 001 shall maintain monthly availability of at least **99.90%**.
...
4.4 Supplier 001 shall respond to a credit claim within fifteen (15) business days. An unanswered claim is deemed accepted.
...
| 8 hours (Sev 1) | Supplier executive sponsor and VP Distribution & E-Commerce |
...
7.1 Supplier 001 shall provide a monthly service report within ten (10) business days of month end.
