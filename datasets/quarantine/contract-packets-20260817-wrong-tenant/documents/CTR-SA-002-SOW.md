...
| Incorporates | `CTR-SA-002-MSA`, `CTR-SA-002-ORDER` |

This Statement of Work is issued under the Master Services Agreement `CTR-SA-002-MSA` and relates to
Order Form `CTR-SA-002-ORDER`.
...
2.1 **In scope.** Configuration, integration, data migration, testing and cutover of the managed services scope ordered under `CTR-SA-002-ORDER`, together with knowledge transfer to Integrated Healthcare Demo operations staff.
...
4.3 The **Acceptance Authority** for this Statement of Work is the VP In-Flight Services, or a designee named in writing. No other person may accept a deliverable.
