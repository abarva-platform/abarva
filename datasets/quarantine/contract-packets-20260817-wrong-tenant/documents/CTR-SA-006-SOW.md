...
| Incorporates | `CTR-SA-006-MSA`, `CTR-SA-006-ORDER` |

This Statement of Work is issued under the Master Services Agreement `CTR-SA-006-MSA` and relates to
Order Form `CTR-SA-006-ORDER`.
...
2.1 **In scope.** Configuration, integration, data migration, testing and cutover of the technology platform services scope ordered under `CTR-SA-006-ORDER`, together with knowledge transfer to Integrated Healthcare Demo operations staff.
...
| ---: | --- | --- | --- | --- |
| 1 | Solution design and integration plan | Written document, PDF | 2023-03-01 | Design addresses every interface listed in the Order Form; written approval by the Acceptance Authority |
| 2 | Non-production environment configured | Working environment plus written test report | 2023-05-01 | Functional test pass rate ≥ 95% with no open severity-1 defect |
| 3 | Production cutover | Working production service plus signed checklist | 2023-09-01 | Go-live checklist signed; no open Sev 1; rollback plan demonstrated |
| 4 | Post-go-live stabilisation and handover | Runbook and operations handover pack | 2023-12-01 | Two consecutive months meeting the Service Level Schedule; runbook accepted by operations |
