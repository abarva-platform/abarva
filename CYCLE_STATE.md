...
- Current objective: keep Source deterministic, bridge Admin/Setup readiness into Source as a read-only contract, and make progress against 100% visible without implying live upload/parsing or production readiness.
- Current item: Admin/Setup-to-Source readiness contract batch state update.
