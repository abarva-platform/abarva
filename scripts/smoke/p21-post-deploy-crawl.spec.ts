...
assert.match(atlasGauntletHarness, /ACTIVE_TENANTS/);
assert.match(atlasGauntletHarness, /PROOF_READY_SMOKE_TENANT_SLUGS/);
assert.match(atlasGauntletHarness, /ATLAS_GAUNTLET_INCLUDE_APEX/);
assert.match(atlasGauntletHarness, /meridian-health/);
assert.match(atlasGauntletHarness, /skyharbor-air/);
