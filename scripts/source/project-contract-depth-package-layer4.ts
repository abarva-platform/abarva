...
async function rebuildViews(client: Client): Promise<void> {
  ...
  await client.query(`
    ...
    SELECT
      ...
      c.actual_annual_spend::numeric(18,2) AS actual_annual_spend,
      c.committed_annual_spend::numeric(18,2) AS committed_annual_spend,
  ...
  await client.query(`
    ...
    SELECT
      ...
      o.paid_amount,
      o.actual_spend,
      NULL::numeric AS consumed_amount,
