...
function main() {
  ...
  const report = {
    ...
    sourceSha,
    sourceWorktree: "current_worktree",
    mode: "report_only_no_data_mutation_no_registry_activation_no_graph_materialization_no_projection_refresh",
    publicDisclosure: "Tenant identifiers are anonymized in this report. Evidence paths are operator-supplied artifacts from the current worktree.",
    evidence: {
      ...
      layerRefreshArtifact: layerDir,
      graphReconciliationArtifact: graphDir,
    },
    answer: {
