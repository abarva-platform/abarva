...
const TENANTS = {
  ...
  meridian:   { id: '6e419b6e-950d-4d34-a4fc-06c3e451a6c4', name: 'Healthcare Composite Demo Tenant', spec: { applications: 140, ai_initiatives: 42, vendor_contracts: 50, enterprise_context_source_files: 48, enterprise_context_chunks: 320, teams: 16 } },
