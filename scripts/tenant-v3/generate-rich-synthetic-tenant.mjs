...
function writeReleaseRecord(results) {
  const lines = [
    ...
    "- Runtime: no runtime path is changed.",
    ...
    "## Rollout Plan",
    "",
    "Merge only. Candidate Azure/Postgres persistence requires a separately approved non-prod target and guarded write execution. Active promotion is out of scope.",
    "",
