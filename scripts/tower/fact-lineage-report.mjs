...
// Tenant key -> directory in each tree. Explicit because the two trees disagree
// on tenant naming, which is itself part of the lineage problem.
const TENANTS = [
  { key: "skyharbor-air", std: "skyharbor-air", v3: "skyharbor-air" },
  { key: "meridian-health", std: "meridian-health", v3: "meridian-health" },
  { key: "first-capital", std: "first-capital-financial", v3: "first-capital" },
  { key: "lakeshore-holdings", std: "lakeshore-industries", v3: "lakeshore-holdings" },
  { key: "apex-retail", std: "apex-retail", v3: "apex-retail" },
];
...
const METRICS = [
  {
    ...
    sources: [
      ...
      ["v3", "08_it_budget_spend_value.csv", "budget_amount_usd", "sum"],
      ["v3", "08_it_budget_spend_value.csv", "approved_budget_usd", "sum"],
      ["v3", "SA02_IT_Finance_Budget_Spend_Extract.csv", "budget_amount_usd", "sum"],
    ],
  },
  {
    ...
    sources: [
      ...
      ["v3", "08_it_budget_spend_value.csv", "ai_tagged_budget_usd", "sum"],
    ],
  },
  {
    ...
    sources: [
      ...
      ["v3", "SA04_Program_Portfolio_Extract.csv", "approved_funding_usd", "sum"],
      ["v3", "09_programs_initiatives.csv", "approved_funding_usd", "sum"],
    ],
  },
  {
    ...
    sources: [
      ...
      ["v3", "SA08_AI_Benefits_Realization_Usage_Ledger.csv", "promised_value_usd", "sum"],
    ],
  },
  {
    ...
    sources: [
      ...
      ["v3", "SA09_AI_Tool_Usage_Feed.csv", "monthly_cost_usd", "sum"],
    ],
  },
  {
    ...
    sources: [
      ...
      ["v3", "07_vendors_contracts.csv", "annual_contract_value_usd", "sum"],
    ],
  },
];
...
function resolve(tree, tenant, rel) {
  if (tree === "std") return path.join(ROOT, "tower-standardized-v1", tenant.std, rel);
  return path.join(ROOT, "datasets/tenant-inputs", tenant.v3, "standard-2026-07-v3", rel);
}
