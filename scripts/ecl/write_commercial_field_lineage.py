...
PROMOTED_FIELDS = {
    ...
    "source_vendor_response_tracker.csv": {
        "sourcing_event_key": [("ecl_projection.source_event_workspace", "event_key")],
        "contract_id": [("ecl_review.review_event", "subject_contract_id FK"), ("ecl_projection.source_event_workspace", "contract_id FK")],
        "response_id": [("ecl_review.review_event", "new_value_json.response_id"), ("ecl_projection.source_event_workspace", "decision_context_json.response_id")],
        "response_vendor_id": [("ecl_context.object", "object_key"), ("ecl_projection.source_event_workspace", "vendor_object_id FK")],
        "response_vendor_name": [("ecl_context.object", "display_name"), ("ecl_projection.source_event_workspace", "decision_context_json.response_vendor_name")],
        "response_status": [("ecl_projection.source_event_workspace", "decision_context_json.response_status")],
        "annual_price_usd": [("ecl_projection.source_event_workspace", "decision_context_json.annual_price_usd")],
        "baseline_annual_price_usd": [("ecl_projection.source_event_workspace", "decision_context_json.baseline_annual_price_usd")],
        "savings_vs_baseline_usd": [("ecl_projection.source_event_workspace", "decision_context_json.savings_vs_baseline_usd")],
        "exception_count": [("ecl_projection.source_event_workspace", "decision_context_json.exception_count")],
        "rank": [("ecl_review.review_event", "new_value_json.rank"), ("ecl_projection.source_event_workspace", "decision_context_json.rank")],
        "primary_exception": [("ecl_projection.source_event_workspace", "decision_context_json.primary_exception")],
        "recommended_position": [("ecl_projection.source_event_workspace", "gap_flags_json and decision_context_json.recommended_position")],
        "review_state": [("ecl_projection.source_event_workspace", "decision_context_json.review_state")],
    },
    "source_pricing_response_lines.csv": {
        "sourcing_event_key": [("ecl_projection.source_event_workspace", "event_key through response_id")],
        "response_id": [("ecl_projection.source_event_workspace", "source_refs_json through response tracker")],
        "contract_id": [("ecl_projection.source_event_workspace", "contract_id FK")],
        "response_vendor_id": [("ecl_projection.source_event_workspace", "vendor_object_id FK")],
        "service_tower_id": [("ecl_projection.source_event_workspace", "source_refs_json pricing evidence")],
        "annual_price_usd": [("ecl_projection.source_event_workspace", "decision_context_json.annual_price_usd rollup evidence")],
        "baseline_annual_price_usd": [("ecl_projection.source_event_workspace", "decision_context_json.baseline_annual_price_usd rollup evidence")],
        "delta_vs_baseline_usd": [("ecl_projection.source_event_workspace", "decision_context_json.savings_vs_baseline_usd rollup evidence")],
        "review_state": [("ecl_projection.source_event_workspace", "decision_context_json.review_state")],
    },
    "source_evaluation_scorecard.csv": {
        ...
        "contract_id": [("ecl_projection.source_event_workspace", "contract_id FK")],
        "response_vendor_id": [("ecl_projection.source_event_workspace", "vendor_object_id FK")],
        "commercial_score": [("ecl_projection.source_event_workspace", "decision_context_json.commercial_score")],
        "delivery_score": [("ecl_projection.source_event_workspace", "decision_context_json.delivery_score")],
        "risk_score": [("ecl_projection.source_event_workspace", "decision_context_json.risk_score")],
        "overall_score": [("ecl_projection.source_event_workspace", "decision_context_json.overall_score")],
        "rank": [("ecl_review.review_event", "new_value_json.rank"), ("ecl_projection.source_event_workspace", "decision_context_json.rank")],
        "scorecard_basis": [("ecl_review.review_event", "new_value_json.response_basis")],
        "review_state": [("ecl_projection.source_event_workspace", "decision_context_json.review_state")],
    },
}
