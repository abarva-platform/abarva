...
PROMOTED_FIELDS = {
    "contract_register.csv": {
        ...
        "annual_value_usd": [("ecl_commercial.contract", "annualized_value_usd"), ("ecl_context.measure", "annual_contract_value_usd")],
    ...
    "contract_scope_application_links.csv": {
        ...
        "allocation_percent": [("ecl_commercial.contract_scope", "allocation_percent")],
    ...
    "source_market_benchmark_rates.csv": {
        ...
        "market_variance_usd": [("ecl_context.measure", "market_benchmark_variance_usd")],
        "market_variance_pct": [("ecl_context.measure", "market_benchmark_variance_percent")],
    ...
    "source_ap_po_invoice_lines.csv": {
        ...
        "invoice_amount_usd": [("ecl_commercial.invoice_line", "invoice_amount_usd"), ("ecl_context.measure", "invoice_amount_usd")],
    ...
    "contract_commercial_protection_assessment.csv": {
        ...
        "protection_score": [("ecl_context.measure", "commercial_protection_score"), ("ecl_projection.cube_slice_metric", "metric_key")],
        "notice_window_days": [("ecl_context.measure", "notice_window_days"), ("ecl_projection.cube_slice_metric", "metric_key")],
        "estimated_tfc_cost_usd": [("ecl_context.measure", "estimated_tfc_cost_usd"), ("ecl_projection.cube_slice_metric", "metric_key")],
        "minimum_commitment_usd": [("ecl_context.measure", "minimum_commitment_usd")],
        "modeled_shortfall_exposure_usd": [("ecl_context.measure", "modeled_shortfall_exposure_usd"), ("ecl_projection.cube_slice_metric", "metric_key")],
        "primary_weakness": [("ecl_projection.source_contract_360", "risk_control_json.primary_weakness"), ("ecl_projection.tower_command_center", "gate_reason_json")],
        "review_state": [("ecl_context.measure", "review_state")],
    },
}
