...
ROWS: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "projection_field_path": "not_available",
        "source_extracts": "future sourcing_event_register.csv; future vendor_response_tracker.csv; future event_evidence_inventory.csv",
        "ecl_tables": "ecl_context.object; ecl_context.relationship; ecl_review.review_event",
        "basis_rule": "Events require declared workflow objects and review events; do not synthesize event status from contract age.",
        "missing_data_behavior": "Render the tab as not yet supplied with required extracts and no empty event list.",
        "page_render_obligation": "Refuse/gate page until source_event_workspace projection exists.",
        "next_required_builder": "source_event_workspace_builder",
    ...
    },
    {
        ...
        "projection_table": "ecl_projection.source_event_workspace",
        "projection_field_path": "not_available",
        "source_extracts": "future vendor_response_tracker.csv; future pricing_response_lines.csv; future evaluation_scorecard.csv",
        ...
        "missing_data_behavior": "Render missing response pack and no recommendation.",
        "page_render_obligation": "Gate comparison until response facts and review state exist.",
        "next_required_builder": "source_event_workspace_builder",
        "route_status": "deferred",
    },
    {
        ...
        "missing_data_behavior": "Render gated value reasons; never total blocked value as achieved savings.",
        "page_render_obligation": "Show claimable, gated, and evidence-needed values separately.",
        "next_required_builder": "source_value_levers_builder",
        "route_status": "deferred",
    },
    {
        ...
        "projection_table": "ecl_projection.source_event_workspace",
        "projection_field_path": "not_available",
        "source_extracts": "future review_queue_export.csv; future owner_attestation_log.csv",
        ...
        "missing_data_behavior": "Render review queue unavailable with evidence requirements.",
        "page_render_obligation": "Gate approvals until review_event producer exists.",
        "next_required_builder": "source_review_event_builder",
        "route_status": "deferred",
    },
    {
        ...
        "missing_data_behavior": "Render proposed opportunities as provisional and evidence-needed.",
        "page_render_obligation": "Show opportunity basis, confidence, and next evidence request.",
        "next_required_builder": "source_value_levers_builder",
        "route_status": "deferred",
    },
]
