...
select jsonb_pretty(jsonb_build_object(
  ...
  'application', (select count(*) from ecl_context.object where object_type = 'application'),
  'application_deployment', (select count(*) from ecl_context.object where object_type = 'application_deployment'),
  'vendor', (select count(*) from ecl_context.object where object_type = 'vendor'),
  'data_platform', (select count(*) from ecl_context.object where object_type = 'data_platform'),
