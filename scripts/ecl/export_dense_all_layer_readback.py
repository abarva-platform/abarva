...
def layer_counts(flat: dict[str, int]) -> dict[str, dict[str, int]]:
    return {
        ...
        "context": {
            ...
            "document": flat.get("document", 0),
            "document_extraction": flat.get("document_extraction", 0),
            "object_type_catalog": flat.get("object_type_catalog", 0),
        ...
        "projection": {
            ...
            "projection_entry": flat.get("projection_entry", 0),
            "projection_entry_object_ref": flat.get("projection_entry_object_ref", 0),
            "projection_entry_metric_ref": flat.get("projection_entry_metric_ref", 0),
            "projection_entry_measure_ref": flat.get("projection_entry_measure_ref", 0),
            "projection_entry_relationship_ref": flat.get("projection_entry_relationship_ref", 0),
            "projection_entry_source_record_ref": flat.get("projection_entry_source_record_ref", 0),
            "projection_entry_document_extraction_ref": flat.get("projection_entry_document_extraction_ref", 0),
            ...
            "tower_value_chain": flat.get("tower_value_chain", 0),
            "tower_evidence_queue": flat.get("tower_evidence_queue", 0),
            "tower_ai_portfolio": flat.get("tower_ai_portfolio", 0),
            "intelligence_context_pack": flat.get("intelligence_context_pack", 0),
            "intelligence_pattern_evidence": flat.get("intelligence_pattern_evidence", 0),
            "intelligence_question_context": flat.get("intelligence_question_context", 0),
            "serving_contract_rows": flat.get("serving_contract_rows", 0),
            ...
            "projection_entry_count_drift": flat.get("projection_entry_count_drift", 0),
            "projection_surface_entry_drift": flat.get("projection_surface_entry_drift", 0),
            "projection_entry_metric_ref_drift": flat.get("projection_entry_metric_ref_drift", 0),
            "projection_entry_object_ref_drift": flat.get("projection_entry_object_ref_drift", 0),
            "projection_entry_source_record_ref_drift": flat.get("projection_entry_source_record_ref_drift", 0),
            ...
            "home_application_count_basis_drift": flat.get("home_application_count_basis_drift", 0),
            "home_application_page_deployment_rows": flat.get("home_application_page_deployment_rows", 0),
            ...
            "tower_value_chain_gated_without_reason": flat.get("tower_value_chain_gated_without_reason", 0),
            "tower_value_chain_measure_drift": flat.get("tower_value_chain_measure_drift", 0),
            "tower_evidence_queue_missing_gate_payload": flat.get("tower_evidence_queue_missing_gate_payload", 0),
            "tower_evidence_queue_measure_drift": flat.get("tower_evidence_queue_measure_drift", 0),
            "tower_ai_primary_object_drift": flat.get("tower_ai_primary_object_drift", 0),
            ...
            "intelligence_pattern_primary_object_drift": flat.get("intelligence_pattern_primary_object_drift", 0),
            "intelligence_question_context_pack_drift": flat.get("intelligence_question_context_pack_drift", 0),
        },
        "cube": {
