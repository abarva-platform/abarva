...
const modules = [
  ...
  },
  {
    ...
    legacyDependency: "Source write seams are tenant-guarded; old SkyHarbor-specific routes remain disabled/unavailable for Airline until certified",
    evidence: [
      evidence(
    ...
    nextAction: "Certify Source runtime routes and prove old fixture/default routes fail explicitly for Airline.",
  },
  {
    module: "Tower",
    classification: "partially_migrated_legacy_operational_risk",
    ...
    legacyDependency: "Aggregate/enterprise-summary seams are tenant-guarded; seeded deterministic Tower views remain to be disabled or proven unavailable for Airline",
    evidence: [
      evidence(
    ...
    nextAction: "Certify Tower runtime routes and disable or prove unavailable any seeded deterministic Tower views for Airline.",
  },
  {
