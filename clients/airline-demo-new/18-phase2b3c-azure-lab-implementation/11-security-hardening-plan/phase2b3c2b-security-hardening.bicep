...
var jobs = [
  { name: 'job-airdn-source-register-lab', process: 'airline-demo-new-source-register-v1', identityName: 'mi-airdn-ingest-lab-001', stage: '01_register_source' }
  { name: 'job-airdn-source-parse-lab', process: 'airline-demo-new-source-parse-v1', identityName: 'mi-airdn-ingest-lab-001', stage: '03_parse_source' }
  { name: 'job-airdn-evidence-extract-lab', process: 'airline-demo-new-evidence-extract-v1', identityName: 'mi-airdn-ingest-lab-001', stage: '04_extract_evidence' }
  { name: 'job-airdn-normalize-lab', process: 'airline-demo-new-knowledge-normalize-v1', identityName: 'mi-airdn-ingest-lab-001', stage: '05_normalize_values' }
  { name: 'job-airdn-entity-resolve-lab', process: 'airline-demo-new-entity-resolve-v1', identityName: 'mi-airdn-ingest-lab-001', stage: '06_resolve_identity' }
  { name: 'job-airdn-validate-lab', process: 'airline-demo-new-knowledge-validate-v1', identityName: 'mi-airdn-ingest-lab-001', stage: '07_validate_semantics' }
  { name: 'job-airdn-review-apply-lab', process: 'airline-demo-new-knowledge-review-v1', identityName: 'mi-airdn-review-lab-001', stage: '09_route_review_quarantine' }
  { name: 'job-airdn-domain-publish-lab', process: 'airline-demo-new-domain-publish-v1', identityName: 'mi-airdn-publish-lab-001', stage: '11_publish_domain' }
  { name: 'job-airdn-baseline-publish-lab', process: 'airline-demo-new-baseline-publish-v1', identityName: 'mi-airdn-publish-lab-001', stage: '12_publish_baseline' }
  { name: 'job-airdn-projection-build-lab', process: 'airline-demo-new-projection-build-v1', identityName: 'mi-airdn-publish-lab-001', stage: '13_build_module_projections' }
...
resource ingestIdentity 'Microsoft.ManagedIdentity/userAssignedIdentities@2023-01-31' existing = { name: 'mi-airdn-ingest-lab-001' }
resource reviewIdentity 'Microsoft.ManagedIdentity/userAssignedIdentities@2023-01-31' existing = { name: 'mi-airdn-review-lab-001' }
resource publishIdentity 'Microsoft.ManagedIdentity/userAssignedIdentities@2023-01-31' existing = { name: 'mi-airdn-publish-lab-001' }
resource readIdentity 'Microsoft.ManagedIdentity/userAssignedIdentities@2023-01-31' existing = { name: 'mi-airdn-read-lab-001' }
resource evaluatorIdentity 'Microsoft.ManagedIdentity/userAssignedIdentities@2023-01-31' existing = { name: 'mi-airdn-evaluator-lab-001' }

resource rawIngestWrite 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  scope: rawContainer
  name: guid(rawContainer.id, 'mi-airdn-ingest-lab-001', blobContributorRole, tenantKey)
  properties: {
...
resource publishedPublishRead 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  ...
  name: guid(publishedContainer.id, 'mi-airdn-publish-lab-001', blobReaderRole, tenantKey)
  properties: {
...
resource publishedRuntimeRead 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  scope: publishedContainer
  name: guid(publishedContainer.id, 'mi-airdn-read-lab-001', blobReaderRole, tenantKey)
  properties: {
...
resource publishedEvaluatorRead 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  scope: publishedContainer
  name: guid(publishedContainer.id, 'mi-airdn-evaluator-lab-001', blobReaderRole, tenantKey)
  properties: {
...
resource auditEvaluatorWrite 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  ...
  name: guid(auditContainer.id, 'mi-airdn-evaluator-lab-001', blobContributorRole, tenantKey)
  properties: {
    principalId: evaluatorIdentity.properties.principalId
    principalType: 'ServicePrincipal'
    roleDefinitionId: blobContributorRole
...
resource evaluatorTruthAccess 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  ...
  name: guid(evaluatorHiddenTruth.id, 'mi-airdn-evaluator-lab-001', blobReaderRole, tenantKey)
  properties: {
    principalId: evaluatorIdentity.properties.principalId
    principalType: 'ServicePrincipal'
    roleDefinitionId: blobReaderRole
...
resource evaluatorProofAccess 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  ...
  name: guid(evaluatorReconstruction.id, 'mi-airdn-evaluator-lab-001', blobContributorRole, tenantKey)
  properties: {
    principalId: evaluatorIdentity.properties.principalId
    principalType: 'ServicePrincipal'
    roleDefinitionId: blobContributorRole
...
resource keyVaultIngestSecretUser 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  scope: keyVault
  name: guid(keyVault.id, 'mi-airdn-ingest-lab-001', keyVaultSecretsUserRole, tenantKey)
  properties: {
    principalId: ingestIdentity.properties.principalId
    principalType: 'ServicePrincipal'
...
resource keyVaultReviewSecretUser 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  scope: keyVault
  name: guid(keyVault.id, 'mi-airdn-review-lab-001', keyVaultSecretsUserRole, tenantKey)
  properties: {
...
resource keyVaultPublishSecretUser 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  scope: keyVault
  name: guid(keyVault.id, 'mi-airdn-publish-lab-001', keyVaultSecretsUserRole, tenantKey)
  properties: {
    principalId: publishIdentity.properties.principalId
    principalType: 'ServicePrincipal'
    roleDefinitionId: keyVaultSecretsUserRole
...
resource keyVaultEvaluatorSecretUser 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  scope: keyVault
  name: guid(keyVault.id, 'mi-airdn-evaluator-lab-001', keyVaultSecretsUserRole, tenantKey)
  properties: {
    principalId: evaluatorIdentity.properties.principalId
    principalType: 'ServicePrincipal'
    roleDefinitionId: keyVaultSecretsUserRole
