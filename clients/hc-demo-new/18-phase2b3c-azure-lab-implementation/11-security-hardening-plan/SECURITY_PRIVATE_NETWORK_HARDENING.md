...
- Operational storage: `stabhcdemonewlab001`
- Evaluator-only storage: `stabhcdemonewevallab001`
- Database: `abarva_hc_demo_new_knowledge_lab`
- Key Vault: `kv-abarva-hcdn-lab-001`
- Container Apps environment: `cae-abarva-hcdn-lab-eus-001`
...
1. Run global name checks for `stabhcdemonewlab001`, `stabhcdemonewevallab001`, and `kv-abarva-hcdn-lab-001`.
