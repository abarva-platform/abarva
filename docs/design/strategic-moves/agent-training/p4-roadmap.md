...
| GC-P4-S1: Funding approval recorded (`funding_approval_recorded`) | Soft | No — requires formal record of approved funding amount, authority, and mechanism | Finance or sponsor authority on record |
| GC-P4-S2: Sponsor alignment confirmed (`sponsor_alignment_confirmed`) | Soft | No — requires named sponsor confirmation separate from business case sign-off | Named sponsor |
