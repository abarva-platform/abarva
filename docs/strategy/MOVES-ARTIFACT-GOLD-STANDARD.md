...
`CXO-ARTIFACT-STORYTELLING-CONTRACT.md`,
...
For executive storyline shape, use `CXO-ARTIFACT-STORYTELLING-CONTRACT.md`.
Moves artifacts must explain not only what solution is proposed, but why it is
the right move, what happens if the client does nothing, and how the decision
maps to revenue, cost, risk, speed, customer and compliance.
...
8. **Derived visuals carry provenance.** Process flows, data flows, architecture
   ...
   visual directly.
9. **Every phase has a story spine.** Phase-end deliverables must include an
   executive message, value/risk movement, why-it-happened analysis, action
   timeline or roadmap, do-nothing scenario where relevant, and business-impact
   mapping. Details belong in appendices when they interrupt the executive story.
...
| Business Impact | Impact mapped to revenue, cost, risk, speed, customer and compliance. | Business-impact scorecard and do-nothing vs act scenario. |
