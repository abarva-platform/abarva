...
| 3 | Trigger the persisted agent-quality telemetry smoke in GitHub Actions after applying the AZLAB46 migration to Azure Postgres. | Confirms C5 guard telemetry survives Container App restarts and feeds the pilot dashboard from durable evidence. |
