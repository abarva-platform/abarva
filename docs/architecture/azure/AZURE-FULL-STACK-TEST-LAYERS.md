...
| 3 | Run the persisted agent-quality telemetry smoke against Azure Postgres. | Confirms C5 guard telemetry survives Container App restarts and feeds the pilot dashboard from durable evidence. |
