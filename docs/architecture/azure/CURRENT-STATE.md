...
|---|---|---|
| L1-L11 full-stack test gates not wired end-to-end | High | `AZURE-FULL-STACK-TEST-LAYERS.md` defines the deploy, pilot, and continuous gates. L1 resource parity, L2 positive-path, L3 advisory audit, L4 Azure SEC-P0 target, L5 schema/data parity, L6 primary-surface E2E, L10 sensitive-upload audit assertions, and L11 evidence-plane audit are now wired. Remaining gates: L1 what-if, L7 agent quality, L8 load, L9 resilience, and L10 evidence-pack export/live SQL assertions. |
