...
| 9   | Artifact prompt/workflow maturity by phase (d06, d08, d10, d12–d33 partial)          | **Candidate — remaining early/mid slice in branch.** Pricing d19–d21, Responses d13–d15, Evaluation d16–d18, BAFO d22–d23, Decision/Selection d25–d28, Transition d29–d31, and Value d32–d33 prompt workflow/lifecycle projection slices are merged, deployed, ACA-invariant-checked, and signed-in Apex proven. This branch adds the remaining prompt gaps in Scope/RFP: d06 Exclusion Log, d08 Scope Risk Pre-mortem, d10 RFI Summary, and d12 Vendor Shortlist. | None known after this slice for item #9's named d06/d08/d10/d12–d33 scope. Continue to watch for artifact-quality/guidance/ingest gaps in the separate backlog items below. | Current PR scope only: d06/d08/d10/d12 prompt templates, upstream blocking, evidence binding, and lifecycle/standards prompt-backed projection. Do not bundle artifact body generation, client-final repair, guidebooks, ingestion, or analytics UI changes. | Prompt-registry tests cover d06/d08/d10/d12 availability, upstream blocking, evidence binding, no invented exclusions/workshop decisions/vendor interest/shortlist approvals. Lifecycle-matrix regression asserts d06/d08/d10/d12 export as prompt-backed and no longer show "No dedicated prompt." | Signed-in proof after deploy should confirm the Scope/RFP Files matrix shows d06/d08/d10/d12 as prompt-backed / Claude model labels instead of "No dedicated prompt"; no generation or data mutation required. |
...
Transition d29–d31, Value d32–d33, BAFO d22–d23, and Decision/Selection d25–d28 are also
merged, deployed, ACA-invariant-checked, and signed-in Apex proven. The remaining early/mid
prompt/workflow maturity slice (`d06`, `d08`, `d10`, `d12`) is active. After item #9 closes,
move to `SOURCE-ARTIFACT-QUALITY-001`,
