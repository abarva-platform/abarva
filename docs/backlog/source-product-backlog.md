...
| 9   | Artifact prompt/workflow maturity by phase (d06, d08, d10, d12–d33 partial)          | **Candidate — Transition slice in branch.** Pricing d19–d21, Responses d13–d15, and Evaluation d16–d18 prompt workflow/lifecycle projection slices are merged, deployed, ACA-invariant-checked, and signed-in Apex proven. This branch adds the next priority family: Transition d29–d31. The sequence is `d27_selection_memo` + `d28_contract_record` → `d29_transition_plan`, then `d29_transition_plan` → `d30_checkpoint_log` and `d31_kt_evidence`, so transition cannot inherit invented selected vendors, contract dates, go/no-go decisions, KT sessions, or receiving-team sign-offs. | Value prompt/workflow coverage remains open after this Transition slice. | Current PR scope only: Transition d29–d31 prompt templates, transition-roadmap controls, checkpoint go/no-go controls, KT evidence controls, upstream blocking, and lifecycle/standards prompt-backed projection. Do not bundle Value.                                                                                                                                 | Prompt-registry tests cover d29/d30/d31 availability, upstream blocking, uploaded transition/KT evidence binding, and checkpoint/KT prompts that do not invent completed decisions or sign-offs. Lifecycle-matrix regression asserts d29/d30/d31 export as prompt-backed and no longer show "No dedicated prompt."                                                                                                                                 | Signed-in proof after deploy should confirm the Transition Files matrix shows d29/d30/d31 as prompt-backed / Claude model labels instead of "No dedicated prompt"; no generation or data mutation required. |
