# Q057 · operating-model

Question: What operating model changes are needed before SkyHarbor expands autonomous disruption recovery? Compare scale, hold, and stop options.
