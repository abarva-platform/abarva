# Q024 · vendor-sourcing

Question: Which vendor or platform dependencies should sourcing pressure-test before the next AI funding release? Call out what is tenant fact versus industry context.
