# Q038 · product-development

Question: How should SkyHarbor sequence AI-led product development across operations and customer journeys? Name the top missing evidence before board approval.
...
```json
{
  ...
  "expertLenses": [
    ...
    {
      "id": "lens-c3e2cb7552",
      "lens": "transformation lead",
      "role": "REQUIRED",
      "whySelected": "Pressure-test sequencing, ownership, change load, and delivery risks.",
      "pressureTest": "What sequence, owner, and dependency path lowers execution risk?"
    }
  ],
  "benchmarkContext": [
    {
