# Q034 · vendor-sourcing

Question: Which vendor or platform dependencies should sourcing pressure-test before the next AI funding release? Name the top missing evidence before board approval.
...
```json
{
  ...
  "expertLenses": [
    ...
    {
      "id": "lens-a5e1f2c1b5",
      "lens": "sourcing / vendor",
      "role": "REQUIRED",
      "whySelected": "Pressure-test vendor leverage, contract evidence, renewal, and sourcing implications.",
      "pressureTest": "What commercial leverage, dependency, or vendor evidence changes the decision?"
    },
    {
      "id": "lens-965b44cb3f",
      "lens": "board advisor",
      "role": "REQUIRED",
      "whySelected": "Pressure-test executive clarity, decision required, and board-safe caveats.",
      "pressureTest": "What decision is required now, and what caveat would matter in a board paper?"
    }
  ],
  "benchmarkContext": [
    {
