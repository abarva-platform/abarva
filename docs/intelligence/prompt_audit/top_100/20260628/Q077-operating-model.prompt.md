# Q077 · operating-model

Question: What operating model changes are needed before SkyHarbor expands autonomous disruption recovery? Give a concise recommendation with next actions.
