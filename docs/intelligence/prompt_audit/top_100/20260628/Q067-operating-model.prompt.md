# Q067 · operating-model

Question: What operating model changes are needed before SkyHarbor expands autonomous disruption recovery? Show the most important tradeoff.
