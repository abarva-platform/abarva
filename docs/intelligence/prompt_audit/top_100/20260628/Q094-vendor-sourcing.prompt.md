# Q094 · vendor-sourcing

Question: Which vendor or platform dependencies should sourcing pressure-test before the next AI funding release? Pressure-test the value claim without inventing ROI.
