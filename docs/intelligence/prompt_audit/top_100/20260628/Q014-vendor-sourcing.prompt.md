# Q014 · vendor-sourcing

Question: Which vendor or platform dependencies should sourcing pressure-test before the next AI funding release? Frame it for a CIO and CFO joint decision.
