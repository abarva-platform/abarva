# Q097 · operating-model

Question: What operating model changes are needed before SkyHarbor expands autonomous disruption recovery? Pressure-test the value claim without inventing ROI.
