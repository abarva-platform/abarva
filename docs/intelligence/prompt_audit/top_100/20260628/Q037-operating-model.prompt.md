# Q037 · operating-model

Question: What operating model changes are needed before SkyHarbor expands autonomous disruption recovery? Name the top missing evidence before board approval.
