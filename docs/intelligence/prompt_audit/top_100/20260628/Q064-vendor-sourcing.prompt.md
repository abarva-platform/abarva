# Q064 · vendor-sourcing

Question: Which vendor or platform dependencies should sourcing pressure-test before the next AI funding release? Show the most important tradeoff.
