# Q054 · vendor-sourcing

Question: Which vendor or platform dependencies should sourcing pressure-test before the next AI funding release? Compare scale, hold, and stop options.
