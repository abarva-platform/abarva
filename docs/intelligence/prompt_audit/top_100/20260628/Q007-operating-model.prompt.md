# Q007 · operating-model

Question: What operating model changes are needed before SkyHarbor expands autonomous disruption recovery? Give the direct CXO answer.
