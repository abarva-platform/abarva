...
| F5 | Files "Upload" command | `button.source-new-files__command` (`:343`), gated `{onUpload && …}` | — | — | **None — this affordance never renders on Source New.** See [Negative control](#negative-control-the-row-origin-main-does-not-satisfy) | n/a | n/a | n/a |
