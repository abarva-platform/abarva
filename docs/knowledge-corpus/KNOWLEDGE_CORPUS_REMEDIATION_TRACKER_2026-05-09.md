...
- Runtime pattern-first retrieval in agents: Nexus and Sentinel complete; Atlas in PR-B4.
...
| Atlas value/KPI grounding | In PR-B4 | Atlas value guidance separates projected/tracked/verified framing and grounds KPI, baseline, measurement, value lever, confidence, and quantitative claim handling in canonical patterns. | Merge PR-B4 and include unified source/confidence visibility in PR-C3. |
