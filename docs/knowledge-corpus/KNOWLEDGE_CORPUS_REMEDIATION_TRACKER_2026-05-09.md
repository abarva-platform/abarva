...
- End-to-end validation that agents retrieve and use patterns: PR-C2 complete; source/confidence visibility is in PR-C3.
...
| User-visible source basis/confidence | In PR-C3 | `groundingDisclosure` contract added to Nexus, Sentinel, and Atlas agent/API outputs. | Merge PR-C3 after CI; richer UI placement can follow if needed. |
