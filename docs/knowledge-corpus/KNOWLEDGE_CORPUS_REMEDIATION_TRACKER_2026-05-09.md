...
- Context broker corpus hydration: In PR-B1.
...
| `corpusPatterns` hydration | In PR-B1 | Context broker now maps persisted canonical hits into `corpusPatterns`, provenance, and retrieval trace shared-corpus ids. | Merge PR-B1, then ensure Nexus/Sentinel/Atlas consume the hydrated patterns. |
