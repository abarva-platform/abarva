...
const SOLUTIONS = [
  { name: 'AI-Powered PDLC',                    desc: 'Build products faster with AI agents',        tag: '', path: '/solutions/pdlc' },
  { name: 'AI-Powered Transformation Delivery', desc: 'Replace large consulting teams with Maestros', tag: '', path: '/solutions/delivery' },
  { name: 'Margin Optimization',                desc: 'Recover margin across revenue, cost and AI',   tag: '', path: '/solutions/margin' },
]
    ...
    <nav style={{ background: CARD, borderBottom: `1px solid ${BORDER}`, position: 'sticky', top: 0, zIndex: 200 }}>
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 28px', display: 'flex', alignItems: 'center', height: '64px' }}>
        ...
        <a href="/" style={{ display: 'flex', flexDirection: 'column', textDecoration: 'none', marginRight: '28px', lineHeight: 1, flexShrink: 0 }}>
          ...
          <span style={{ fontFamily: 'monospace', fontSize: '9px', color: TEXT, letterSpacing: '.04em', marginTop: '1px' }}>
