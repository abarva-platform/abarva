...
- The first lab runtime uses the in-memory Cube cache/queue driver. Add Cube Store before treating this runtime as a high-concurrency production semantic service.
