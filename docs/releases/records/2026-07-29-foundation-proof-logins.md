...
- Local `.auth/` storage-state file generated by the prime script, retained outside git.
- `reports/foundation-preview-auth/*.json` and screenshot proof, retained outside git unless explicitly attached to a private evidence bundle.
