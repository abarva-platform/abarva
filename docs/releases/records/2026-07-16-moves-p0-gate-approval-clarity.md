...
Merge through PR to `main`. The repo-owned Azure Container Apps main deploy workflow builds and deploys the digest-pinned image. After deploy, verify the Meridian P0 gate URL shows the hard/soft criteria split, allows approval when the seven-answer P0 charter is complete, and lands in P1 after approval.
