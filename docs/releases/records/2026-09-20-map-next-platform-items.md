# 2026-09-20-map-next-platform-items - Restore Execution Queue Coverage

## Release ID

`2026-09-20-map-next-platform-items`
...
- Maps `T-416` through `T-421` and `T-606` once under `platformTrack.items`.
...
- Pull request and CI checks created from `codex/T606-map-watcher-items`.
