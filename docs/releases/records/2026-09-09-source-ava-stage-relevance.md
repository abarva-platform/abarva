...
- Keep recorded-selection questions with remaining conditions on the authoritative selection-memo path; only explicit ready, held, blocked, or must-resolve language enters the award-readiness path.
