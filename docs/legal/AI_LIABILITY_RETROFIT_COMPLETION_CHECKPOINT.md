...
| In progress | T234, T238, T240, T242, T243, T244, T245, T247, T248, T250 | 10 |
| Not started | None | 0 |
...
| Intelligence / Sentinel | T233, T234 | Mixed | 75% | T233 is Done after visible pattern-card AI labels, evidence refs, confidence, and human-promotion warnings landed. T234 remains In progress until PR #2902 merges and the persisted promotion approval evidence is live. |
...
pilot-complete because 10 rows remain `In progress`, and those rows require
...
| --- | --- | --- |
| T234 | PR #2902 is open with the consuming Intelligence pattern-to-Move approval dialog and server-side fail-closed validation for rationale/evidence packet persistence. | Merge green CI, then verify the promotion approval evidence remains persisted before Move creation. |
