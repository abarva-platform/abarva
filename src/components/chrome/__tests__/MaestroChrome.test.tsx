...
describe("MaestroChrome canonical shell", () => {
  ...
  it.each(["/home/knowledge", "/intelligence", "/strategic-moves", "/source", "/tower"])(
    "mounts exactly one Nexus toolbar for %s",
    (pathname) => {
      ...
      expect(screen.getByRole("img", { name: "AbarVa NEXUS" })).toBeInTheDocument();
