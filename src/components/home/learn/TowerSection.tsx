  ...
  return (
    <>
      <HeroBand color="teal">
        ...
        <SectionTitle light size="xl">Six programs. One heatmap. Atlas watches what Moves create.</SectionTitle>
        <Lead light>
          Apex Retail has six AI programs running simultaneously. APX-01 is in execution. APX-02 is mid-design. APX-03 is complete and generating validation data. APX-04 is flagged amber. APX-05 has a gate-miss alert. APX-06 is just originating. Atlas watches all of it — and surfaces the signal that matters before the quarterly review asks for it.
        </Lead>
      </HeroBand>
      ...
      <Section>
        ...
        <SectionTitle>Six programs in Atlas</SectionTitle>
        <Lead>
          The portfolio heatmap shows every active Move with phase, gate status, and health signal. Green is on track. Amber is advisory. Red is blocked. Atlas shows you where to look — you decide what to do.
        </Lead>
        ...
        >
          ...
          >
            {['Program', 'Phase', 'Status', 'Atlas signal'].map((h) => (
              <div
                key={h}
                style={{
                  fontFamily: T.fMono,
          ...
          {[
            ...
            },
            {
              ...
              detail: 'Completed Q4 · Atlas monitoring KPIs · Value validation in progress',
            },
            {
              id: 'APX-04',
            ...
            },
            {
              ...
              detail: 'P0 in progress · Steward flagged foundation readiness as partial',
            },
      ...
      <Section>
        ...
        <Lead>
          APX-03 Contact Center AI Routing completed last quarter. The program is closed — but Atlas is still watching. The P4 business case projected 28% AHT reduction. Actual performance is 26%. The value validation gap feeds back into Intelligence.
        </Lead>
      ...
      <Section>
        ...
        <SectionTitle>Atlas watching APX-01 in real time</SectionTitle>
        <Lead>
          APX-01 has been in execution for 8 weeks. Atlas is tracking three KPIs from the P4 Tower Metrics Plan. Two are improving. One — the Home category override rate — is not.
        </Lead>
        ...
        >
          ...
          >
            Atlas alert · APX-01 · Home category override rate
          </div>
          <div
            style={{
              fontFamily: T.fBody,
          ...
          >
            Home category GM override rate: 68% (week 8 of execution) vs 47% program baseline. Portfolio average has declined to 38% — Home is diverging further. P2 risk &ldquo;GM change management for reason code adoption&rdquo; (owner: Karina Shah) appears to be materializing in this category specifically. Recommend: direct conversation with Home GM; consider category-level guardrail adjustment. Atlas has flagged this to Karina Shah&rsquo;s weekly summary.
          </div>
        </div>

        <BodyP>
          This is what Tower monitoring is for. The P2 risk register flagged Home as a behavioral outlier at diagnosis. P5 assigned Karina Shah as risk owner. Atlas surfaced the alert in week 8 — before it showed up in quarterly GM data. Karina can act now, not after the quarter closes.
        </BodyP>
      </Section>
      ...
      <Section>
        ...
        <TermGrid>
          <Term name="Portfolio heatmap">
            A grid of all active Moves showing phase, gate status, and health signal. <em>Green = on track. Amber = advisory. Red = blocked. Atlas updates it in real time from program signals and KPI data.</em>
          </Term>
          ...
          <Term name="Atlas">
            The Tower agent. Answers questions about portfolio status, execution risk, and signal health. <em>&ldquo;Atlas, which Move is at highest risk of missing its P4 gate this quarter?&rdquo; Atlas: &ldquo;APX-04 — sponsor gap, week 3 stalled, escalation sent.&rdquo;</em>
          </Term>
          <Term name="Gate-miss alert">
            An Atlas alert that a program is approaching a gate deadline without the required gate criteria met. <em>APX-05 received a gate-miss alert three weeks before the May P1→P2 deadline — enough time to act.</em>
          </Term>
          <Term name="Value validation">
            The post-completion comparison between the P4 business case projections and actual execution results. <em>APX-03 is in value validation now. Atlas tracks the gap and feeds findings back to Intelligence.</em>
          </Term>
          <Term name="Tower acceptance">
            The confirmation from Atlas that a P5 handoff package is complete and the program is ready to transition to execution monitoring. <em>A hard gate criterion — no Move can close P5 without it.</em>
          </Term>
        </TermGrid>
      </Section>
    </>
