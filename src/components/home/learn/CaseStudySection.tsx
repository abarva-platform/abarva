      ...
      <Section>
        ...
        <PhaseCard
          ...
          nexusDidItems={[
            ...
            'Pre-filled RACI with delivery team: PM = Head of Digital Transformation, Tech Lead = Director of Platform Engineering, Vendor Lead = pending final vendor award (RFP live)',
