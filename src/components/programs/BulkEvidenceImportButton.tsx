...
// BulkEvidenceImportButton (programs) — ghost-style "Import CSV" button that
// opens a hidden file input, parses the CSV client-side (no library), shows a
// preview table of the first 5 rows, then POSTs each row to
...
//
// Mirror of src/components/source/BulkEvidenceImportButton.tsx adapted to
  ...
  return (
    <>
      ...
      {showModal && (
        <div
          style={OVERLAY}
          onClick={phase.kind === 'done' || phase.kind === 'error' ? dismiss : undefined}
        >
