...
.mxw-shell{max-width:900px;margin:0 auto;padding:38px 40px 96px}
...
.mxw-stage-head p{font-size:15.5px;color:var(--muted);line-height:1.55;max-width:62ch;margin:0}
