          ...
          {showDeliverables && (
            <div style={DELIVERABLES_PANEL} role="region" aria-label="Step templates and upload">
              ...
              <button
                ...
                onClick={() =>
                  pageState?.ask(
                    `Review the deliverables gap for ${stageLabel}. For each required artifact, tell me: what's missing, who needs to provide it, what format it must be, and how Ava will validate it once uploaded.`,
                  )
                }
                style={{
                  ...GAP_REVIEW_BUTTON,
