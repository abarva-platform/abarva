    ...
    <div style={READER_WRAP_STYLE}>
      <div style={READER_HEADER_STYLE}>
        <span style={READER_BADGE_STYLE}>
          {isGenerated
            ? 'AI draft generated by Sentinel · human edit required before completion'
            : bodyIsAuthored
              ? 'Authored content'
...
function ArtifactStatusControls({
  ...
  const hasCommittedContent = isArtifactHumanReviewed(artifact);
  const isAiOnlyDraft = Boolean(
    artifact.body?.trim() &&
          ...
          <button
            ...
            title={
              hasCommittedContent
                ...
                : isAiOnlyDraft
                  ? 'Human-edit this AI draft before marking complete.'
