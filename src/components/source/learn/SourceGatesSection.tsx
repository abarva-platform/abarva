    ...
    <>
      ...
      <Section>
        ...
        <BodyP>
          ...
          an authored body — either hand-written or Ava-generated.{' '}
      ...
      <Section>
        ...
        <BodyP>
          ...
          source&rdquo; means one document, URL, or Ava artifact has been
          tagged as evidence for at least one gate criterion. The count goes up
          each time you upload a document, pin a URL via the Ava chat, or
          tag an Ava-generated artifact as a provenance receipt.
        </BodyP>
        <BodyP>
      ...
      <Section>
        ...
        <SubHead>URL pinned via Ava chat</SubHead>
        <BodyP>
          In the Ava chat lane, paste a URL and ask Ava to
          &ldquo;pin this as evidence for [criterion name].&rdquo; Ava
        ...
        <SubHead>Ava-generated artifact with a valid provenance receipt</SubHead>
        <BodyP>
          Any artifact generated by Ava carries a provenance receipt. You
          ...
          criterion. This is the most common evidence path: Ava generates
      ...
      <Section>
        ...
        <Lead>
          ...
          Ava surfaces a confirmation dialog listing any unmet criteria
        ...
        <StepList>
          ...
          <Step title="Click Promote stage">
            ...
            button activates. Click it. Ava shows a confirmation dialog
      ...
      <Section>
        ...
        <Lead>
          Before you promote, run &ldquo;Audit gate gaps&rdquo; in the Ava
          chat lane. Ava reads the substrate and returns a structured gap
        ...
        <BodyP>
          ...
          promotion?&rdquo;) in the Ava chat lane. Ava runs the
        ...
        <ul style={{ marginLeft: 24, lineHeight: 1.8, fontSize: 14 }}>
          <li>
            ...
            satisfied. Ava lists each by label and explains the gap (e.g.
          ...
          <li>
            ...
            but expected by a downstream stage, Ava flags it as a
            &ldquo;forward dependency warning.&rdquo;
          </li>
          <li>
            <strong>Thin evidence links</strong> — criteria whose evidence
            requirement is technically met (one item tagged) but where Ava
            judges the evidence weak (e.g. a URL with no annotation, or a
            very short Ava receipt). Ava flags these as warnings, not
        ...
        <BodyP>
          ...
          card, or ask Ava to generate the missing artifact in the same
          chat turn.
        </BodyP>
      </Section>
