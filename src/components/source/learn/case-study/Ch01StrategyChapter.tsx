    ...
    <ChapterShell slug="strategy">
      ...
      <Section>
        ...
        <BodyP>
          ...
          Portland colocation lease comes up Q3 2027. The renewal terms include
          ...
          cloud, Epic integration, and payer-data controls. The question is
          which cloud, on what terms, with what exit posture if it doesn&rsquo;t work.
        </BodyP>
        <BodyP>
      ...
      <Section>
        ...
        >
          ...
          <strong>Trigger:</strong> Portland colocation lease expires Q3 2027 with
          rate escalation locked at 18% YoY. Epic, MyChart, Cloverleaf, health-plan
          data controls, and Tier-1 clinical DR are in scope across 23 hospitals
          and 142 clinics.
        </Callout>
        <BodyP>
      ...
      <Section>
        ...
        >
          ...
          <p>
            <strong>Strategic posture.</strong> Move 920 production workloads
            to a managed cloud platform under a multi-year commitment. Include
            Epic CIS, MyChart, Cloverleaf integration middleware, payer-data
            controls, and DR for 68 Tier-1 systems. Defer only Tier-2 DR and
            non-clinical archival workloads to follow-on events.
          </p>
          <p>
          ...
          <p>
            <strong>Value at stake.</strong> $18M low / $26M high annual
            run-rate · 5-year horizon · strict rigor.
          </p>
        </ArtifactSpecimen>
      ...
      <Section>
        ...
        <GateStatusBox
          ...
          rows={[
            ...
            {
              text: 'Estimated value band ($18M low / $26M high annual) recorded in canvas + visible in canvas header',
              status: 'met',
            },
          ]}
        />
      ...
      <Section>
        ...
        <BodyP>
          The 920-workload count is Marcus&rsquo;s rough sense, not yet
