...
export const NAV_ITEMS: CockpitNavItem[] = [
  {
    // Demo IA reset (2026-06-18): Home is again a signed-in executive
    // hub. Setup/Admin remains available under /admin, but the top-nav
    // Home tab must not land buyers in Steward setup plumbing.
    key: "home",
    label: "Home",
    href: "/home",
    match: (pathname) =>
