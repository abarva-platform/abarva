...
const tree = "src/lib/source/exports/__tests__";
...
describe("Source export suite CI ownership", () => {
  it("names the export test directory in a Jest workflow command", () => {
  ...
  it("cannot prefix-match a sibling test directory", () => {
