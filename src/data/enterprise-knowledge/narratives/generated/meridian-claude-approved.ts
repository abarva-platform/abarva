...
export const MERIDIAN_CLAUDE_HOME_INSIGHTS = {
  summary_title:
    "Meridian Health: Building the Governed Context Layer Before Scaling AI",
  executive_summary:
    "Meridian runs a mature but fragmented current-state estate: Epic clinical systems (Epic Clarity, Epic Caboodle), a claims administration platform, eligibility and benefits, a CRM member case platform, a contact center platform, an enterprise knowledge base, on-prem SQL Server reporting marts, a DB2 or Netezza-style integration warehouse where applicable, and heavy reporting through Tableau, SAS, and Power BI. The declared direction is an AWS plus Databricks lakehouse with medallion architecture, Unity Catalog-style governance, PHI controls, human-in-the-loop review, and audit controls — target-state, not current production. Across nine represented domains, source-backed synthetic context covers 62 readable records, each backed by a citable evidence reference: enough to ground enterprise orientation, discovery, and current-state diagnosis. Member service Agent Assist in the contact center is the clearest worked example of what a governed context foundation unlocks, but it is one example among many, not the whole story. High-value bets such as Agent Assist depend on a governed context spine that does not yet exist, so the near-term work is evidence capture, baseline setting, and relationship validation rather than premature automation claims.",
  ...
  top_insights: [
    {
      title:
        "A capable current-state estate is fragmented across reporting marts and tools",
      what_nexus_sees:
        "The context describes Epic Clarity and Epic Caboodle, a claims administration platform, on-prem SQL Server reporting marts, and heavy Tableau, SAS, and Power BI reporting, alongside a CRM member platform and contact center platform.",
      why_it_matters:
        "Fragmentation means the same member, claim, and eligibility facts live in multiple places, which limits consistent answers for member service and slows every downstream decision.",
      ...
      next_action:
        "Confirm system owners, criticality, and interface points for member service, claims, eligibility, and knowledge in a working session.",
      module_handoff:
        "Knowledge frames the estate; Intelligence reasons about consolidation options.",
    },
    {
      title:
        "AWS and Databricks are the declared destination, not the current production floor",
      what_nexus_sees:
        "AWS, Databricks, medallion architecture, Unity Catalog-style governance, and a governed lakehouse appear consistently as target-state direction, with explicit gaps noting no certified medallion architecture and no platform, network, or security foundation evidence loaded.",
      why_it_matters:
        "Treating the target platform as if it were live would overstate readiness and risk building AI use cases on an unproven foundation.",
      ...
      next_action:
        "Request landing-zone, medallion certification, and security foundation artifacts to confirm foundation maturity.",
      module_handoff:
        "Knowledge holds the boundary; Moves can phase-gate the foundation build once evidence exists.",
    },
    {
      title:
        "Member service Agent Assist is a well-anchored worked example that depends on many upstream domains",
      what_nexus_sees:
        "The business anchor ties Agent Assist to member service operations, supervisors, knowledge stewards, health plan operations, claims, eligibility and benefits, clinical reporting, data governance, privacy, and analytics, and a call center optimization program sits in early evidence framing.",
      why_it_matters:
        "It shows that a single high-value use case is only as strong as the governed context feeding it, which is exactly why the context layer is the hero of this story.",
      ...
      next_action:
        "Capture current contact center KPIs and confirm knowledge base and CRM readiness before scoping automation.",
      module_handoff:
        "Knowledge scopes dependencies; Moves turns Agent Assist into a phase-gated bet.",
    },
    {
      title:
        "The relationship layer that connects the context is not yet validated",
      what_nexus_sees:
        "Relationship rows were present in source but not accepted, and readiness reports relationship coverage at zero with relationships not validated across records.",
      why_it_matters:
        "Without validated links, the context can describe each domain but cannot yet reason confidently about how a system change ripples into functions, risks, and outcomes.",
      evidence_strength: "Gap",
      related_dimensions: ["Relationships", "Evidence Sources"],
      next_action:
        "Run a relationship validation session to connect systems, functions, data assets, risks, and metrics.",
      module_handoff:
        "Knowledge surfaces the gap; Intelligence depends on it for reliable reasoning.",
    },
    {
      title:
        "Metrics exist as definitions and readiness checks, not yet as measured outcomes",
      what_nexus_sees:
        "Metrics such as analytics maintenance share, net-new analytics capacity, medallion certification status, and program baseline readiness are defined with a synthetic steward as owner and baseline required.",
      why_it_matters:
        "Value can be framed and targeted, but no realized savings or ROI can be claimed until actuals and accountable owners are in place.",
      evidence_strength: "Partial",
      related_dimensions: ["Metrics & Outcomes", "IT Budget, Spend & Value"],
      next_action:
        "Assign real metric owners and capture current baselines for the priority programs.",
      module_handoff:
        "Knowledge defines the metrics; Tower carries them once actuals exist.",
    },
  ],
  ...
  readiness_matrix: [
    {
      ...
      readiness: "Strong",
      story:
        "Current-state clinical, claims, reporting, and member systems are described with owners and criticality; AWS and Databricks remain target-state.",
    },
    {
      dimension: "Data Assets & Integrations",
      readiness: "Partial",
      story:
        "Fragmented marts and warehouse are visible and a governed lakehouse is planned, but certified layers and an identity spine are not loaded.",
    },
    {
      dimension: "Business Functions",
      readiness: "Strong",
      story:
        "Member experience, clinical, health plan, quality, finance, and technology functions are represented with executive owners.",
    },
    {
      dimension: "Programs & Initiatives",
      readiness: "Partial",
      story:
        "Priority programs including call center optimization and the lakehouse foundation are framed in early evidence stages with baselines required.",
    },
    {
      dimension: "Relationships",
      readiness: "Gap",
      story:
        "Relationship rows were not accepted and coverage reads zero, so cross-domain reasoning is not yet reliable.",
    },
    {
      dimension: "Metrics & Outcomes",
      readiness: "Partial",
      story:
        "Metrics are defined with readiness checks but carry synthetic ownership and require real baselines.",
    },
    {
      dimension: "Infrastructure & Platforms",
      readiness: "Target / Future",
      story:
        "The AWS and Databricks foundation is a declared direction with no certified platform, network, or security evidence loaded.",
    },
    {
      dimension: "Risks & Controls",
      readiness: "Strong",
      story:
        "High-severity open risks are captured with required evidence, from medallion certification to governance and audit trail gaps.",
    },
  ],
  evidence_heatmap: [
    {
      ...
      confidence: "Medium",
      caveat:
        "Citable synthetic records; deployment and hosting are current_mixed and need workshop confirmation.",
    },
    {
      dimension: "Data Assets & Integrations",
      ...
      confidence: "Medium",
      caveat:
        "Many assets are workshop-refresh with owner to confirm; lakehouse layers are target-state.",
    },
    {
      ...
      confidence: "Medium",
      caveat:
        "Vendors are named but commercial terms and economics are not loaded.",
    },
    {
      dimension: "Programs & Initiatives",
      evidence_coverage: "Medium",
      confidence: "Medium",
      caveat:
        "Mostly candidate moves in early evidence framing with baseline required.",
    },
    {
      dimension: "Risks & Controls",
      evidence_coverage: "High",
      confidence: "Medium",
      caveat:
        "Risks are open with evidence required; closure depends on workshops.",
    },
    {
      dimension: "Metrics & Outcomes",
      evidence_coverage: "Medium",
      confidence: "Low",
      caveat:
        "Definitions present; no measured actuals and synthetic ownership.",
    },
    {
      dimension: "Relationships",
    ...
    },
    {
      ...
      confidence: "Medium",
      caveat:
        "Synthetic, PHI-free, planning-grade, manifest-gated sources only.",
    },
  ],
  top_gaps: [
    {
      ...
      why_it_matters:
        "Cross-domain reasoning and impact analysis cannot be trusted until links are validated.",
      source_dimension: "Relationships",
      evidence_requested:
        "Confirmed relationships mapping systems to functions, data assets, risks, and outcomes.",
    ...
    },
    {
      ...
      why_it_matters:
        "A unified clinical and claims view and reliable member service both depend on trustworthy identity resolution.",
    ...
    },
    {
      ...
      why_it_matters:
        "AI use cases built on an unproven foundation carry quality, security, and PHI risk.",
      source_dimension: "Infrastructure & Platforms",
      evidence_requested:
        "Landing-zone, medallion certification, and security foundation artifacts.",
    ...
    },
    {
      ...
      why_it_matters:
        "Value cannot be realized or defended without current baselines and accountable owners.",
      source_dimension: "Metrics & Outcomes",
      evidence_requested:
        "Current contact center, quality, and cost baselines with named owners.",
    ...
    },
    {
      ...
      why_it_matters:
        "Sourcing scope and contract optimization require loaded commercial evidence.",
      source_dimension: "Vendors & Contracts",
      evidence_requested:
        "Contract terms, spend, and renewal data for key vendors.",
  ...
  module_readiness: [
    {
      module: "Knowledge",
      readiness:
        "Ready to narrate current-state context across nine represented domains with citable synthetic evidence.",
      next_best_action:
        "Confirm ownership, criticality, and dependencies for member service, claims, eligibility, and knowledge systems.",
    },
    {
      module: "Intelligence",
      readiness:
        "Partly ready; domain context is strong but the missing relationship layer limits confident cross-domain reasoning.",
      next_best_action:
        "Validate relationships so reasoning about AI focus and risk becomes decision-grade.",
    },
    {
      module: "Moves",
      readiness:
        "Framing-ready; priority bets such as Agent Assist and the lakehouse foundation are captured as early-stage candidates.",
      next_best_action:
        "Convert the foundation and Agent Assist into phase-gated plans once baseline and foundation evidence exist.",
    },
    {
      module: "Source",
      readiness:
        "Not yet enabled for commercial work; vendors are named but economics are absent.",
      next_best_action:
        "Load contract and spend evidence before sourcing and optimization analysis.",
    },
    {
      module: "Tower",
      readiness:
        "Not yet enabled for value realization; metrics are defined but not measured.",
      next_best_action:
        "Capture actual baselines and assign real owners before any value claim.",
    },
  ],
  safe_claims: [
  ...
  source_context_hash:
    "sha256:22dc8141edb81f614656dc4f957932afd1a62456e55b43a6af743fa5011e1817",
  evidence_refs_used: [
  ...
  generated_at: "2026-07-15T18:06:18.633Z",
...
export const MERIDIAN_CLAUDE_DIMENSION_NARRATIVES = [
  {
    ...
    summary_title:
      "A synthetic integrated delivery network and health plan under modernization",
    executive_summary:
      "The context describes Meridian as an integrated delivery network and health plan spanning clinical delivery, health-plan operations, finance, and analytics transformation. This is source-backed synthetic demo context, not real Meridian production data. Leadership, revenue, and footprint figures are planning-grade and require client validation before display as facts.",
    what_nexus_knows: [
    ...
    why_it_matters:
      "A clear enterprise anchor lets every downstream bet be framed against member service, clinical, and health-plan realities rather than generic assumptions.",
    questions_supported: [
    ...
    source_context_hash:
      "sha256:dad4dee623f5f8191c819fc48f1c4eec0213c45d96489927ce3c36e93570303f",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    summary_title:
      "Functions that carry the member service and Agent Assist story",
    executive_summary:
      "The context captures clinical operations, health plan operations, quality, finance, contact center and member experience, technology platform, and enterprise data and analytics, each with a named executive owner. Contact Center and Member Experience anchors the Agent Assist worked example. All entries are planning-grade synthetic context, not current production certification.",
    what_nexus_knows: [
    ...
    why_it_matters:
      "Mapping owned capabilities to functions shows which teams must collaborate for member service Agent Assist and where accountability sits.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:25e1cf998e2040561d375b7d31fd3db377cd10e785e3145e424121498d97f361",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    summary_title:
      "Ownership inferred from function executives, not yet a validated org model",
    executive_summary:
      "Ownership signals come through function-level executive owners such as CDAO, CMO, Chief Health Plan Officer, CFO, Chief Experience Officer, and CDIO. A dedicated, validated organizational ownership structure is not separately loaded, so accountability chains for member service and data governance remain to be confirmed.",
    what_nexus_knows: [
    ...
    why_it_matters:
      "Clear ownership determines who signs off on Agent Assist, knowledge base governance, and the target-state data foundation.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:2aa8de75148cb4715538d538c28655e098a9844b9a513d2f741902c6fd543810",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    why_it_matters:
      "Role clarity drives adoption planning, human-in-the-loop design, and change management for any AI-assisted workflow.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:dfc51603b234819527a44c157f28b4c91a6db7ea7af003d0546fd2a576bb11e0",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    summary_title:
      "A current mixed estate of clinical, claims, and reporting systems",
    executive_summary:
      "The context shows current-state systems including Epic Hyperspace, Epic Clarity, Epic Caboodle, a claims administration platform, on-prem SQL Server reporting marts, Tableau, SAS, and Power BI, plus CRM member case management and contact center telephony. AWS and Databricks appear only as target-state direction and are not certified current production for this tenant.",
    what_nexus_knows: [
    ...
    why_it_matters:
      "The Agent Assist example depends on CRM, claims, eligibility, knowledge base, and Epic-derived data, so current system readiness governs feasibility.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:8d333cdb0d049d28174c8c78e9ebdc4cb5e4e345f70085e17a6e93cc9d153f46",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    summary_title:
      "Fragmented current marts moving toward a governed lakehouse",
    executive_summary:
      "Current analytics are on-premise and fragmented across Epic Clarity and Caboodle, SQL Server reporting marts, a DB2 or Netezza-style integration warehouse where applicable, Tableau, and SAS. Named lakehouse and governed data foundation assets are candidate, workshop-refresh planning constructs on a future medallion and Unity Catalog direction, not current production data products.",
    what_nexus_knows: [
    ...
    why_it_matters:
      "Agent Assist and downstream automation need harmonized, governed data; fragmented marts and unconfirmed owners are the core constraint.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:b4464ebc6130620b8bad35c9a197da39d821f7153ffbfdc3dd64970352ce01e0",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    summary_title:
      "Target-state AWS and Databricks foundation, not yet certified",
    executive_summary:
      "The technology platform function names an AWS landing zone, a Databricks foundation, network and security controls, and interface operations as target-state ambitions. No certified medallion architecture and no platform, network, or security foundation business context is loaded, so AWS and Databricks must be treated as target-state, not current production.",
    what_nexus_knows: [
    ...
    why_it_matters:
      "Every AI and data bet, including member service Agent Assist, depends on a governed platform whose foundation readiness is unproven today.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:b150ab1f281f42dfc7c4fe99f1e3c1e085af304ed2df9986b89ce8baa60b996c",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    why_it_matters:
      "Sourcing scope and contract optimization for member service, analytics, and the target platform depend on validated commercial business context not yet present.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:b5f80913bbc0fc0942bb9a9ec8565604781265d354ef0ec70075fab4af0aedd9",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    summary_title:
      "Planning-grade budget signals awaiting financial validation",
    executive_summary:
      "The context includes a planning-grade technology budget figure and program-level budget and expected-value numbers for the Databricks on AWS foundation. These are synthetic planning hypotheses, not audited financials. ROI, savings, or Tower value should not be claimed until measured actuals exist.",
    what_nexus_knows: [
    ...
    why_it_matters:
      "Investment prioritization for member service and data foundation bets needs validated spend and value baselines, not planning placeholders.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:93c0c0c545b9de8524886ff787252b2f501a22012476657fc6ce5b70fd0d9d39",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    why_it_matters:
      "These initiatives are the raw material for phase-gated execution, with member service optimization the natural Agent Assist worked example.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:793f90f19761548584aa742daaa6e4005cd13c63abb74e1006776879c128b1b5",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    why_it_matters:
      "A concrete, governed use case shows how the context layer would power AI with human-in-the-loop and audit controls once foundations exist.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:9e3a5f0fcb4d90aaf9db95c510725acd135dfbac459b6075083b6a4694c4e52c",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    why_it_matters:
      "These open risks directly gate any member service Agent Assist or automation bet that must operate under PHI and audit controls.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:6eb877be8a8b6475d0aae424eb8ad03ff7540042ddc29843b3fd327c2a258d82",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    executive_summary:
      "No validated relationships are loaded for this context: 85 candidate connections were withheld pending validation, and relationship coverage reads zero across functions, systems, programs, and risks. Cross-dimension links between member service, systems, and data assets are implied by the data but cannot yet be treated as confirmed, governed connections.",
    what_nexus_knows: [
    ...
    why_it_matters:
      "Without validated relationships, the context can describe entities but cannot yet prove how member service, systems, and data assets formally connect.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:c3f35821ab8ec9ec5a14449c45db1f29ecf78f8df7473ab5207139d216614776",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    why_it_matters:
      "Transparent, synthetic, PHI-free provenance keeps the story honest and prevents planning hypotheses from being read as audited facts.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:13d98ed0f9d48b94038e881b656f6cd1030466d4280e293c5d66982f64678cf3",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    why_it_matters:
      "Sound metric definitions and readiness signals set the stage for value tracking once baselines and actuals for member service and data bets exist.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:5509db53f46aa7e494d2d396a91a057ffddff50c6f336a560990a1b04398dd2f",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    why_it_matters:
      "Industry framing helps prioritize member service, quality, cost transparency, and payment integrity bets against recognizable healthcare pressures.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:6602a07e81bf66ca1fbf11f6a347c56dd2eb3723a5a9b7e261b712ec30fee342",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    summary_title:
      "Advisory lenses on data, clinical, plan, finance, and experience",
    executive_summary:
      "The function owners imply distinct advisory lenses: data and analytics under a CDAO, clinical under a CMO, health plan operations, finance and actuarial under a CFO, member experience under a CXO, and platform and security under a CDIO. These lenses guide interpretation but are not separately validated expert assessments.",
    what_nexus_knows: [
    ...
    why_it_matters:
      "Multiple expert lenses ensure member service, clinical safety, financial integrity, and governance perspectives all inform the modernization story.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:e19b955be610b9dbcbb76f109a4610ccea4cc793d5809fff6db5ebd50488ac7b",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    why_it_matters:
      "Managed-services scope shapes who runs the fragmented analytics estate and how member service and data bets would be resourced and governed.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:89249eb53df794514f93d7923adb621b4b22cc8af703470c269e9c88593ac4c8",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
  ...
  },
  {
    ...
    why_it_matters:
      "Agent Assist redesign depends on documented member service process flows, handoffs, and transcript governance that are not yet evidenced.",
    questions_supported: [
    ...
    context_gap_ids_used: ["gap-validation-needed"],
    source_context_hash:
      "sha256:ba3695846585e210fb52a30ee2911d6a087d442e13ce37ecfe812336084c4bde",
    generated_by: "claude",
    generated_model: "claude-opus-4-8",
    generated_at: "2026-07-15T18:06:18.633Z",
    validation_status: "passed",
