  ...
  executives: [
    {
      ...
      contradictions: [
        ...
        {
          claim:
            "CIO states IT has 'full visibility into our vendor landscape'",
    ...
    },
    {
      ...
      contradictions: [
        ...
        {
          claim:
            "Travel nurse spend reduction program 'on track' per operations dashboard",
    ...
    },
    {
      ...
      contradictions: [
        {
          claim:
            "Ensemble Health Partners reports prior auth average approval time of 3.1 days",
        ...
        {
          claim:
            "Net collection rate reported as 94.2% using internal methodology",
    ...
    },
    {
      ...
      contradictions: [
        {
          claim:
            "MA Stars improvement described as 'on the roadmap' in Q3 board materials",
        ...
        {
          claim:
            "HEDIS mental health access and medication adherence scores reflect clinical performance",
