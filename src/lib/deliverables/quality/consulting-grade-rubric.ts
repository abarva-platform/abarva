...
export function buildConsultingGradeReviewPrompt(args: {
  ...
  return [
    ...
    "- For Strategy, Value, and Scope governed drafts, a registered page/row locator action on an otherwise matching filename-cited parsed file is a pre-issue control, not by itself a reason to fail the current artifact gate.",
