...
//
// The first test is the one that matters. A scan of fifteen live artifacts
// fetched each and parsed it as HTML; ten were DOCX, the byte stream decoded
// into garbage, the garbage matched a hex pattern, and eight documents were
// reported as leaking internal hashes. None were. This file exists so that
...
describe("the guard that would have prevented the false positives", () => {
