...
const MOVES_SOLUTION_DESIGN: DeliverableStructure = {
  ...
  sections: [
    s("exec_decision", "Executive Decision & Design Basis", "The approved option, accepted architecture basis, design decision, and material open items in one compact read.", "mixed", [], "Keep under 300 words; lead with the decision and do not restate the full architecture."),
    s("journey_workflow", "End-to-End Journey & Human/AI Workflow", "The user journey, AI assistance, human decisions, exceptions, and measurable outcomes.", "mixed", [], "Keep under 450 words plus one workflow exhibit."),
    s("service_design", "Service & Component Design", "Responsibilities, interfaces, and interaction of the reusable services inherited from the accepted architecture.", "mixed", [], "Keep under 550 words plus a component interaction exhibit."),
    s("data_integration", "Data, Context & Integration Contracts", "Inputs, outputs, system-of-record boundaries, data products, interface patterns, and unresolved contracts.", "mixed", [], "Keep under 500 words; use a compact contract table."),
    s("controls_exceptions", "Controls, Exceptions & Decision Rights", "Human checkpoints, policy enforcement, exception handling, audit evidence, and prohibited autonomous actions.", "mixed", [], "Keep under 450 words plus one exception/control exhibit."),
    s("nfr_operability", "Non-Functional Design & Operability", "Security, privacy, resilience, observability, performance, support, and model operations requirements.", "mixed", [], "Keep under 450 words; distinguish confirmed requirements from open decisions."),
    s("acceptance_traceability", "Acceptance, Traceability & Open Decisions", "Acceptance criteria, trace to architecture decisions/evidence, dependencies, risks, and the decisions required before roadmap planning.", "mixed", [], "Keep under 450 words using concise tables."),
    s("recommendation", "Recommendation & Next Actions", "Approve, revise, or hold the solution design with named owners for open decisions.", "mixed", [], "Keep under 150 words."),
  ],
  requiredSectionKeys: [
    "exec_decision",
    "journey_workflow",
...
const MOVES_OPERATING_MODEL: DeliverableStructure = {
  ...
  sections: [
    s("exec_decision", "Executive Decision & Operating Thesis", "The operating-model decision, what changes, and what remains client-to-confirm.", "mixed", [], "Keep under 300 words."),
    s("human_ai_split", "Human/AI Work Split", "Work allocation across the priority journey, including prohibited autonomous decisions and exceptions.", "mixed", [], "Keep under 500 words plus one exhibit."),
    s("roles_raci", "Roles, Accountabilities & RACI", "Retained business, technology, risk, data, service, and partner roles with explicit accountability.", "mixed", [], "Keep under 600 words using role and RACI tables."),
    s("decision_controls", "Decision Rights, Controls & Escalation", "Approval thresholds, control ownership, override rights, forums, and escalation paths.", "mixed", [], "Keep under 550 words plus one decision-rights exhibit."),
    s("run_cadence", "Run Cadence, Monitoring & Service Management", "Operating forums, telemetry, incident/model handling, policy refresh, and continuous-improvement cadence.", "mixed", [], "Keep under 500 words using a cadence table."),
    s("adoption", "Adoption, Training & Business-Process Change", "Role-specific behavior change, enablement, adoption measures, and accountability for benefits realization.", "mixed", [], "Keep under 450 words; tie each action to the changed process and measure."),
    s("risks_open", "Risks, Open Decisions & Mobilization Actions", "Material operating risks, unresolved ownership, dependencies, and immediate actions before roadmap planning.", "mixed", [], "Keep under 400 words using concise tables."),
    s("recommendation", "Recommendation & Next Actions", "Approve, revise, or hold the operating model.", "mixed", [], "Keep under 120 words."),
  ],
  requiredSectionKeys: [
    "exec_decision",
    "human_ai_split",
...
const MOVES_SOURCING_STRATEGY: DeliverableStructure = {
  ...
  sections: [
    s("exec_decision", "Executive Decision & Recommended Posture", "The sourcing decision, recommendation, guardrails, and open inputs in one page-equivalent read.", "mixed", [], "Keep under 250 words."),
    s("capability_boundary", "Capability & Sourcing Boundary", "Capabilities inherited from the architecture, what is reusable, what requires market capacity, and explicit exclusions.", "mixed", [], "Keep under 400 words using a capability table."),
    s("options", "Sourcing Options & Trade-Offs", "Build, buy, configure, partner, and hybrid options assessed without naming unsupported vendors.", "mixed", [], "Keep under 525 words plus one options matrix."),
    s("evaluation_commercial", "Evaluation & Commercial Guardrails", "Decision criteria, evidence required, commercial principles, risk protections, and market-test questions.", "mixed", [], "Keep under 450 words using compact criteria and guardrail tables."),
    s("delivery_governance", "Delivery Model, Governance & Dependencies", "Retained ownership, partner boundaries, transition responsibilities, architecture conformance, and dependencies.", "mixed", [], "Keep under 400 words."),
    s("risks_open", "Risks, Open Decisions & Required Inputs", "Material sourcing risks, unresolved platform/vendor decisions, and evidence required before an event or award.", "mixed", [], "Keep under 350 words using a single table."),
    s("recommendation", "Recommendation & Next Actions", "Approve the posture, authorize a market test, or hold for evidence.", "mixed", [], "Keep under 100 words."),
  ],
  requiredSectionKeys: [
    "exec_decision",
    "capability_boundary",
