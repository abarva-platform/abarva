...
const MOVES_SOURCING_STRATEGY: DeliverableStructure = {
  ...
  sections: [
    s("exec_decision", "Executive Decision & Recommended Posture", "The sourcing decision, recommendation, guardrails, and open inputs in one page-equivalent read.", "mixed", [], "Keep under 200 words."),
    s("capability_boundary", "Capability & Sourcing Boundary", "Capabilities inherited from the architecture, what is reusable, what requires market capacity, and explicit exclusions.", "mixed", [], "Keep under 325 words using a capability table."),
    s("options", "Sourcing Options & Trade-Offs", "Build, buy, configure, partner, and hybrid options assessed without naming unsupported vendors.", "mixed", [], "Keep under 425 words plus one options matrix."),
    s("evaluation_commercial", "Evaluation & Commercial Guardrails", "Decision criteria, evidence required, commercial principles, risk protections, and market-test questions.", "mixed", [], "Keep under 350 words using compact criteria and guardrail tables."),
    s("delivery_governance", "Delivery Model, Governance & Dependencies", "Retained ownership, partner boundaries, transition responsibilities, architecture conformance, and dependencies.", "mixed", [], "Keep under 325 words."),
    s("risks_open", "Risks, Open Decisions & Required Inputs", "Material sourcing risks, unresolved platform/vendor decisions, and evidence required before an event or award.", "mixed", [], "Keep under 275 words using a single table."),
    s("recommendation", "Recommendation & Next Actions", "Approve the posture, authorize a market test, or hold for evidence.", "mixed", [], "Keep under 80 words."),
  ],
  requiredSectionKeys: [
    "exec_decision",
    "capability_boundary",
