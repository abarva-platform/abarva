...
const MOVES_OPERATING_MODEL: DeliverableStructure = {
  ...
  sections: [
    s("exec_decision", "Executive Decision & Operating Thesis", "The operating-model decision, what changes, and what remains client-to-confirm.", "mixed", [], "Keep under 350 words."),
    s("human_ai_split", "Human/AI Work Split", "Work allocation across the priority journey, including prohibited autonomous decisions and exceptions.", "mixed", [], "Keep under 600 words plus one exhibit."),
    s("roles_raci", "Roles, Accountabilities & RACI", "Retained business, technology, risk, data, service, and partner roles with explicit accountability.", "mixed", [], "Keep under 700 words using role and RACI tables."),
    s("decision_controls", "Decision Rights, Controls & Escalation", "Approval thresholds, control ownership, override rights, forums, and escalation paths.", "mixed", [], "Keep under 650 words plus one decision-rights exhibit."),
    s("run_cadence", "Run Cadence, Monitoring & Service Management", "Operating forums, telemetry, incident/model handling, policy refresh, and continuous-improvement cadence.", "mixed", [], "Keep under 600 words using a cadence table."),
    s("adoption", "Adoption, Training & Business-Process Change", "Role-specific behavior change, enablement, adoption measures, and accountability for benefits realization.", "mixed", [], "Keep under 550 words; tie each action to the changed process and measure."),
    s("risks_open", "Risks, Open Decisions & Mobilization Actions", "Material operating risks, unresolved ownership, dependencies, and immediate actions before roadmap planning.", "mixed", [], "Keep under 500 words using concise tables."),
    s("recommendation", "Recommendation & Next Actions", "Approve, revise, or hold the operating model.", "mixed", [], "Keep under 150 words."),
  ],
  requiredSectionKeys: [
    "exec_decision",
    "human_ai_split",
...
const MOVES_SOURCING_STRATEGY: DeliverableStructure = {
  ...
  sections: [
    s("exec_decision", "Executive Decision & Recommended Posture", "The sourcing decision, recommendation, guardrails, and open inputs in one page-equivalent read.", "mixed", [], "Keep under 350 words."),
    s("capability_boundary", "Capability & Sourcing Boundary", "Capabilities inherited from the architecture, what is reusable, what requires market capacity, and explicit exclusions.", "mixed", [], "Keep under 500 words using a capability table."),
    s("options", "Sourcing Options & Trade-Offs", "Build, buy, configure, partner, and hybrid options assessed without naming unsupported vendors.", "mixed", [], "Keep under 650 words plus one options matrix."),
    s("evaluation_commercial", "Evaluation & Commercial Guardrails", "Decision criteria, evidence required, commercial principles, risk protections, and market-test questions.", "mixed", [], "Keep under 550 words using compact criteria and guardrail tables."),
    s("delivery_governance", "Delivery Model, Governance & Dependencies", "Retained ownership, partner boundaries, transition responsibilities, architecture conformance, and dependencies.", "mixed", [], "Keep under 500 words."),
    s("risks_open", "Risks, Open Decisions & Required Inputs", "Material sourcing risks, unresolved platform/vendor decisions, and evidence required before an event or award.", "mixed", [], "Keep under 450 words using a single table."),
    s("recommendation", "Recommendation & Next Actions", "Approve the posture, authorize a market test, or hold for evidence.", "mixed", [], "Keep under 150 words."),
  ],
  requiredSectionKeys: [
    "exec_decision",
    "capability_boundary",
