...
const MOVES_SOLUTION_DESIGN: DeliverableStructure = {
  ...
  sections: [
    s("exec_decision", "Executive Decision & Design Basis", "The approved option, accepted architecture basis, design decision, and material open items in one compact read.", "mixed", [], "Keep under 350 words; lead with the decision and do not restate the full architecture."),
    s("journey_workflow", "End-to-End Journey & Human/AI Workflow", "The user journey, AI assistance, human decisions, exceptions, and measurable outcomes.", "mixed", [], "Keep under 550 words plus one workflow exhibit."),
    s("service_design", "Service & Component Design", "Responsibilities, interfaces, and interaction of the reusable services inherited from the accepted architecture.", "mixed", [], "Keep under 650 words plus a component interaction exhibit."),
    s("data_integration", "Data, Context & Integration Contracts", "Inputs, outputs, system-of-record boundaries, data products, interface patterns, and unresolved contracts.", "mixed", [], "Keep under 600 words; use a compact contract table."),
    s("controls_exceptions", "Controls, Exceptions & Decision Rights", "Human checkpoints, policy enforcement, exception handling, audit evidence, and prohibited autonomous actions.", "mixed", [], "Keep under 550 words plus one exception/control exhibit."),
    s("nfr_operability", "Non-Functional Design & Operability", "Security, privacy, resilience, observability, performance, support, and model operations requirements.", "mixed", [], "Keep under 550 words; distinguish confirmed requirements from open decisions."),
    s("acceptance_traceability", "Acceptance, Traceability & Open Decisions", "Acceptance criteria, trace to architecture decisions/evidence, dependencies, risks, and the decisions required before roadmap planning.", "mixed", [], "Keep under 550 words using concise tables."),
    s("recommendation", "Recommendation & Next Actions", "Approve, revise, or hold the solution design with named owners for open decisions.", "mixed", [], "Keep under 200 words."),
  ],
  requiredSectionKeys: [
    "exec_decision",
    "journey_workflow",
