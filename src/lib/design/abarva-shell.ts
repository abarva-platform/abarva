...
export const ABARVA_SHELL_CONFIG: AbarVaShellConfig = {
  ...
  navItems: [
    { surface: 'home', label: 'Knowledge', href: '/home' },
    { surface: 'programs', label: 'Moves', href: '/strategic-moves' },
    { surface: 'source', label: 'Source', href: '/source' },
    { surface: 'intelligence', label: 'Intelligence', href: '/intelligence' },
    { surface: 'control_tower', label: 'Tower', href: '/tower' },
