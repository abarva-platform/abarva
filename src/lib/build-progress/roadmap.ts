...
export const buildProgressRoadmap: BuildProgressRoadmap = {
  ...
  categories: [
    ...
    },
    {
      ...
      blockerCount: 3,
      summary:
        "Azure Container Apps serves app.abarva.ai; app.abarva.com DNS was unresolved from local verification.",
    },
  ],
  criticalPath: [
    {
  ...
  sliceQueue: [
    {
      ...
      risk: "medium",
      ownerRecommendation:
        "Code owns template; founder approves merge discipline.",
      dependencies: [
        "CYCLE_STATE discipline",
        "auto-merge retirement decision",
      ],
      acceptanceSummary:
    ...
    },
    {
      ...
      risk: "high",
      ownerRecommendation:
        "Code should align Source context contracts with global Nexus bundle shape.",
      dependencies: [
        "Canon AUTHORED-LOCKED",
        "existing runPipeline documented",
      ],
      acceptanceSummary:
    ...
    },
    {
      ...
      risk: "high",
      ownerRecommendation:
        "Code should implement deterministic quality scoring before model invocation.",
      dependencies: ["S1"],
      acceptanceSummary:
    ...
    },
    {
      ...
      risk: "high",
      ownerRecommendation:
        "Code should adapt runPipeline retrieve/assemble phases without prompt churn.",
      dependencies: ["S1", "S2"],
      acceptanceSummary:
    ...
    },
    {
      ...
      risk: "medium",
      ownerRecommendation:
        "Code should bind existing disclosure primitives to actual bundle scores.",
    ...
    },
    {
      ...
      risk: "critical",
      ownerRecommendation:
        "Code should codify Marcus T and Dr. L cross-tenant probes as regression tests.",
    ...
    },
    {
      ...
      risk: "medium",
      ownerRecommendation:
        "Product and Code should lock contract before further Programs UI work.",
  ...
  validationCommands: [
    ...
    },
    {
      ...
      scope: "full repo",
      latestNote:
        "Acceptance requires this to pass for the build-progress page.",
    },
    {
      id: "build",
    ...
    },
    {
      ...
      latestNote:
        "Last observed passing in this thread after dashboard refactor.",
    },
    {
      id: "nexus-tests",
    ...
    },
    {
      ...
      latestNote:
        "Run when Programs readiness contract or canonical proof changes.",
    },
  ],
  productionSignals: [
    {
      ...
      status: "code_complete",
      detail:
        "Core guard exists and Dr. L tenant-isolation check passed; broader live re-walk pending.",
    },
    {
      id: "dns",
      ...
      status: "blocked",
      detail:
        "app.abarva.ai resolves; app.abarva.com did not resolve from local verification.",
    },
    {
      id: "runtime",
      ...
      status: "in_progress",
      detail:
        "Nexus/Sentinel/Atlas exist; global Context Bundle and Steward runtime still open.",
    },
    {
      id: "content",
      ...
      status: "blocked",
      detail:
        "Hero deliverables and pattern library depth need founder/domain authoring.",
    },
    {
      id: "validation",
      ...
      status: "ready",
      detail:
        "Manual persona reports exist; automated persona/golden prompt harness is next.",
    },
  ],
  guidance: [
