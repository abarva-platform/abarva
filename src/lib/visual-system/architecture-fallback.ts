...
function baseNodes(): { current: ArchNode[]; target: ArchNode[] } {
  const current: ArchNode[] = [
    {
      ...
      layer: "experience",
      status: "existing",
      note: "Current operating decisions rely on human coordination.",
    },
    {
    ...
    },
    {
      ...
      layer: "core_systems",
      status: "existing",
      note: "[Open input] Confirm the authoritative user and case-management platform.",
    },
    {
      id: "system-transaction",
      label: "Transaction system of record",
      kind: "system",
      layer: "core_systems",
      status: "existing",
      note: "[Open input] Confirm the authoritative transaction and status source.",
    },
    {
      id: "system-knowledge",
      label: "Policy and knowledge sources",
      kind: "system",
      layer: "core_systems",
      status: "existing",
      note: "[Open input] Confirm the governed policy, knowledge, and reference sources.",
    },
    {
      id: "manual-data",
  ...
  const target: ArchNode[] = [
    ...
    },
    {
      ...
      layer: "application",
      status: "new",
      note: "Scores response options against policy and operating constraints.",
    },
    {
    ...
    },
    {
      ...
      layer: "core_systems",
      status: "existing",
      note: "[Architecture detail required] user, case, and interaction state.",
    },
    {
      ...
      layer: "core_systems",
      status: "existing",
      note: "[Architecture detail required] authoritative transaction and status data.",
    },
    {
      id: "knowledge-system",
      label: "Policy and knowledge service",
      kind: "system",
      layer: "core_systems",
      status: "existing",
      note: "[Architecture detail required] governed policy and response knowledge.",
    },
    {
      id: "approval-control",
...
const currentFlows: ArchFlow[] = [
  {
    id: "cur-1",
    from: "system-engagement",
    to: "manual-data",
    kind: "data",
    label: "interaction extracts",
  },
  {
    id: "cur-2",
...
function fallbackGaps(plan: DeliverablePlan | undefined): ObservedGap[] {
  ...
  const defaults: ObservedGap[] = [
    ...
    {
      id: "gap-2",
      observation: "Operational actions depend on several systems of record and handoffs.",
    ...
    {
      id: "gap-3",
      observation: "Human operators remain accountable for consequential decisions.",
...
export function buildGroundedArchitectureFallback(
  ...
  const bridge = gaps.map((g, i) => ({
    ...
    architectureResponse:
      i === 0
        ? "Operational context store grounds the AI recommendation agent."
        : i === 1
  ...
  return {
    ...
    currentStateFlow: [
      {
        ...
        dataSources: ["Interaction extracts", "Manual updates", "System alerts"],
        bottleneck: "Common context is not yet governed across decision teams.",
      },
      {
        id: "step-2",
        label: "Response options assembled",
        actor: "Workflow coordination team",
      ...
      },
      {
        ...
        decision: "Approve the recommended action or escalate.",
    ...
    current: {
      ...
      thesis: firstSentence(
        ...
        "The current state coordinates operating decisions through teams, extracts, and system-specific handoffs.",
      ),
      nodes: current,
      flows: currentFlows,
    },
    ...
    agentic: [
      {
        agentId: "assist-agent",
        role: "Recommend response options grounded in governed operating context.",
    ...
    patterns: [
      {
        ...
        appliesTo: ["assist-agent", "context-store", "recommendation-service"],
    ...
    controlPoints: [
      {
        ...
        what: "Defines who can approve, reject, or override AI-assisted recommendations.",
