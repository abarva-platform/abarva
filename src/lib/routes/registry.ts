...
const ROUTE_REGISTRY: ReadonlyArray<RouteRegistryEntry> = [
  ...
  },
  {
    ...
    label: 'Setup Connector Reconnect',
    shellKind: 'admin',
    surface: 'admin',
    primaryAgent: 'Steward',
    requiresAuth: true,
  ...
  },
  {
    ...
    requiresAuth: true,
    active: true,
    notes: 'Canonical Setup architecture route. /platform/admin/architecture is a legacy redirect bridge.',
  },
  {
    routeId: 'admin-policies',
    pattern: '/admin/policies',
    label: 'Setup Policies',
    shellKind: 'admin',
    surface: 'admin',
    primaryAgent: 'Steward',
    requiresAuth: true,
