...
const ROUTE_REGISTRY: ReadonlyArray<RouteRegistryEntry> = [
  ...
  // --- Admin ---
  {
    ...
    requiresAuth: true,
    active: true,
    notes: 'Legacy /platform/admin redirects to /admin; /admin is the canonical Admin operator entry.',
  },
  {
    routeId: 'admin-setup-data-loads',
    pattern: '/admin/setup',
    label: 'Admin Data Loads',
    shellKind: 'admin',
    surface: 'admin',
    primaryAgent: 'Steward',
    requiresAuth: true,
  ...
  {
    routeId: 'admin-connector-detail',
    pattern: '/admin/connectors/[connectorId]',
    label: 'Admin Connector Detail',
    shellKind: 'admin',
    surface: 'admin',
    primaryAgent: 'Steward',
    requiresAuth: true,
  ...
  {
    routeId: 'admin-connector-reconnect',
    pattern: '/admin/connectors/[connectorId]/reconnect',
    label: 'Admin Connector Reconnect',
    shellKind: 'admin',
    surface: 'admin',
    primaryAgent: 'Steward',
    requiresAuth: true,
  ...
  {
    routeId: 'admin-invite',
    pattern: '/admin/invite',
    label: 'Admin Invite User',
    shellKind: 'admin',
    surface: 'admin',
    primaryAgent: 'Steward',
    requiresAuth: true,
  ...
  },
  {
    ...
    requiresAuth: true,
    active: true,
    notes: 'Canonical Admin architecture route. /platform/admin/architecture is a legacy redirect bridge.',
  },
  {
    routeId: 'admin-policies',
