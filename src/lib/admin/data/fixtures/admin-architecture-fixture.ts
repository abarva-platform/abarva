...
const ARCHITECTURE_PLANES_FIXTURE: ReadonlyArray<ArchitecturePlaneRecord> = [
  {
    id: "app",
    label: "App Plane",
    components: ["Programs", "Source", "Intelligence", "Tower", "Admin"],
  },
  {
    id: "agent",
    label: "Agent Plane",
    components: ["Nexus", "Sentinel", "Atlas", "Steward"],
  },
  {
    id: "context",
    label: "Context Plane",
    components: ["Work object", "state", "evidence", "missing inputs"],
  },
  {
    id: "evidence",
    label: "Evidence Plane",
    components: ["Datasets", "artifacts", "claims", "confidence"],
  },
  {
    id: "data",
    label: "Data Plane",
    components: ["Postgres", "Blob", "vector/search", "graph"],
  },
  {
    id: "gateway",
    label: "Gateway + Tools",
    components: ["Policy", "audit", "cost", "redaction"],
  },
  {
    id: "deployment",
    label: "Deployment",
    components: ["SaaS", "dedicated tenant", "private data plane"],
  },
];
...
const ARCHITECTURE_COMPONENTS_FIXTURE: ReadonlyArray<ArchitectureComponentRecord> =
  [
    ...
    },
    {
      ...
      dependencies: [],
      summary:
        "Object storage for artifacts (Vercel Blob today, Azure Blob target).",
    },
    {
      id: "vector-search",
      planeId: "data",
    ...
    },
    {
      ...
      state: "deferred",
      dependencies: ["saas"],
      summary: "Single-tenant Azure deploy target (Wave 27).",
    },
    {
