...
export const ADMIN_SUB_SECTIONS: ReadonlyArray<AdminSubSection> = [
  { id: 'overview', label: 'Overview', subtitle: 'What needs setup?', href: '/admin' },
  { id: 'data-trust', label: 'Data Trust', subtitle: 'Loaded → usable evidence', href: '/admin/data-trust' },
  { id: 'connectors', label: 'Connectors', subtitle: 'External systems', href: '/admin/connectors' },
  { id: 'users-access', label: 'Users & Access', subtitle: 'Roles and risk', href: '/admin/users-access' },
  { id: 'agent-readiness', label: 'Agent Readiness', subtitle: 'Nexus/Sentinel/Atlas/Steward', href: '/admin/agent-readiness' },
...
export const DEFAULT_AGENT_CARDS: ReadonlyArray<AgentCardModel> = [
  { id: 'steward', label: 'Steward', governs: 'Gate, access, readiness', posture: 'BLOCKED' },
  { id: 'nexus', label: 'Nexus', governs: 'Workflow orchestration', posture: 'PARTIAL' },
  { id: 'sentinel', label: 'Sentinel', governs: 'Evidence gaps', posture: 'THIN' },
  { id: 'atlas', label: 'Atlas', governs: 'Executive tradeoffs', posture: 'THIN' },
];
