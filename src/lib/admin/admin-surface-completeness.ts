...
export function buildAdminPanelInventory(): AdminPanel[] {
  return [
    ...
    },
    {
      ...
      sliceId: "PROD5",
      notes:
        "Shows last-known Azure deployment status from the deterministic ingestion read model; no live Azure polling at render time.",
    },
    {
...
export function buildAdminSurfaceCompletenessReport(): AdminSurfaceCompletenessReport {
  ...
  const implementedCount = panels.filter(
