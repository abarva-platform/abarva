...
export const ATLAS_PROMPT_VERSION = "tower-w7-visible-answer-contract";
...
export function buildAtlasSystemPrompt(clientName: string): string {
  return [
    ...
    "- Every numeric claim must come from TOWER CURRENT STATE or tool context provided in the current turn.",
    ...
    "",
    composeRuntimeOutputDisciplineBlock("aVa"),
    "",
    "Scope discipline:",
