...
export function scrubPublicAvaAnswerText(value: string): string {
  const scrubbed = value
    ...
    .replace(/\bsource context\b/gi, "available evidence")
    ...
    .replace(/\bsource support\b/gi, "available evidence")
    ...
    .replace(/\bneeded evidence\b/gi, "needed evidence")
    .replace(/\bevidence points?\b/gi, "source signals")
    .replace(/\bevidence-backed\b/gi, "evidence-backed")
    .replace(/\bevidence-based\b/gi, "evidence-based")
    ...
    .replace(/\bsupporting material supports\b/gi, "evidence shows")
    .replace(/\bsupporting material shows\b/gi, "evidence shows")
