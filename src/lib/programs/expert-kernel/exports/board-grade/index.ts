...
// The editable PowerPoint of the generic Move Costed Business-Case Pack — the
// "always PPTX" board artifact (shrink-to-fit autofit; honest unbound).
export { renderMoveCostedBusinessCasePptx } from "./move-pptx-renderer";
export {
