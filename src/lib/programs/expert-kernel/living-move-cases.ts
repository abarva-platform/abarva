...
// cases — Apex Retail, Meridian Health System, First Capital Financial. This
...
//   • First Capital Financial — Fraud Detection Enhancement. Three haircut
...
// ===========================================================================
// First Capital Financial — Fraud Detection Enhancement
// ===========================================================================
...
> = Object.freeze({
  ...
  arcturus: {
    ...
    provenance:
      'First Capital Financial · Fraud Detection Enhancement · costed ' +
...
export function isLivingMoveCaseId(
  value: unknown,
): value is LivingMoveCaseId {
  return (
    typeof value === 'string' &&
