...
export const VISIBLE_ANSWER_CONTRACT_PROMPT = [
  ...
  '- No session-history phrases such as "same answer as before", "same answer as the last four turns", "last three times", "earlier turns", or "this session"; answer the current question as if it stands alone.',
