...
export function evaluateSupabaseBootGuard(env: NodeJS.ProcessEnv): SupabaseBootGuardResult {
...
export function assertNoSupabaseRuntime(): void {
  ...
  throw new Error('Supabase runtime configuration is forbidden for Azure Postgres production.');
}
