...
const MERIDIAN_HEALTHCARE_TEMPLATE_SEEDS: ContextTemplateSeed[] = [
  ...
  {
    id: "org-structure-decision-rights",
    dimension: "org_decision_rights",
    label: "Org structure and decision rights",
    acceptedFormats: ["csv"],
    requiredFields: [
      "role_id",
      "role_title",
    ...
    optionalFields: [],
    ownerRole: "Chief Administrative Officer",
    refreshCadence: "quarterly",
    unlocks: MERIDIAN_HEALTHCARE_UNLOCKS,
  },
  {
  ...
  {
    id: "kpi-library",
    dimension: "kpi_library",
    label: "Enterprise KPI library",
    acceptedFormats: ["csv"],
    requiredFields: [
      "kpi_id",
      "kpi_name",
      ...
      "target_value",
      "owner_role",
      "provider_plan_shared",
    ],
    optionalFields: [],
    ownerRole: "VP Enterprise Performance",
    refreshCadence: "quarterly",
    unlocks: MERIDIAN_HEALTHCARE_UNLOCKS,
  },
  {
    id: "databricks-target-model",
    dimension: "databricks_lakehouse_target",
    label: "Azure Databricks lakehouse target model",
    acceptedFormats: ["csv"],
    requiredFields: [
      "layer",
      "component",
      "current_state",
      "target_state",
      "unity_catalog_domain",
      "migration_wave",
      "owner_role",
    ],
    optionalFields: [],
    ownerRole: "Chief Data Architect",
    refreshCadence: "monthly",
    unlocks: MERIDIAN_HEALTHCARE_UNLOCKS,
  },
  {
    id: "plan-provider-analytics",
    dimension: "plan_provider_analytics",
    label: "Plan and provider analytics",
    acceptedFormats: ["csv"],
    requiredFields: [
      "measure",
      "line_of_business",
  ...
  {
    id: "use-case-evidence-register",
    dimension: "use_case_evidence",
    label: "Use-case evidence register",
    acceptedFormats: ["csv"],
    requiredFields: [
      "use_case_id",
      "use_case",
    ...
    optionalFields: [],
    ownerRole: "Transformation Office Lead",
    refreshCadence: "monthly",
    unlocks: MERIDIAN_HEALTHCARE_UNLOCKS,
  },
  {
