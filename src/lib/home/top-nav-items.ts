...
export const TOP_NAV_ITEMS: ReadonlyArray<TopNavItem> = [
  {
    // Demo IA reset (2026-06-18): Home is a signed-in executive hub.
    // Setup/Admin remains available under /admin, but top-nav Home
    // should not land buyers in setup plumbing.
    id: 'home',
    label: 'Home',
    href: '/home',
    moduleKey: null,
