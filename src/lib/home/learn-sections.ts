...
export const LEARN_SECTIONS: ReadonlyArray<LearnSection> = [
  {
    ...
    shellPlaceholder:
      'Quickstart guide shell. For now, start at the AI Initiatives panel to see what is already loaded for your tenant.',
  },
  {
    id: 'glossary',
    index: 2,
    ...
    shellPlaceholder:
      'Glossary index shell. Use the term list below for the current reference structure.',
    sampleSubPages: [
  ...
  },
  {
    ...
    shellPlaceholder:
      'Doctrine reference shell for the opinionated framework underneath AbarVa.',
    sampleSubPages: [
  ...
  },
  {
    ...
    shellPlaceholder:
      'Agent reference shell. Each agent has a job, a surface, and a personality.',
    sampleSubPages: [
  ...
  },
  {
    ...
    shellPlaceholder:
      'Workflow guide shell for the most-asked tasks, walked through end to end.',
    sampleSubPages: [
