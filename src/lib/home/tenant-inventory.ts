...
const APEX_IT: ITStackRow[] = [
  ...
  { id: 'apx-it-04', name: 'SAP ECC 6.0', category: 'ERP', vendor: 'SAP', segment: 'Tier 1 · Strategic', budgetAnnual: 22_000_000, renewalDate: d(365), health: 'At risk', aiCapability: 'Extension', integrations: 86 },
...
const APEX_VENDORS: VendorRow[] = [
  ...
  { id: 'apx-v-11', name: 'OneTrust', category: 'Technology', relationshipTier: 'Standard', annualSpend: 560_000, contractEnd: d(184), relationshipOwner: 'CISO · Sarah Whitfield', riskScore: 'Low', aiExposure: 'Direct · sanctioned' },
  { id: 'apx-v-12', name: 'CrowdStrike', category: 'Technology', relationshipTier: 'Strategic partner', annualSpend: 890_000, contractEnd: d(156), relationshipOwner: 'CISO · Sarah Whitfield', riskScore: 'Low', aiExposure: 'Direct · sanctioned' },
  ...
  { id: 'apx-v-17', name: 'Vendor that recently failed its SOC 2 audit', category: 'Technology', relationshipTier: 'Under review', annualSpend: 340_000, contractEnd: d(28), relationshipOwner: 'CISO · Sarah Whitfield', riskScore: 'Critical', aiExposure: 'Direct · unsanctioned' },
  ...
  { id: 'apx-v-21', name: 'Shadow AI tool · unknown procurement path', category: 'Technology', relationshipTier: 'Under review', annualSpend: 0, contractEnd: d(0), relationshipOwner: 'CISO · Sarah Whitfield', riskScore: 'Critical', aiExposure: 'Direct · unsanctioned' },
...
const MERIDIAN_VENDORS: VendorRow[] = [
  ...
  { id: 'mer-v-04', name: 'Cohere Health', category: 'Technology', relationshipTier: 'Strategic partner', annualSpend: 2_040_000, contractEnd: d(101), relationshipOwner: 'President Health Plans · Thomas Hartwell', riskScore: 'Low', aiExposure: 'Direct · sanctioned' },
  ...
  { id: 'mer-v-06', name: 'Paige AI', category: 'Technology', relationshipTier: 'Under review', annualSpend: 610_000, contractEnd: d(143), relationshipOwner: 'Chief Physician Executive · Dr. Marcus Reid', riskScore: 'High', aiExposure: 'Direct · sanctioned' },
