...
export const ACTIVE_ROUTE_OWNERSHIP_MAP: ActiveRouteOwnershipEntry[] = [
  ...
  },
  {
    ...
    importedShellOrNav: ['SourceFoundationShell', 'SentinelEngagementCanvas', 'SourceCommercialEventSection'],
    currentPrimaryVisibleComponent: 'SentinelEngagementCanvas + SourceCommercialEventSection',
    expectedCanonicalShell: 'SourceCanonShell or SourceFoundationShell (canon-compliant)',
    expectedCanonicalWordmark: 'AbarvaWordmark',
    compliance: 'partial',
