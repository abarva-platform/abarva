...
const ROUTE_RULES: RouteRule[] = [
  ...
  },
  {
    ...
    ownerSurface: 'source',
    requiredCanonicalShellMarkers: ['SourceCanonShell'],
    requiredWorkflowMarkers: ['Event → Pricing → Risk → BAFO → Readiness → Missions → Signals'],
    disallowedLegacyImports: ['StewardAdminRail'],
    remediation: 'Use SourceCanonShell on Source dashboard route.',
  },
  {
    ...
    requiredWorkflowMarkers: ['Event → Pricing → Risk → BAFO → Readiness → Missions → Signals'],
    disallowedLegacyImports: ['StewardAdminRail'],
    remediation: 'Use SourceCanonShell on source events index route.',
  },
  {
    routePattern: '/source/events/[eventId]',
    routeFile: 'src/app/(maestro)/source/events/[eventId]/page.tsx',
    ownerSurface: 'source',
    requiredCanonicalShellMarkers: ['SourceCanonShell', 'SourceCommercialEventSection'],
    requiredWorkflowMarkers: ['Event → Pricing → Risk → BAFO → Readiness → Missions → Signals'],
    disallowedLegacyImports: ['StewardAdminRail'],
    remediation: 'Ensure event detail route mounts SourceCommercialEventSection and canonical shell.',
  },
  {
