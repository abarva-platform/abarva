...
export const SOURCING_PRICING_PATTERNS: PatternSeed[] = [
  {
    ...
    pricingBenchmarks: [
      {
        ...
        model: "hybrid",
        metric:
          "Committed entitlement dimensions with separately governed additional usage",
      ...
      },
      {
        ...
        model: "usage-based",
        metric:
          "Metered item, usage record, threshold alert, credit, and rate-card governance",
      ...
      },
      {
        ...
        model: "subscription",
        metric:
          "Auto-renewal, opt-out, coterminosity, prorated term, and price-level treatment",
    ...
    riskFactors: [
      {
        ...
        contractualRemedies: [
          "Metric schedule exhibit",
          "Usage audit rights",
          "Invoice traceability requirement",
        ],
        sourceBasis: [AWS_SAAS_CONTRACTS, STRIPE_USAGE_BASED_BILLING],
      },
      {
        ...
        contractualRemedies: [
          "Bundle decomposition exhibit",
          "SKU substitution language",
          "Renewal baseline schedule",
        ],
    ...
    industryVariants: [
      ...
      },
      {
        ...
        additionalRequirements: [
          "PHI boundary by charge line",
          "AI data-use review",
          "Support access and audit logging schedule",
        ],
      },
      {
        industry: "retail_cpg",
