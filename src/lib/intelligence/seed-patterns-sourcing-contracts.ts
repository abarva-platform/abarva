...
export const SOURCING_CONTRACT_PATTERNS: PatternSeed[] = [
  {
    ...
    regulatoryChips: [
      ...
      "Privacy-review-if-personal-data",
      "Security-review-if-confidential-data",
    ],
    relatedPatternIds: [
      "PAT-SRC-001",
      "PAT-SRC-002",
    ...
    riskFactors: [
      {
        ...
        contractualRemedies: [
          "Renewal uplift cap",
          "Advance price notice",
          "Non-renewal acknowledgement",
          "Quantity reduction right",
        ],
      },
    ],
    body: `## Summary
    ...
    standardClauses: [
      {
        ...
        walkawayTriggers: [
          ...
          "Exit support is available only at unspecified rates or subject to vendor discretion.",
    ...
    riskFactors: [
      {
        ...
        contractualRemedies: [
          "Data return covenant",
          "Transition assistance schedule",
          "Successor cooperation covenant",
