  ...
  try {
    ...
    if (
      ...
      const repairUser = [
        ...
        "For prioritization, funding, scale, hold, stop, or sequencing questions, prefer executive-canvas-sequencing.",
        "For portfolio tradeoff or value-readiness questions, prefer value-readiness-matrix.",
        "For dependency, prerequisite, gate, roadmap, or unlock-value questions, prefer gate-to-value-roadmap.",
        "For trust, governance, evidence quality, assumption, missing-data, or signoff questions, prefer proof-boundary-card.",
