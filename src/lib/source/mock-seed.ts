...
import { getSourceCorpusUpliftPatternSections } from "./source-corpus-uplift";
...
const events: SourcingEventDetail[] = [
    ...
    stages: [
      {
        ...
        status: "complete",
        summary:
          "Executive sponsor, objective, and sourcing perimeter were accepted.",
        gate: {
      ...
      },
      {
        ...
        status: "blocked",
        summary:
          "Scope is framed, but missing application inventory and analytics workload data block a credible transition to sourcing strategy.",
        gate: {
          ...
          blocker:
            "Application inventory and analytics workload baseline still missing.",
        },
      },
      {
        ...
        status: "not_started",
        summary:
          "Strategy remains locked until baseline inputs are uploaded and reviewed.",
        gate: {
      ...
      },
      {
        ...
        status: "not_started",
        summary:
          "Realization begins once the partner is selected and the modernization work is mobilized.",
        gate: {
    ...
    alerts: [
      {
        ...
        detail:
          "The event has been waiting 12 days on client inputs and should be treated as at-risk until the baseline is complete.",
        severity: "critical",
        status: "open",
      },
      {
        ...
        detail:
          "Line items exist, but evidence depth is uneven until baseline uploads are complete.",
        severity: "warning",
        status: "open",
      },
    ],
    artifacts: [
      {
        ...
        status: "draft",
        summary:
          "Structured input request for application, workload, contract, and delivery baseline.",
        sourceCount: 0,
      ...
      },
      {
        ...
        status: "draft",
        summary:
          "Projected value by workstream with assumption and measurement placeholders.",
        sourceCount: 2,
        updatedAt: "2026-04-24",
      },
    ],
    ...
    dataReadiness: [
      {
        ...
        confidence: "high",
        workflowImpact:
          "Can support Scope framing and RFP application portfolio language.",
        agentRecommendation:
          "Sentinel can use this as scope evidence, but should still caveat workload sizing.",
      ...
      },
      {
        ...
        confidence: "low",
        workflowImpact:
          "Blocks Rich-tier Scope and makes pricing normalization unsafe.",
        agentRecommendation:
          "Sentinel should request workload volumes before strategy design expands.",
      ...
      },
      {
        ...
        confidence: "low",
        workflowImpact:
          "Limits support sizing and weakens vendor run-cost comparison.",
        agentRecommendation:
          "Sentinel should include ticket history in the minimum data request.",
      ...
      },
      {
        ...
        confidence: "medium",
        workflowImpact:
          "Supports directional value framing but should not be treated as validated baseline.",
        agentRecommendation:
          "Sentinel should keep spend claims caveated until evidence is validated.",
      ...
      },
      {
        ...
        confidence: "low",
        workflowImpact:
          "Prevents confident service-level requirements and transition risk sizing.",
        agentRecommendation:
          "Sentinel should request current SLA performance before RFP release.",
      ...
      },
      {
        ...
        confidence: "medium",
        workflowImpact:
          "Shows contract presence, but exclusions and termination terms are not citeable yet.",
        agentRecommendation:
          "Sentinel should not cite contract terms until parsing and validation complete.",
      ...
      },
      {
        ...
        confidence: "low",
        workflowImpact:
          "Security requirements can be outlined, but approval-grade language needs validation.",
        agentRecommendation:
          "Steward should route security requirements back for owner confirmation.",
      ...
      },
      {
        ...
        confidence: "low",
        workflowImpact:
          "Blocks clear scope split and transition responsibility language.",
        agentRecommendation:
          "Sentinel should ask the client to confirm retained roles before RFP drafting.",
  ...
  },
  {
    ...
    isAtRisk: false,
    valueAtStakeUsd:
      SOURCE_GOLDEN_EVENT_VALUES_USD[SOURCE_GOLDEN_EVENT_IDS.amsConsolidation],
    projectedValueUsd:
      SOURCE_GOLDEN_EVENT_VALUES_USD[SOURCE_GOLDEN_EVENT_IDS.amsConsolidation],
    realizedValueUsd: 0,
    nextDecision:
      "Lock the sourcing model before packaging the vendor exercise.",
    synopsis:
    ...
    stages: [
      {
        ...
        status: "complete",
        summary:
          "CIO office sponsored the assessment and declared the retained-organization question in scope.",
        gate: {
      ...
      },
      {
        ...
        status: "complete",
        summary:
          "Service towers, vendor inventory, and run spend were collected.",
        gate: {
      ...
      },
      {
        ...
        status: "active",
        summary:
          "The team is deciding between tower consolidation paths and the vendor shortlist is nearly ready.",
        gate: {
      ...
      },
      {
        ...
        status: "not_started",
        summary:
          "Selection will begin once the sourcing model and shortlist are approved.",
        gate: {
      ...
      },
      {
        ...
        status: "not_started",
        summary:
          "Value tracking starts after partner selection and mobilization.",
        gate: {
    ...
    alerts: [
      {
        ...
        detail:
          "The event is moving well, but the sourcing model decision should not drift into package assembly.",
        severity: "info",
        status: "open",
      },
    ],
  ...
  },
  {
    ...
    isAtRisk: false,
    valueAtStakeUsd:
      SOURCE_GOLDEN_EVENT_VALUES_USD[SOURCE_GOLDEN_EVENT_IDS.digitalAppBuild],
    projectedValueUsd:
      SOURCE_GOLDEN_EVENT_VALUES_USD[SOURCE_GOLDEN_EVENT_IDS.digitalAppBuild],
    realizedValueUsd: 0,
    ...
    stages: [
      {
        ...
        status: "complete",
        summary:
          "Product intent, timeline, and delivery constraints were agreed.",
        gate: {
      ...
      },
      {
        ...
        status: "blocked",
        summary:
          "Responses are in flight, but two vendors still owe full pricing templates.",
        gate: {
    ...
    alerts: [
      {
        ...
        detail:
          "Pricing template gaps should be resolved before the event drifts into ad hoc vendor comparison.",
        severity: "warning",
        status: "open",
      },
    ],
    artifacts: [
      {
        ...
        status: "draft",
        summary:
          "Structured vendor package and response normalization boundary.",
        sourceCount: 1,
        updatedAt: "2026-04-24",
      },
      {
        ...
        status: "draft",
        summary:
          "Selection criteria prepared for use once responses are complete.",
        sourceCount: 1,
        updatedAt: "2026-04-24",
      },
    ],
    ...
    stages: [
      {
        ...
        status: "complete",
        summary:
          "CIO office sponsored the consolidation. Scope perimeter and business case accepted.",
        gate: {
      ...
      },
      {
        ...
        status: "complete",
        summary:
          "40+ application estate scoped. Service towers (infrastructure, applications, data platform) defined.",
        gate: {
      ...
      },
      {
        ...
        status: "complete",
        summary:
          "Tower consolidation strategy agreed. Single preferred-supplier model selected.",
        gate: {
      ...
      },
      {
        ...
        status: "complete",
        summary:
          "RFP issued to 4 vendors with full pricing template and SLA framework.",
        gate: {
          id: "gate-src-004-rfp",
      ...
      },
      {
        ...
        status: "complete",
        summary:
          "All 4 vendor responses received. Pricing normalisation completed. Sentinel pattern signals detected.",
        gate: {
      ...
      },
      {
        ...
        status: "complete",
        summary:
          "Evaluation scorecard completed. Northstar and ArcVault advanced to BAFO. BlueMaster and DataPeak excluded.",
        gate: {
      ...
      },
      {
        ...
        status: "active",
        summary:
          "BAFO Round 1 in progress. Northstar and ArcVault invited. Responses due May 15, 2026.",
        gate: {
      ...
      },
      {
        ...
        status: "not_started",
        summary:
          "Selection pending BAFO outcome. Target: award recommendation by May 30, 2026.",
        gate: {
      ...
      },
      {
        ...
        status: "not_started",
        summary:
          "Contract mobilisation will begin after CIO award approval. Target: operational by Q3 2026.",
        gate: {
      ...
      },
      {
        ...
        status: "not_started",
        summary:
          "Value tracking starts post-mobilisation. CDP integration timeline is the primary value dependency.",
        gate: {
    ...
    alerts: [
      {
        ...
        detail:
          "Northstar Managed Services and ArcVault Managed responses due in 19 days. Sentinel will prompt follow-up if no confirmation received by May 10.",
        severity: "info",
        status: "open",
      },
      {
        ...
        detail:
          "Sentinel has detected that the AMS selection timeline and CDP data migration window (Q3 2026) are correlated. A selection delay past end of June compresses the CDP onboarding window below the minimum 8-week threshold.",
        severity: "warning",
        status: "open",
      },
    ],
    artifacts: [
      {
        ...
        status: "approved",
        summary:
          "CIO-sponsored AMS consolidation brief covering 40+ applications, service towers, and preferred-supplier rationale.",
        sourceCount: 6,
      ...
      },
      {
        ...
        status: "approved",
        summary:
          "Full RFP issued to 4 vendors. Includes pricing template, SLA framework, and evaluation criteria.",
        sourceCount: 4,
      ...
      },
      {
        ...
        status: "approved",
        summary:
          "Completed evaluation across 4 vendors. Northstar and ArcVault shortlisted for BAFO.",
        sourceCount: 4,
        updatedAt: "2026-04-24",
      },
    ],
  ...
  parsingErrors: [
    {
      code: "lowConfidence",
      message:
        "Seed placeholder only; no real vendor response has been uploaded or parsed.",
      recoverable: true,
    },
  ],
...
export function getSourceEventSeed(
  eventId: string,
): SourcingEventDetail | null {
  return events.find((event) => event.id === eventId) ?? null;
}

export function getSourceArtifactSeed(
  eventId: string,
  artifactId: string,
): SourceArtifactDetail | null {
  return (
    artifactDetails.find(
      (artifact) => artifact.eventId === eventId && artifact.id === artifactId,
    ) ?? null
  );
}
...
export function getSourceEvidenceSeed(
  event: SourcingEventDetail,
): SourceEvidenceContext[] {
  if (event.id === SOURCE_GOLDEN_EVENT_IDS.dataAiModernization) {
...
export function getSourceAttachmentSeed(
  ...
  if (
    ...
    selectedAttachmentIds.includes(
      digitalVendorResponsePlaceholderAttachment.id,
    )
  ) {
...
export function getSourceDashboardSeed(): AbarvaSourceDashboardData {
  ...
  return {
    ...
    metrics: {
      ...
      waitingEvents: summaries.filter((event) =>
        SOURCE_WAITING_LIFECYCLE_STATUSES.includes(event.status),
      ).length,
    ...
    attentionItems: [
      {
        ...
        detail:
          "Application inventory and analytics workload data are still missing after 12 days.",
        severity: "critical",
        owner: "Client PMO Lead",
      ...
      },
      {
        ...
        detail:
          "The event is healthy, but the shortlist and sourcing model should be confirmed before packaging work expands.",
        severity: "info",
        owner: "CIO Office",
      ...
      },
      {
        ...
        detail:
          "Two vendors still owe pricing templates, which makes the response set non-comparable.",
        severity: "warning",
        owner: "Procurement Lead",
    ...
    responses: [
      {
        ...
        assumptions: [
          "Retained roles include 40% shared support for first quarter.",
          "Automation savings depend on ticket mix stability.",
        ],
      ...
      },
      {
        ...
        assumptions: [
          "Commercial model assumes fixed run cost uplift in year 1.",
        ],
      ...
      },
      {
        ...
        assumptions: [
          "Vendor assumes retained team provides runbooks in week 2.",
        ],
...
export function getSourceVendorResponseSeed(
  eventId: string,
): SourceVendorResponseSeed {
  const fallback: SourceVendorResponseSeed = { eventId, responses: [] };
  return (
    SOURCE_VENDOR_RESPONSE_SEEDS.find((seed) => seed.eventId === eventId) ??
    fallback
  );
}
...
const SOURCE_PRICING_NORMALIZATION_SEEDS: SourcePricingSeed[] = [
  {
    ...
    vendors: [
      ...
      },
      {
        ...
        optionals: ["Optional reporting add-on"],
        exclusions: [
...
export function getSourcePricingNormalizationSeed(
  eventId: string,
): SourcePricingSeed {
  const fallback: SourcePricingSeed = { eventId, vendors: [] };
  return (
    SOURCE_PRICING_NORMALIZATION_SEEDS.find(
      (seed) => seed.eventId === eventId,
    ) ?? fallback
  );
}
...
export function getSourceRfpReadinessSeed(
  eventId: string,
): SourceRfpReadinessSeed {
  return (
    SOURCE_RFP_READINESS_SEEDS.find((seed) => seed.eventId === eventId) ?? {
      eventId,
      blockers: [],
    }
  );
...
export function getSourceArtifactStatusStripSeed(
  eventId: string,
  ...
  return (
    SOURCE_ARTIFACT_STATUS_STRIP_SEEDS.find(
      (seed) => seed.eventId === eventId,
    ) ?? fallback
  );
}
