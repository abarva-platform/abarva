  ...
  it("projects dense source files into Source read-model rows without upgrading synthetic values", () => {
      ...
      contracts: [
        {
          ...
          termination_rights:
            "termination for convenience with transition assistance fees",
    ...
    expect(projection.qualityGate).toEqual({
      ...
      rowCounts: {
        ...
        negotiationFindings: 0,
        negotiationLevers: 0,
        contractIntelligence: 1,
      },
    });
      ...
      baseline: {
        metrics: expect.arrayContaining([
          expect.objectContaining({
            ...
            meaning: expect.stringContaining("recurring amount"),
          }),
        ]),
      },
