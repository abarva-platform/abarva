    ...
    negotiationFindings: [
      {
        ...
        dataset_version: "meridian-contract-depth-v1-20260828",
        contract_id: "MER-TECH-AMS-001",
        finding_id: "F-AMS-001",
        source_row_id: "finding:MER-TECH-AMS-001:01",
      },
    ],
    negotiationLevers: [
      {
        ...
        contract_id: "MER-TECH-AMS-001",
        lever_id: "L-AMS-001",
        source_row_id: "lever:MER-TECH-AMS-001:01",
      },
    ],
  };
}
...
describe("adaptContractDepthPackage", () => {
  it("preserves every Layer 1 source family as a named Layer 2 adapter output", () => {
    ...
    expect(adapted.qualityGate.rowCounts).toMatchObject({
      ...
      resourceModelAdapter: 1,
      pricingBridgeAdapter: 1,
      invoiceLineAdapter: 1,
      batchOperationsAdapter: 1,
      qbrAdapter: 1,
      optimizationAdapter: 1,
      negotiationFindingAdapter: 1,
      negotiationLeverAdapter: 1,
    ...
    expect(adapted.qualityGate.richness).toMatchObject({
      ...
      contractsWithNegotiationFindings: 1,
      contractsWithNegotiationLevers: 1,
      contractsWithChangeOrders: 1,
      contractsWithPageText: 1,
      contractsWithRecurringChangeOrders: 1,
      managedServiceContractsWithResourceModel: 1,
      managedServiceContractsWithInvoiceLines: 1,
      managedServiceContractsWithBatchVolumetrics: 1,
      managedServiceContractsWithQbrScorecards: 1,
