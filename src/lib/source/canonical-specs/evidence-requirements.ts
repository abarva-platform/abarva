...
const SCOPE: SourceEvidenceRequirement[] = [
  {
    ...
    stage: 'scope',
    label: 'Application economics inventory',
    sourceLabel: 'CMDB / finance export',
    minimumState: 'Usable Evidence',
    level: 'required',
    description: 'Application IDs with annual run cost, loaded FTE cost, and variable cost share.',
    unlocks: 'Scope memo economics; volume-band and retained-cost levers.',
  },
  {
  ...
  },
  {
    ...
    stage: 'scope',
    label: 'Service tower volumetrics',
    sourceLabel: 'ITSM / finance baseline',
    minimumState: 'Available',
    level: 'required',
    description: 'Service-tower economics: change-order spend, avoidable share, volume decline, automatable pool, SLA miss rate.',
    unlocks: 'Scope §3 economics; volume-band, scope-leakage, and productivity levers.',
  },
  {
...
const RESPONSES: SourceEvidenceRequirement[] = [
  {
    ...
    stage: 'responses',
    label: 'Vendor response coverage',
    sourceLabel: 'Vendor portal / email',
    minimumState: 'Available',
    level: 'required',
    description: 'Vendor-by-lever response coverage: addressed, partial, or dodged.',
    unlocks: 'Response completeness and vendor comparison.',
  },
  {
...
const PRICING: SourceEvidenceRequirement[] = [
  {
    ...
    stage: 'pricing',
    label: 'Vendor bid normalization',
    sourceLabel: 'Vendor proposals (pricing section)',
    minimumState: 'Available',
    level: 'required',
    description: 'Per-vendor headline bid, retained-FTE delta, and SLA credit cap.',
    unlocks: 'Should-cost normalization; TCO matrix.',
  },
  {
