...
const EVALUATE_TO_PRICING: SourceGateCriterion[] = [
  ...
  },
  {
    ...
    fromStage: 'evaluation',
    toStage: 'pricing',
    title: 'Scorecard governance signed off',
    description: 'Governance owner attests scorecard governance is complete.',
    severity: 'hard',
    required: true,
    linkedArtifactCodes: ['d16_scorecard'],
    ownerRole: 'steward',
...
const PRICING_TO_BAFO: SourceGateCriterion[] = [
  ...
  },
  {
    ...
    fromStage: 'pricing',
    toStage: 'bafo',
    title: 'Trap log produced and governance-reviewed',
  ...
  },
  {
    ...
    fromStage: 'pricing',
    toStage: 'bafo',
    title: 'BAFO question pack governance-approved',
    description: 'Governance owner signs off on the question pack before send.',
    severity: 'hard',
    required: true,
...
const DECISION_TO_SELECTION: SourceGateCriterion[] = [
  {
    ...
    toStage: 'selection',
    title: 'Decision brief signed off',
    description: 'Executive brief with finalist comparison and recommendation.',
    severity: 'hard',
    required: true,
  ...
  },
  {
    ...
    fromStage: 'executive_decision',
    toStage: 'selection',
    title: 'Governance sign-off recorded',
    description: 'Governance owner attests scorecard governance and weight lock.',
    severity: 'hard',
    required: true,
