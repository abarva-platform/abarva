...
const record = {
  ...
  reporting: {
    ...
    completenessReason: "No reporting cutoff is declared.",
    sourceRefs: [],
  },
  evidenceLanes: [],
  anatomy: {
  ...
  education: {
    ...
    headline: "Manage the commitment against demand.",
    body: "Track the evidence loop.",
    state: "partial",
    stateLabel: "Education basis is partial",
    steps: [],
    focus: "Review utilization before renewal.",
    basis: [],
    requiredEvidenceCount: 0,
    missingEvidence: [],
    thresholds: [],
    facetRequirements: {
      Story: { state: "required", reason: "Required." },
      Scope: { state: "required", reason: "Required." },
      Economics: { state: "required", reason: "Required." },
      Performance: { state: "not_required", reason: "Not required." },
      Relationship: { state: "required", reason: "Required." },
      Evidence: { state: "required", reason: "Required." },
      Optimize: { state: "required", reason: "Required." },
    },
  },
  findings: [],
  levers: [],
