...
export const CONTRACT_EVIDENCE_TEMPLATES: SourceContractEvidenceTemplate[] = [
  ...
  },
  {
    ...
    columns: [
      { key: "month", label: "Month", valueType: "date", required: true, description: "Month or period start.", example: "2026-03-01" },
      { key: "tower", label: "Tower", valueType: "text", required: true, description: "Service tower or queue.", example: "Finance apps" },
      { key: "baseline_tickets", label: "Baseline tickets", valueType: "number", required: true, description: "Contracted or expected monthly baseline.", example: "7420" },
      { key: "actual_tickets", label: "Actual tickets", valueType: "number", required: true, description: "Actual monthly volume.", example: "8610" },
      { key: "reopen_rate_pct", label: "Reopen rate %", valueType: "percent", required: false, description: "Reopen rate if available.", example: "7.1" },
    ],
  },
  {
