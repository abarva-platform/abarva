...
const LINKS = [{ href: '/platform/admin', label: 'Engagement Hub' }, { href: '/platform/admin/data', label: 'Data Loader' }, { href: '/platform/admin/quality', label: 'Quality Ops' }, { href: '/platform/admin/approvals', label: 'Approvals', active: true }, { href: '/platform/admin/outcomes', label: 'Outcome Tracker' }]
...
const COMPLETED = [
  ...
  { title: 'IT Financial Model upload approved', client: 'FS Demo', date: 'Apr 4, 2026', result: 'Approved' },
