...
const ADMIN_EMAIL_ALLOWLIST = new Set(["anand.sundaram@thesundaram.com"]);
  ...
  return (
    <AdminCanonShell
      ...
      workflow={{
        ...
        pageQuestion:
          "What build slices are complete and what blocks the next merge-safe wave?",
        whatIsKnown:
          "Wave/slice manifests and deterministic progress summary are route-backed.",
        whatIsMissing:
          "Live CI/Azure telemetry is not guaranteed on this page.",
        recommendedNextAction:
          "Use wave tracker to close blockers before production promotion.",
    ...
    >
      <main style={{ padding: 40, fontFamily: "DM Sans, sans-serif" }}>
        ...
        <p>
          Founder Build Control Tower is restricted to platform administrators.
        </p>
      </main>
    </AdminCanonShell>
  );
  ...
  return (
    <AdminCanonShell
      ...
      workflow={{
        primaryAgent: "steward",
        pageQuestion:
          "Which waves are merged, blocked, or pending verification?",
        whatIsKnown:
          "Build roadmap and merged status are represented in canonical docs/build manifests.",
        whatIsMissing:
          "This route does not certify real-time deploy success automatically.",
        recommendedNextAction:
          "Close failed checks and verify hygiene gate before merge.",
        caveat:
          "Deterministic tracker surface. Manual deploy verification still required.",
      }}
    >
