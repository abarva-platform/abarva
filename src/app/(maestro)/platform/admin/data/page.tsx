...
const CLIENT_FILES: Record<string, { label: string; confidence: number; files: DataFile[] }> = {
  ...
  arcturus: {
    ...
    files: [
      // Business — Financial
      { name: 'AUM_Revenue_Breakdown_FY2025.xlsx', owner: 'Finance', date: 'Mar 12', type: 'xlsx', segment: 'Business', category: 'Financial', status: 'approved', confidence: 94 },
      { name: 'AUM_Revenue_Breakdown_FY2024.xlsx', owner: 'Finance', date: 'Feb 10', type: 'xlsx', segment: 'Business', category: 'Financial', status: 'approved', confidence: 93 },
      ...
      { name: 'Bloomberg_SLA_Incident_Log_18_Months.xlsx', owner: 'Procurement', date: 'Apr 8', type: 'xlsx', segment: 'Business', category: 'Vendors', status: 'approved', confidence: 91 },
      { name: 'Vendor_and_Platform_Contract_Register.xlsx', owner: 'Procurement', date: 'Mar 25', type: 'xlsx', segment: 'Business', category: 'Vendors', status: 'approved', confidence: 89 },
      { name: 'Technology_Vendor_Spend_Analysis.xlsx', owner: 'Finance', date: 'Mar 22', type: 'xlsx', segment: 'Business', category: 'Vendors', status: 'approved', confidence: 90 },
      { name: 'MAS_FEAT_Compliance_Assessment.pdf', owner: 'CRO', date: 'Mar 28', type: 'pdf', segment: 'Business', category: 'Regulatory', status: 'approved', confidence: 89 },
      { name: 'FCA_AI_Governance_Gap_Analysis.pdf', owner: 'CRO', date: 'Mar 20', type: 'pdf', segment: 'Business', category: 'Regulatory', status: 'approved', confidence: 86 },
      { name: 'APRA_Operational_Resilience_Report.pdf', owner: 'CRO', date: 'Mar 15', type: 'pdf', segment: 'Business', category: 'Regulatory', status: 'approved', confidence: 87 },
      { name: 'Stress_Testing_Configuration_Audit.pdf', owner: '—', date: '—', type: 'pdf', segment: 'Business', category: 'Regulatory', status: 'missing', confidence: 0 },
      // Business — Leadership
      { name: 'Board_Strategic_Plan_2026_2029.pptx', owner: 'CEO Office', date: 'Feb 5', type: 'pptx', segment: 'Business', category: 'Leadership', status: 'approved', confidence: 88 },
      { name: 'CEO_Quarterly_Briefing_Q1_2026.pptx', owner: 'CEO Office', date: 'Apr 1', type: 'pptx', segment: 'Business', category: 'Leadership', status: 'approved', confidence: 86 },
      { name: 'CDO_Vacancy_and_Search_Status_Report.pdf', owner: 'HR', date: 'Apr 8', type: 'pdf', segment: 'Business', category: 'Leadership', status: 'approved', confidence: 84 },
      { name: 'Leadership_Org_Chart_2026.pdf', owner: 'HR', date: 'Mar 20', type: 'pdf', segment: 'Business', category: 'Leadership', status: 'approved', confidence: 90 },
      { name: 'AI_Initiative_Register_94M_28_Initiatives.xlsx', owner: 'CIO', date: 'Mar 18', type: 'xlsx', segment: 'Business', category: 'AI', status: 'approved', confidence: 91 },
      // IT — Technology
      { name: 'Technology_Stack_and_Vendor_Inventory_240_Apps.xlsx', owner: 'CTO', date: 'Mar 22', type: 'xlsx', segment: 'IT & Technology', category: 'Technology', status: 'approved', confidence: 87 },
      { name: 'Salesforce_FSC_Implementation_Report.pdf', owner: 'IT Dept', date: 'Mar 20', type: 'pdf', segment: 'IT & Technology', category: 'Technology', status: 'approved', confidence: 88 },
      { name: 'Aladdin_Risk_System_Configuration_Report.pdf', owner: 'CRO', date: 'Apr 2', type: 'pdf', segment: 'IT & Technology', category: 'Technology', status: 'approved', confidence: 86 },
      { name: 'Bloomberg_Terminal_Integration_Map.pdf', owner: 'CTO', date: 'Mar 28', type: 'pdf', segment: 'IT & Technology', category: 'Technology', status: 'approved', confidence: 85 },
      { name: 'Data_Platform_Architecture_Snowflake.pdf', owner: 'CTO', date: 'Mar 25', type: 'pdf', segment: 'IT & Technology', category: 'Technology', status: 'approved', confidence: 84 },
      { name: 'IT_Architecture_Overview.pptx', owner: 'CTO', date: 'Mar 15', type: 'pptx', segment: 'IT & Technology', category: 'Technology', status: 'approved', confidence: 86 },
      { name: 'BI_Tool_Consolidation_Analysis.xlsx', owner: 'IT Dept', date: 'Apr 1', type: 'xlsx', segment: 'IT & Technology', category: 'Technology', status: 'approved', confidence: 88 },
      { name: 'Tableau_Usage_and_License_Audit.xlsx', owner: 'IT Dept', date: 'Mar 30', type: 'xlsx', segment: 'IT & Technology', category: 'Technology', status: 'approved', confidence: 87 },
      { name: 'Cybersecurity_Risk_Assessment_FY2025.pdf', owner: 'CISO', date: 'Mar 10', type: 'pdf', segment: 'IT & Technology', category: 'Technology', status: 'approved', confidence: 89 },
      { name: 'Data_Governance_Framework_v2.0.pdf', owner: 'CIO', date: 'Mar 5', type: 'pdf', segment: 'IT & Technology', category: 'Technology', status: 'approved', confidence: 83 },
      { name: 'Shadow_IT_Discovery_Report.pdf', owner: 'IT Dept', date: 'Mar 18', type: 'pdf', segment: 'IT & Technology', category: 'Technology', status: 'approved', confidence: 85 },
      { name: 'IT_Project_Delivery_Scorecard.xlsx', owner: 'IT Dept', date: 'Apr 5', type: 'xlsx', segment: 'IT & Technology', category: 'Technology', status: 'approved', confidence: 86 },
      { name: 'AI_Initiative_Technical_Assessment_28_Initiatives.pdf', owner: 'CIO', date: 'Apr 8', type: 'pdf', segment: 'IT & Technology', category: 'AI', status: 'approved', confidence: 88 },
      { name: 'Snowflake_Data_Platform_Roadmap.pptx', owner: 'CTO', date: 'Apr 3', type: 'pptx', segment: 'IT & Technology', category: 'AI', status: 'approved', confidence: 85 },
      // Third Party — Benchmarks
      { name: 'Wealth_Management_Industry_Benchmarks_2025.pdf', owner: 'AbarVa Research', date: 'Mar 10', type: 'pdf', segment: 'Third Party', category: 'Benchmarks', status: 'approved', confidence: 98 },
      { name: 'Asset_Manager_CI_Ratio_Peer_Analysis_31_Firms.xlsx', owner: 'AbarVa Research', date: 'Mar 15', type: 'xlsx', segment: 'Third Party', category: 'Benchmarks', status: 'approved', confidence: 97 },
      { name: 'McKinsey_Wealth_Survey_2025.pdf', owner: 'AbarVa Research', date: 'Mar 8', type: 'pdf', segment: 'Third Party', category: 'Benchmarks', status: 'approved', confidence: 96 },
      { name: 'Bloomberg_Pricing_Benchmarks_31_Peers.xlsx', owner: 'AbarVa Research', date: 'Mar 20', type: 'xlsx', segment: 'Third Party', category: 'Benchmarks', status: 'approved', confidence: 95 },
      { name: 'MAS_FEAT_Enforcement_Update_Q1_2026.pdf', owner: 'AbarVa Research', date: 'Apr 2', type: 'pdf', segment: 'Third Party', category: 'Regulatory', status: 'approved', confidence: 98 },
      { name: 'FCA_AI_Governance_Consultation_Response.pdf', owner: 'AbarVa Research', date: 'Mar 25', type: 'pdf', segment: 'Third Party', category: 'Regulatory', status: 'approved', confidence: 96 },
      { name: 'Genome_Pattern_F007_CDO_Vacancy.pdf', owner: 'AbarVa', date: 'Mar 20', type: 'pdf', segment: 'Third Party', category: 'Benchmarks', status: 'approved', confidence: 97 },
      { name: 'Genome_Pattern_F008_Untracked_AI_Spend.pdf', owner: 'AbarVa', date: 'Mar 20', type: 'pdf', segment: 'Third Party', category: 'Benchmarks', status: 'approved', confidence: 97 },
      { name: 'Genome_Pattern_F002_Efficiency_Gap.pdf', owner: 'AbarVa', date: 'Mar 20', type: 'pdf', segment: 'Third Party', category: 'Benchmarks', status: 'approved', confidence: 96 },
      // Third Party — Intelligence
      { name: 'Executive_Interview_Victoria_Hargreaves_CEO.pdf', owner: 'AbarVa', date: 'Apr 5', type: 'pdf', segment: 'Third Party', category: 'Intelligence', status: 'approved', confidence: 85 },
      { name: 'Executive_Interview_Raj_Malhotra_CIO.pdf', owner: 'AbarVa', date: 'Apr 6', type: 'pdf', segment: 'Third Party', category: 'Intelligence', status: 'approved', confidence: 85 },
      { name: 'Executive_Interview_Sarah_Okonkwo_CFO.pdf', owner: 'AbarVa', date: 'Apr 7', type: 'pdf', segment: 'Third Party', category: 'Intelligence', status: 'approved', confidence: 84 },
      { name: 'Executive_Interview_David_Chen_CTO.pdf', owner: 'AbarVa', date: 'Apr 8', type: 'pdf', segment: 'Third Party', category: 'Intelligence', status: 'approved', confidence: 84 },
      { name: 'Executive_Interview_Priya_Singh_CRO.pdf', owner: 'AbarVa', date: 'Apr 9', type: 'pdf', segment: 'Third Party', category: 'Intelligence', status: 'approved', confidence: 83 },
      { name: 'Leadership_Profiles_and_Board_Composition.pdf', owner: 'HR', date: 'Mar 25', type: 'pdf', segment: 'Third Party', category: 'Leadership', status: 'approved', confidence: 93 },
    ],
  },
  apexretail: {
