  ...
  return (
    <AppShell
      ...
      topBarProps={{
        ...
        showLocked: true,
        context: "Source · Board-grade deliverables",
      }}
      subNav={<SourceSubNav />}
    >
      <SourceWorkingPane>
        ...
        >
          <header>
            ...
            <p style={{ color: "#706D66", fontSize: 14, marginTop: 6 }}>
              Generate a board-grade document for each stage of the sourcing
              lifecycle for <strong>{clientName}</strong>. Every stage&apos;s
              document is produced through the governed multi-pass authoring
              flow with its own stage-specific structure — the strategy memo,
              RFP package, evaluation workbook, and executive recommendation
              each follow a tailored section flow. Every client-specific fact is
              grounded in governed evidence and cited; missing facts are
              flagged, never invented. The quality gate holds back any document
