        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: 12.5, color: "#5f5e5a", marginTop: 3 }}>
              Structural positions, not sized until real evidence backs a
              number.
            </div>
          </div>
          <div
            style={{ display: "flex", flexWrap: "wrap", background: "#fff" }}
          >
            {vm.oppScenarios.map((s, i) => (
              ...
              >
                ...
                <div
                  style={{ fontSize: 12.5, color: "#5f5e5a", lineHeight: 1.55 }}
                >
