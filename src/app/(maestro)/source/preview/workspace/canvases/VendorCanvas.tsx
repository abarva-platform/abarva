    ...
    <>
      ...
      {vm.vOverview ? (
        ...
        >
          ...
          <div style={{ fontSize: 12.5, color: "#5f5e5a", marginBottom: 16 }}>
            Annual contract value against actual spend, per governed contract.
            Row click opens Contract 360.
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {vm.vendorComposition.map((c) => (
              ...
              >
                ...
                >
                  <span
                    style={{ fontSize: 13, fontWeight: 600, color: "#0a0a0b" }}
                  >
                    {c.name}
                  </span>
                  <span
                ...
                >
                  ...
                  >
                    <span
                      style={{ width: 88, fontSize: 10.5, color: "#888780" }}
                    >
                      Contract value
                    </span>
                    <div
      ...
      {vm.vOverview ? (
        ...
        >
          ...
          <div style={{ fontSize: 12.5, color: "#5f5e5a", marginBottom: 16 }}>
            Vendor → contracts → critical applications → platforms →
            transformation initiatives. A layer that has nothing mapped for this
            vendor says so rather than showing zero.
          </div>
          <div
            style={{
              display: "grid",
          ...
          >
            <DepCol label="Contracts">
              {vm.vendorDependencyMap.contracts.length ? (
                vm.vendorDependencyMap.contracts.map((c) => (
                  <DepChip key={c.id} onClick={c.onClick}>
                    {c.name}
                  </DepChip>
                ))
              ) : (
            ...
            <DepCol label="Critical applications">
              {vm.vendorDependencyMap.criticalApplications > 0 ? (
                <DepChip tone="#0066CC">
                  {vm.vendorDependencyMap.criticalApplications}{" "}
                  business-critical
                </DepChip>
              ) : (
                <DepEmpty />
            ...
            <DepCol label="Platforms">
              {vm.vendorDependencyMap.platforms.length ? (
                vm.vendorDependencyMap.platforms.map((p) => (
                  <DepChip key={p}>{p}</DepChip>
                ))
              ) : (
                <DepEmpty />
              )}
      ...
      {vm.vDeps ? (
        ...
        >
          ...
          <div style={{ fontSize: 12.5, color: "#5f5e5a", marginBottom: 16 }}>
            source.contract_initiative_dependency, across every material
          ...
          {vm.vendorDependencyMap.initiatives.length ? (
            ...
            <div style={{ fontSize: 12.5, color: "#b4b2a9" }}>
              No initiative dependencies recorded for this vendor&rsquo;s
              contracts.
            </div>
          )}
        </div>
...
function DepChip({
  ...
  return (
    <div
      ...
      style={{
        border: `1px solid ${tone ?? "rgba(10,10,11,.14)"}`,
        borderRadius: 6,
        padding: "7px 10px",
        fontSize: 12.5,
        color: tone ?? "#2c2c2a",
