        ...
        >
          ...
          >
            <div style={{ fontSize: 14.5, fontWeight: 600, color: "#0a0a0b" }}>
              Sourcing leverage matrix
            </div>
            <div style={{ fontSize: 12.5, color: "#5f5e5a", marginTop: 3 }}>
              X: count of weak leverage signals · Y: annual contract value ·
              size: actual annual spend · colour: renewal urgency · outline:
              auto-renew
            </div>
          </div>
          <div style={{ padding: "14px 18px 4px" }}>
            <svg
              viewBox={`0 0 ${mx.w} ${mx.h}`}
          ...
          >
            <span>computeContractLeverageSignals(source.contract_360)</span>
            <span>·</span>
            <span>drill: contract_id</span>
          </div>
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <div style={{ fontSize: 13, color: "#5f5e5a", lineHeight: 1.55 }}>
            Select a quadrant to filter the opportunity portfolio to the
