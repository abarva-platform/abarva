...
export function ConcentrationLens({ vm }: { vm: SourceWorkspaceVM }) {
  ...
  const dim = (key: string) =>
    activeStrip && !activeStrip.vendors.some((v) => v.ref === key) ? 0.22 : 1;
  return (
    <>
      <div
        style={{
      ...
      >
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 12.5, color: "#5f5e5a", marginTop: 3 }}>
              Bars: annual contract value · line: cumulative portfolio share
        ...
        >
          ...
          >
            ...
            />
            Ranks six to ten · cumulative {vm.top10Pct}
          </div>
          <div
            style={{
              display: "flex",
          ...
          >
            <span style={{ width: 16, height: 2, background: "#0066CC" }} />
            Cumulative portfolio share
          </div>
          <div
            style={{
              display: "flex",
        ...
        >
          ...
          >
            <b>What this says.</b> {vm.concTake}
          </div>
        </div>
        <div
          style={{
        ...
        >
          <span>computeVendorConcentration(source.contract_360)</span>
          <span>·</span>
          <span>grain: vendor</span>
          <span>·</span>
          <span>drill: vendor_ref → Vendor 360</span>
        </div>
      </div>
      ...
      >
        ...
        >
          <div style={{ fontSize: 14, fontWeight: 600, color: "#0a0a0b" }}>
            Where concentration is compounded by risk
          </div>
          <div style={{ fontSize: 12.5, color: "#5f5e5a", marginTop: 3 }}>
            Select a strip to highlight those vendors in the chart above.
          </div>
        </div>
