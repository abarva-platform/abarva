...
const LP_LABEL: React.CSSProperties = {
...
export function ContextLens({ vm }: { vm: SourceWorkspaceVM }) {
  ...
  return (
    <>
      <div
        style={{ background: "#0a0a0b", borderRadius: 8, padding: "22px 26px" }}
      >
        <div
          style={{
            display: "flex",
        ...
        >
          <div>
            <div style={{ ...LP_LABEL, color: "rgba(255,255,255,.5)" }}>
              What we know
            </div>
            <div style={{ fontSize: 13.5, lineHeight: 1.55, color: "#fff" }}>
              {lp.whatWeKnow}
            </div>
          </div>
          <div>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 12.5, color: "#5f5e5a" }}>
            Which governed reads actually returned rows for this tenant.
          </div>
        </div>
          ...
          {vm.coverage.map((c, i) => (
            ...
            >
              ...
              >
                ...
                />
                <span
                  style={{ fontSize: 12.5, fontWeight: 600, color: "#0a0a0b" }}
                >
                  {c.name}
                </span>
                <span
              ...
              <div
                style={{ fontSize: 11.5, color: "#5f5e5a", lineHeight: 1.45 }}
              >
                {c.note}
              </div>
              <div
