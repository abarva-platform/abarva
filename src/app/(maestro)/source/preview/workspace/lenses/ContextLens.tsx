    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            style={{ fontFamily: TYPE.mono, fontSize: 11, color: "#888780" }}
          >
          ...
          <div style={{ overflowX: "auto" }}>
            {cockpit.actionQueue.map((row, index) => (
              ...
              >
                ...
                <span
                  style={{ color: "#2c2c2a", fontSize: 12.8, lineHeight: 1.4 }}
                >
                  {row.why}
                </span>
                <span
                ...
                >
                  ...
                  >
                    <span
                      style={{
                        fontFamily: TYPE.mono,
                        color: COLORS[row.confidenceGate],
                        fontWeight: 800,
                      }}
                    >
                      {row.confidenceLabel}
            ...
            >
              ...
              >
                <Metric
                  ...
                  value={String(proof.reconciliation.legacyContractCount)}
                />
                <Metric
                  label="legacy vendors"
                  value={String(proof.reconciliation.legacyVendorCount)}
                />
                <Metric
                  label="v4 contracts"
                  value={String(proof.reconciliation.v4ContractCount)}
                />
                <Metric
                  label="v4 vendors"
                  value={String(proof.reconciliation.v4VendorCount)}
                />
              </div>
