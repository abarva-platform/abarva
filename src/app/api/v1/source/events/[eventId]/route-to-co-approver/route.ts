...
export async function POST(
  ...
  await sourceWrite.insertActivityLog({
    ...
    actionType: "source_event_routed_to_co_approver",
    actionLabel: "Source event routed to co-approver",
    reason,
    metadata: {
      fromState: event.lifecycle_state,
      toState: "waiting_on_co_approver",
    },
  ...
  return Response.json({
    ok: true,
    eventId,
    newLifecycleState: "waiting_on_co_approver",
    redirectTo: `/source/events/${eventId}/approval`,
  });
}
