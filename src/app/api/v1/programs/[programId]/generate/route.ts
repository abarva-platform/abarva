...
export async function POST(
  ...
  return Response.json({
    ...
    editableArtifactId: persisted.editableArtifactId,
    editableArtifactVersion: persisted.editableArtifactVersion,
    editableArtifactBlobStored: persisted.editableArtifactBlobStored,
    content: result.html,
    phase: targetPhase,
    deliverableKey: artifact,
