    ...
    >
      <section style={{ width: "min(720px, 100%)", display: "grid", gap: 18 }}>
        <div>
          ...
          >
            AbarVa is decision-support software. The client decision owner
            remains responsible for reviewing evidence, validating assumptions,
            and approving actions before they are taken.
          </p>
        </div>
