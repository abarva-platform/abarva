...
export default function SolutionMargin() {
  ...
  const starters = [
    `C/I ratio is ${f.costToIncomeRatio}% vs ${f.targetCIRatio}% peer target. $${f.efficiencyGap}M efficiency gap.`,
    `$${f.aiInvestment}M committed to AI initiatives. Cannot show ROI on any of them.`,
  ...
  const findings = [
    {
      ...
      title: `C/I ratio ${f.costToIncomeRatio}% vs ${f.targetCIRatio}% target — $${f.efficiencyGap}M annual gap`,
    ...
    {
      severity: 'critical' as const,
      title: `$${f.aiInvestment}M AI committed — zero with documented baseline`,
  ...
  const followupOptions = [
    'CEO — total margin recovery',
    'CFO — cost discipline and ROI',
    'CIO — technology cost and AI ROI',
    'Board — competitive benchmarking',
  ]
      ...
      <div style={{ borderBottom: `1px solid ${BORDER}`, padding: '64px 32px 56px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ fontFamily: MONO, fontSize: '10px', color: TEAL, letterSpacing: '.14em', textTransform: 'uppercase', marginBottom: '14px' }}>
            Solution · Margin Intelligence · {arcturusFinancial.org.name}
          </div>
          ...
          <p style={{ fontSize: '18px', color: MUTED, maxWidth: '640px', lineHeight: 1.7, margin: '0 0 48px' }}>
            Recover margin across revenue, cost structure, and AI portfolio. Baseline locked Day 0. Fee on verified savings only — not day-rates.
          </p>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px' }}>
            {[
              {
                value: `${f.costToIncomeRatio}%`,
                color: RED,
                label: `C/I ratio — vs ${f.targetCIRatio}% target · $${f.efficiencyGap}M gap`,
              },
              {
                value: `$${f.aiInvestment}M`,
                color: AMBER,
                label: `AI committed · $${f.aiTrackedROI} tracked ROI`,
              },
              {
                value: '$60–120M',
                color: TEAL,
                label: 'Annual recovery range — Genome-validated',
              },
              {
                value: '15–20%',
                color: GREEN,
                label: 'Of verified savings only — not day-rates',
              },
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '220px 1fr', gap: '0' }}>
            ...
            <div style={{ padding: '28px 32px 28px 0', borderRight: `1px solid ${BORDER}`, borderBottom: `1px solid ${BORDER}` }}>
              ...
              <div style={{ fontSize: '14px', fontWeight: 600, color: WHITE }}>Diagnose — where the margin is leaking and why</div>
            </div>
            <div style={{ padding: '28px 0 28px 32px', borderBottom: `1px solid ${BORDER}` }}>
              <p style={{ fontSize: '14px', color: MUTED, lineHeight: 1.6, margin: '0 0 16px', maxWidth: '560px' }}>
                Map every cost driver against peer benchmarks. Quantify the technology overspend, AI portfolio waste, and revenue channel underperformance. Surface the structural gaps before any prescriptions are made.
              </p>
            ...
            <div style={{ padding: '28px 32px 28px 0', borderRight: `1px solid ${BORDER}`, borderBottom: `1px solid ${BORDER}` }}>
              ...
              <div style={{ fontSize: '14px', fontWeight: 600, color: WHITE }}>Prescribe — the sequenced recovery plan</div>
            </div>
            <div style={{ padding: '28px 0 28px 32px', borderBottom: `1px solid ${BORDER}` }}>
              <p style={{ fontSize: '14px', color: MUTED, lineHeight: 1.6, margin: '0 0 16px', maxWidth: '560px' }}>
                Rank interventions by ROI range and execution risk. Build the CFO-ready business case for each. Sequence the programme so the fast wins fund the structural changes. No vendor influence — scored against your data only.
              </p>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' as const }}>
            ...
            <div style={{ padding: '28px 32px 28px 0', borderRight: `1px solid ${BORDER}` }}>
              ...
              <div style={{ fontSize: '14px', fontWeight: 600, color: WHITE }}>Verify — baseline locked · savings tracked · fee earned</div>
            </div>
            <div style={{ padding: '28px 0 28px 32px' }}>
              <p style={{ fontSize: '14px', color: MUTED, lineHeight: 1.6, margin: '0 0 16px', maxWidth: '560px' }}>
                Baseline locked on Day 0 — immutable. Monthly savings reports published to the board. AbarVa fee is a percentage of verified savings only. If savings are not realised, the fee is not earned.
              </p>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' as const }}>
                {['Outcomes'].map(p => (
      ...
      <div style={{ background: CARD, borderBottom: `1px solid ${BORDER}`, padding: '56px 32px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ fontFamily: MONO, fontSize: '10px', color: MUTED, letterSpacing: '.12em', textTransform: 'uppercase', marginBottom: '8px' }}>
            AbarVa Genome · Margin failure patterns
          </div>
          <p style={{ fontSize: '14px', color: DIM, margin: '0 0 36px' }}>
            Across 200+ enterprise engagements — these three patterns predict margin deterioration with 90%+ accuracy.
          </p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px' }}>
            {[
              { pct: '89%', label: 'No named executive sponsor' },
              { pct: '76%', label: 'AI spend without verified ROI' },
              { pct: '68%', label: 'Cost misattribution — wrong levers pulled' },
            ].map(({ pct, label }) => (
      ...
      <div style={{ padding: '64px 32px 96px' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <h2 style={{ fontFamily: SERIF, fontSize: '28px', fontWeight: 500, color: WHITE, margin: '0 0 8px' }}>
            Describe your margin situation
          </h2>
              ...
              {step === 1 && (
                <div>
                  ...
                  <p style={{ fontSize: '15px', color: WHITE, marginBottom: '16px', fontWeight: 500 }}>
                    Who is the executive sponsor — and what outcome do they care most about?
                  </p>
              ...
              {step >= 2 && !launched && (
                <div style={{ background: CARD, border: `1px solid rgba(45,212,200,0.25)`, borderRadius: '12px', padding: '28px 24px' }}>
                  ...
                  <p style={{ fontSize: '14px', color: MUTED, lineHeight: 1.6, margin: '0 0 20px' }}>
                    AbarVa will create a Margin Optimization project for <strong style={{ color: WHITE }}>{arcturusFinancial.org.name}</strong> scoped to the sponsor priority: <strong style={{ color: WHITE }}>{selectedOpt}</strong>. Genome patterns pre-loaded. Baseline locked Day 0.
                  </p>
                  <button
