  ...
  return (
    <div style={{minHeight:'100vh',background:B,fontFamily:SANS,color:W}}>
      ...
      <div style={{maxWidth:'1200px',margin:'0 auto',padding:'80px 32px',textAlign:'center' as const}}>
        <div style={{fontFamily:MONO,fontSize:'10px',color:T,letterSpacing:'.14em',textTransform:'uppercase' as const,marginBottom:'16px'}}>Solution · Delivery Intelligence · All verticals</div>
        <h1 style={{fontFamily:SERIF,fontSize:'44px',fontWeight:500,color:W,marginBottom:'16px',lineHeight:1.2}}>AI-Powered Transformation Delivery</h1>
        <p style={{fontSize:'17px',color:M,maxWidth:'600px',margin:'0 auto 12px',lineHeight:1.7}}>Replace 40 consultants with 4 Maestros. Knowledge stays permanently.</p>
        <p style={{fontFamily:MONO,fontSize:'13px',color:T,maxWidth:'600px',margin:'0 auto 48px',fontStyle:'italic'}}>"80 consultants on site. 70% of their time is getting up to speed."</p>
        <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:'16px',maxWidth:'800px',margin:'0 auto 48px'}}>
          {[['4 Maestros','Replace 40 consultants'],['0','Day-rate billing'],['100%','Knowledge retention']].map(([v,l])=>(
