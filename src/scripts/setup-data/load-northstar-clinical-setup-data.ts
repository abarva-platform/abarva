...
export const SEGMENTS: SegmentConfig[] = [
  ...
  { familyNumber: 4, segmentId: 'it_financials', segmentName: 'IT financials', dir: '04_it_financials', expectedRecordCount: 6, expectedFreshnessDays: 30, reasoningModes: ['tenant_grounded'] },
  { familyNumber: 5, segmentId: 'kpi_dictionary', segmentName: 'KPI dictionary', dir: '05_kpi_dictionary', expectedRecordCount: 6, expectedFreshnessDays: 60, reasoningModes: ['tenant_grounded', 'cross_corpus'] },
  { familyNumber: 6, segmentId: 'program_inventory', segmentName: 'Program inventory', dir: '06_program_inventory', expectedRecordCount: 3, expectedFreshnessDays: 14, reasoningModes: ['tenant_grounded', 'cross_corpus'] },
  { familyNumber: 7, segmentId: 'sourcing_artifacts', segmentName: 'Sourcing artifacts', dir: '07_sourcing_artifacts', expectedRecordCount: 3, expectedFreshnessDays: 14, reasoningModes: ['tenant_grounded'] },
  { familyNumber: 8, segmentId: 'program_deliverables', segmentName: 'Program deliverables', dir: '08_program_deliverables', expectedRecordCount: 2, expectedFreshnessDays: 14, reasoningModes: ['tenant_grounded', 'cross_corpus'] },
  { familyNumber: 9, segmentId: 'evidence_ledger', segmentName: 'Evidence ledger', dir: '09_evidence_ledger', expectedRecordCount: 6, expectedFreshnessDays: 30, reasoningModes: ['tenant_grounded', 'cross_corpus'] },
  { familyNumber: 10, segmentId: 'operating_telemetry', segmentName: 'Operating telemetry', dir: '10_operating_telemetry', expectedRecordCount: 5, expectedFreshnessDays: 7, reasoningModes: ['tenant_grounded', 'cross_corpus'] },
  { familyNumber: 11, segmentId: 'vendor_contracts', segmentName: 'Vendor and contract', dir: '11_vendor_contracts', expectedRecordCount: 5, expectedFreshnessDays: 60, reasoningModes: ['tenant_grounded', 'cross_corpus'] },
  { familyNumber: 12, segmentId: 'compliance', segmentName: 'Compliance and regulatory', dir: '12_compliance', expectedRecordCount: 1, expectedFreshnessDays: 90, reasoningModes: ['tenant_grounded', 'cross_corpus'] },
  { familyNumber: 13, segmentId: 'industry_context', segmentName: 'Industry context', dir: '13_industry_context', expectedRecordCount: 4, expectedFreshnessDays: 30, reasoningModes: ['cross_corpus'] },
  { familyNumber: 14, segmentId: 'cross_program_signals', segmentName: 'Cross-program signals', dir: '14_cross_program_signals', expectedRecordCount: 4, expectedFreshnessDays: 7, reasoningModes: ['tenant_grounded', 'cross_corpus'] },
];
...
async function ensureClient(client: SupabaseClient) {
  ...
  const inserted = await client
    ...
    .insert({
      ...
      it_budget_usd: 310_000_000,
      ai_budget_usd: 24_000_000,
      employee_count: 24_500,
      operational_units: 38,
      business_description: 'Synthetic diversified medtech manufacturer and healthcare-products enterprise used for Azure migration rehearsal and pilot demos.',
    })
    .select('id')
    .single();
