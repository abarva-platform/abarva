...
// VOICE.STRAT-2026-05-10g — production-canon roster.
// Source of truth: meridian-data/02_org_structure/executive_bench.json.
// The earlier Mountain-West / Vasquez / Oshima roster has been retired
// in favour of the Sacramento-headquartered, $16.8B production tenant
// (CEO Dr. Elaine Morales; CDIO Dr. Anita Krishnamurthy; CFO David Park;
// CPE Dr. Marcus Reid; CMIO Dr. Jennifer Wexler; COO Sarah O'Brien;
// President MHP Thomas Hartwell; etc.).
const OWNER_NAME_ALIASES: Record<string, string> = {
  'CEO': 'Dr. Elaine Morales',
  'President & Chief Executive Officer': 'Dr. Elaine Morales',
  'CFO': 'David Park',
  'Chief Financial Officer': 'David Park',
  'Chief Physician Executive': 'Dr. Marcus Reid',
  'Chief Medical Officer': 'Dr. Marcus Reid',
  'Chief Medical Information Officer': 'Dr. Jennifer Wexler',
  'CMIO': 'Dr. Jennifer Wexler',
  'Chief Operating Officer': "Sarah O'Brien",
  'COO': "Sarah O'Brien",
  'Chief Digital and Information Officer': 'Dr. Anita Krishnamurthy',
  'CDIO': 'Dr. Anita Krishnamurthy',
  'Chief Information Officer': 'Dr. Anita Krishnamurthy',
  'President, Meridian Health Plans': 'Thomas Hartwell',
  'President Meridian Health Plans': 'Thomas Hartwell',
  'Chief Medical Officer, Meridian Health Plans': 'Dr. Lakshmi Venkatesan',
  'General Counsel': 'Rebecca Hollings',
  'General Counsel and Chief Compliance Officer': 'Rebecca Hollings',
  'Chief Compliance Officer': 'Karen Mercer',
  'Chief Quality Officer': 'Dr. James Okonjo',
  'VP Revenue Cycle': 'Patricia Okafor',
  'Chief Human Resources Officer': 'Margaret Liu',
  'Chief Procurement Officer': 'Angela Brooks',
  'Chief Product Officer, Digital Health': 'Maya Iyer',
  'Chief Nursing Officer': 'Dr. Robert Chen',
  'VP Network Management': 'Andrew Fitzgerald',
  'VP Care Management & Population Health': 'Dr. Priya Sharma',
  'VP Risk Adjustment & STAR Quality': 'Christopher Vega',
  'Board Chair': 'Harold Kim',
};
...
function buildExternalEvents(): ExternalEventSeed[] {
  return [
    {
      id: 'meridian_event_cdio_arrival_krishnamurthy',
      sourceId: 'meridian_ext_source_earnings_and_bond_materials',
      title: 'Dr. Anita Krishnamurthy joined as CDIO with mandate to formalize AI governance and modernize revenue cycle',
      summary: 'Meridian hired Dr. Anita Krishnamurthy from Optum Care in October 2025 to fill the CDIO seat after the post-DENIALS-2024 leadership gap left by Dr. Aiden Walsh, with explicit board mandate to formalize clinical AI governance and underwrite RCM modernization.',
      eventType: 'executive_move',
      eventDate: '2025-10-01',
      entities: ['Dr. Anita Krishnamurthy', 'Meridian Health System'],
      topics: ['digital and information leadership', 'AI governance', 'revenue cycle modernization'],
      geography: ['United States'],
      significance: 'high',
      reasoningScopeSummary: 'broad',
      disclosureScopeSummary: 'broad',
      confidenceLevel: 'high',
      asOfDate: '2026-04-25',
      eventPayload: { source_note: 'meridian-data/01_enterprise_profile/enterprise_profile.md · April 2026 context' },
    },
    {
      id: 'meridian_event_board_ai_risk_policy',
      sourceId: 'meridian_ext_source_earnings_and_bond_materials',
      title: 'Board-issued AI risk policy created the AI governance attestation requirement',
      summary: 'Q3 FY2025 board action set the policy bar for clinical AI governance attestation and is the upstream forcing function for the Clinical AI Governance Uplift program.',
      eventType: 'governance_action',
      eventDate: '2025-03-15',
      entities: ['Harold Kim', 'Dr. Elaine Morales', 'Meridian Health System'],
      topics: ['AI governance', 'board policy', 'clinical AI'],
      geography: ['United States'],
      significance: 'high',
      reasoningScopeSummary: 'broad',
      disclosureScopeSummary: 'broad',
      confidenceLevel: 'high',
      asOfDate: '2026-04-25',
      eventPayload: { source_note: 'meridian-data/01_enterprise_profile/enterprise_profile.md · Q3 FY2025 AI risk policy' },
    },
    {
      ...
      summary: 'A public peer quality-recovery plan created a relevant comparison point for Meridian Health Plans’ MA quality program under Thomas Hartwell.',
      eventType: 'peer_move',
      eventDate: '2026-02-11',
      entities: ['Thomas Hartwell', 'Meridian Health Plans'],
    ...
    {
      id: 'meridian_event_q4_denial_spike',
      sourceId: 'meridian_ext_source_regulatory_bodies',
      title: 'Q4 FY2025 denial-rate spike forced revenue cycle modernization onto the board roadmap',
      summary: 'Denial rates spiked in Q4 FY2025, compounding the DENIALS-2024 sunk-cost narrative ($8M and counting) and making the meridian-rcm-modernization-2026 program politically unavoidable.',
      eventType: 'internal_signal',
      eventDate: '2025-06-30',
      entities: ['David Park', 'Patricia Okafor', 'Meridian Health System'],
      topics: ['revenue cycle', 'denials', 'capital allocation'],
      geography: ['United States'],
      significance: 'high',
      reasoningScopeSummary: 'broad',
      disclosureScopeSummary: 'broad',
      confidenceLevel: 'high',
      asOfDate: '2026-04-25',
      eventPayload: { source_note: 'meridian-data/01_enterprise_profile/enterprise_profile.md · Q4 FY2025 denial spike' },
    },
    {
      ...
      summary: 'AI Governance Council surfaced 23 use cases under review with 4 attested, 19 in progress, and 3 shadow scribe pilots not yet under governance — including PHI-adjacent and clinical-decision-adjacent usage.',
      eventType: 'internal_signal',
      eventDate: '2026-04-10',
      entities: ['Dr. Jennifer Wexler', 'Dr. Anita Krishnamurthy', 'Meridian Health System'],
