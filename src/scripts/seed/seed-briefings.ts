...
const BRIEFINGS: BriefingSeed[] = [
  ...
  },
  {
    ...
    openingLine: 'Good morning, Thomas. Three items to run through, all health-plan-side and all with cross-system implications.',
    closingRecommendation: 'The MLR movement is the operational priority. Everything else can wait a week if needed.',
    voiceProfileApplied: 'Thomas Hartwell',
    sectionCount: 3,
    itemCount: 3,
