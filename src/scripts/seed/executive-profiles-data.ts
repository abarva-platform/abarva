...
export const COMPOSITE_EXECUTIVE_PROFILES: ExecutiveProfileSeed[] = [
  ...
  {
    // VOICE.STRAT-2026-05-10g — production-canon Meridian executive profile.
    // Replaces the prior Linda Chen-Winters / President MHP composite. The
    // production tenant (meridian-data/02_org_structure/executive_bench.json)
    // names Thomas Hartwell as President, Meridian Health Plans, with
    // Dr. Lakshmi Venkatesan as plan CMO and the broader Krishnamurthy /
    // Park / Reid / Wexler / O'Brien / Hollings / Morales executive team.
    id: '69bfd954-4f3d-41a6-84a4-ee8d70ed5e32',
    profileType: 'composite_tenant',
    tenantKey: 'meridian',
    personName: 'Thomas Hartwell',
    ...
    currentTenureStart: '2020-01-01',
    currentRemit: "Runs Meridian Health Plans across commercial, marketplace, Medicare Advantage, and Medicaid managed care, with $5.0B in plan premium revenue and 1.4M covered lives. Reports to CEO Dr. Elaine Morales.",
    reportingStructure: {
      reports_to: 'Dr. Elaine Morales (CEO)',
    ...
    strategicPrioritiesPersonallyOwned: [
      ...
      'health plan retention and acquisition',
      'plan-side risk adjustment and STAR quality',
      'health-plan-provider economics alignment',
    ],
    initiativesPersonallySponsored: [
      'health plan growth agenda',
      'medicare advantage quality program',
      'risk adjustment and STAR coordination',
    ],
    communicationStyle: {
    ...
    knownPriorities: [
      { priority_description: 'Medicare Advantage retention and acquisition with quality bonus performance', source: 'meridian-data/01_enterprise_profile/enterprise_profile.md', confidence: 'high' },
      { priority_description: 'Plan-side risk adjustment and STAR quality coordination with Christopher Vega', source: 'meridian-data/02_org_structure/executive_bench.json', confidence: 'high' },
      { priority_description: 'Tighter health-plan and provider economics alignment with David Park (CFO)', source: 'meridian-data/02_org_structure/executive_bench.json', confidence: 'high' },
    ],
    knownConstraints: [
      { constraint_description: 'Medicare Advantage rate pressure compressed FY2025 operating margin by 80bp', source: 'meridian-data/01_enterprise_profile/enterprise_profile.md', confidence: 'high' },
      { constraint_description: 'Competitive pressure from national plans across California, Nevada, Oregon, Hawaii markets', source: 'meridian-data/01_enterprise_profile/enterprise_profile.md', confidence: 'high' },
    ],
    influentialVoices: [
      { voice_description: 'Regularly partners with Dr. Marcus Reid (Chief Physician Executive) and Dr. Lakshmi Venkatesan (plan CMO) on utilization-management and formulary decisions', source: 'meridian-data/02_org_structure/executive_bench.json' },
    ],
    abarvaRelationshipHistory: {},
    sourceMaterial: [
      { source_type: 'data_room', source_reference: 'meridian-data/02_org_structure/executive_bench.json · person:meridian:thomas-hartwell', ingestion_date: '2026-05-10', confidence: 'high' },
    ],
    reasoningScopeId: 'exec_profile_scope_meridian_tenant',
    disclosureScopeId: 'exec_profile_scope_meridian_tenant',
    profileUseStatement: 'Composite-tenant personalization for Meridian payer-side conversations, MA quality planning, and executive sponsor briefings.',
    ...
    humanReviewedBy: 'cursor-agent',
    humanReviewedAt: '2026-05-10T15:00:00Z',
    confidence: 'high',
    metadata: { source_spec: 'meridian-data/01_enterprise_profile/enterprise_profile.md' },
    careerHistory: [
      {
        id: '44f79e6e-749f-494b-9561-d36f8f229f24',
        ordinal: 1,
        role: 'Senior health-plan leader',
        company: 'Meridian Health Plans (prior role)',
        tenureStart: '2018-01-01',
        tenureEnd: '2020-01-01',
        notableAccomplishments: ['Built commercial and Medicare Advantage operating depth before assuming the President role'],
    ...
    personaOverrides: {
      ...
      specificFramesToOpenWith: ['clinical-financial integration', 'payer-side MA economics'],
      topicsToLeadWith: ['MA quality and STAR ratings', 'member retention', 'health-plan-provider economics'],
      sensitivitiesToAcknowledge: ['HIPAA compliance as baseline', 'CMS MA rate pressure', 'member economics'],
