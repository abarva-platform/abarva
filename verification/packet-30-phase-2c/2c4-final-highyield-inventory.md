...
- Generated at: `2026-05-29T22:44:19.193Z`
- Total files in inventory: `287`
- Files with import-helper matches: `10`
- Import-helper matches: `29`
- Files with broad matches: `287`
- Broad matches: `830`
...
| src/app/api/v1/source/[eventId]/artifacts/generate/route.ts | MIXED_READ_WRITE | api_routes | 3 | 7 | source_events | - |
...
| src/app/api/v1/source/[eventId]/artifacts/[artifactCode]/body/route.ts | MIXED_READ_WRITE | api_routes | 0 | 3 | source_event_artifact_states, source_events | - |
| src/app/api/notifications/dispatch/route.ts | MIXED_READ_WRITE | api_routes | 0 | 2 | platform_notification_deliveries | - |
| src/app/api/v1/threads/[threadId]/attach/route.ts | MIXED_READ_WRITE | api_routes | 0 | 2 | engagements, intelligence_threads | - |
...
| src/lib/intelligence/ask/session-memory.ts | MIXED_READ_WRITE | intelligence | 0 | 11 | intelligence_ask_sessions, intelligence_ask_turns, move_instances | - |
...
| src/lib/intelligence/synthesis/violationsSupabaseBackend.ts | MIXED_READ_WRITE | intelligence | 0 | 2 | agent_quality_violation_events | - |
...
| src/lib/deliverables/v2-generator.ts | MIXED_READ_WRITE | other_lib | 0 | 11 | deliverable_types, deliverable_versions, deliverables_v2, engagement_topics, engagement_topics_map, engagements, persons | - |
| src/lib/nexus/gateLifecycle.ts | MIXED_READ_WRITE | other_lib | 0 | 10 | deliverable_types, deliverable_versions, deliverables_v2, engagements, module_state_log, persons | - |
| src/lib/agent/tools/program/commitProgram.ts | MIXED_READ_WRITE | other_lib | 0 | 9 | engagement_participants, engagements, module_state_log, pattern_match_logs, persons, program_approval_requests | delete method present; may be Array.delete or Supabase delete |
...
| src/lib/decisions/auto-linker.ts | MIXED_READ_WRITE | other_lib | 0 | 8 | decision_thread_links, decision_threads | - |
| src/lib/topics/db.ts | MIXED_READ_WRITE | other_lib | 0 | 8 | engagement_topics, engagement_topics_map | delete method present; may be Array.delete or Supabase delete |
| src/lib/deliverables/generate.ts | MIXED_READ_WRITE | other_lib | 0 | 7 | engagements | - |
...
| src/lib/security/quarantine-audit-supabase.ts | MIXED_READ_WRITE | other_lib | 0 | 5 | sensitive_upload_audit | - |
| src/lib/billing/stripe.ts | MIXED_READ_WRITE | other_lib | 0 | 4 | clients, engagements, invoices | - |
...
| src/lib/deliverables/live-sync.ts | MIXED_READ_WRITE | other_lib | 0 | 4 | deliverable_versions, deliverables_v2 | - |
| src/lib/evidence/ledger.ts | MIXED_READ_WRITE | other_lib | 0 | 4 | evidence_ledger | - |
| src/lib/agent/maestro-extractor.ts | MIXED_READ_WRITE | other_lib | 0 | 3 | persons | - |
| src/lib/agent/tools/program/assignSponsor.ts | MIXED_READ_WRITE | other_lib | 0 | 3 | engagement_participants | - |
...
| src/lib/rls/rls-audit.ts | MIXED_READ_WRITE | other_lib | 0 | 3 | admin_audit_log, clients | - |
| src/lib/agent/tools/program/completeProgram.ts | MIXED_READ_WRITE | other_lib | 0 | 2 | engagements, module_state_log | - |
...
| src/lib/notifications/store.ts | MIXED_READ_WRITE | other_lib | 0 | 2 | platform_notification_events | - |
| src/lib/workshops/render.ts | MIXED_READ_WRITE | other_lib | 0 | 2 | - | no static table names detected |
| src/lib/agent/tools/program/completeModule.ts | MIXED_READ_WRITE | other_lib | 0 | 1 | program_modules | - |
| src/lib/agent/tools/program/registerPlaceholderPerson.ts | MIXED_READ_WRITE | other_lib | 0 | 1 | persons | - |
| src/lib/agent/tools/source/commitSourceEvent.ts | MIXED_READ_WRITE | other_lib | 0 | 1 | source_event_participants | - |
| src/lib/agent/trace.ts | MIXED_READ_WRITE | other_lib | 0 | 1 | turn_traces | - |
| src/lib/artifacts/repository.ts | MIXED_READ_WRITE | other_lib | 0 | 1 | generated_artifacts | - |
| src/lib/audit/log.ts | MIXED_READ_WRITE | other_lib | 0 | 1 | audit_log | - |
...
| src/lib/integrations/ai-egress/supabase-audit.ts | MIXED_READ_WRITE | other_lib | 0 | 1 | ai_egress_audit | - |
...
| src/lib/source/queries.ts | MIXED_READ_WRITE | source | 3 | 8 | source-artifacts, source_event_artifact_states, source_event_evidence_states, source_event_gate_criterion_states, source_events | - |
...
| src/lib/tower/ingest-portfolio.ts | MIXED_READ_WRITE | tower | 0 | 1 | use_cases | - |
| src/lib/tower/outcome-context-writeback/persist.ts | MIXED_READ_WRITE | tower | 0 | 1 | - | no static table names detected |
...
| src/lib/pilot-dashboard/aggregates.ts | READ_WITH_STORAGE | other_lib | 0 | 1 | turn_traces | - |
| src/lib/security/quarantine-audit-data-plane.ts | READ_WITH_STORAGE | other_lib | 0 | 1 | - | no static table names detected |
