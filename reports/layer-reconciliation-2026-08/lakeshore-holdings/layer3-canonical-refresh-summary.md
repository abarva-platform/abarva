# Layer 3 canonical refresh — lakeshore-holdings

Mode: draft preparation only. No production canonical store was written.
Active root at generation: `datasets/tenant-inputs/active/lakeshore-holdings/current`
...
| Relationship rows use canonical relationship types                        | `NOT_VERIFIED` | 12_relationships carries 364 row(s); the canonical relationship dictionary lives in intelligence_v6.relationship_types and was not read (no data-plane access in this lane).                                                       |
...
| Money, counts, and metrics are deterministic and not model-invented       | `FAIL`         | 2 conflicting or divergent claim(s); see claim-reconciliation-matrix.csv.                                                                                                                                                          |
| Duplicate/conflicting claims are blocked pending reconciliation           | `PASS`         | 2 claim(s) recorded as blocked in the governed package blocked_claims.csv.                                                                                                                                                         |
...
| `01_business_functions.csv`             | `01_business_functions.csv`             | yes          |        14 |                        0 |
| `02_org_ownership.csv`                  | `02_org_ownership.csv`                  | yes          |         8 |                        0 |
| `03_workforce_roles.csv`                | `03_workforce_roles.csv`                | yes          |        10 |                        0 |
| `04_applications_systems.csv`           | `04_applications_systems.csv`           | yes          |        24 |                        0 |
| `05_data_assets_integrations.csv`       | `05_data_assets_integrations.csv`       | yes          |        34 |                        0 |
...
| `08_spend_value.csv`                    | `08_spend_value.csv`                    | yes          |        86 |                        0 |
| `09_programs_initiatives.csv`           | `09_programs_initiatives.csv`           | yes          |        15 |                        0 |
| `10_ai_automation_use_cases.csv`        | `10_ai_automation_use_cases.csv`        | yes          |         8 |                        0 |
| `11_risks_controls.csv`                 | `11_risks_controls.csv`                 | yes          |        10 |                        0 |
| `12_relationships.csv`                  | `12_relationships.csv`                  | yes          |       364 |                        0 |
| `13_evidence_sources.csv`               | `13_evidence_sources.csv`               | yes          |         9 |                        0 |
| `14_metrics_outcomes.csv`               | `14_metrics_outcomes.csv`               | yes          |        12 |                        0 |
| `15_industry_context_patterns.csv`      | `15_industry_context_patterns.csv`      | yes          |         4 |                        0 |
| `16_expert_lenses.csv`                  | `16_expert_lenses.csv`                  | yes          |         4 |                        0 |
