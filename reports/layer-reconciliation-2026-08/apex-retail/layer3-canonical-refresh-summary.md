# Layer 3 canonical refresh — apex-retail

Mode: draft preparation only. No production canonical store was written.
Active root at generation: `datasets/tenant-inputs/active/apex-retail/current`
...
| Relationship rows use canonical relationship types | `NOT_VERIFIED` | 12_relationships carries 1713 row(s); the canonical relationship dictionary lives in intelligence_v6.relationship_types and was not read (no data-plane access in this lane). |
...
| `01_business_functions.csv` | `01_business_functions.csv` | yes | 26 | 0 |
| `02_org_ownership.csv` | `02_org_ownership.csv` | yes | 50 | 0 |
| `03_workforce_roles.csv` | `03_workforce_roles.csv` | yes | 12 | 0 |
| `04_applications_systems.csv` | `04_applications_systems.csv` | yes | 122 | 0 |
| `05_data_assets_integrations.csv` | `05_data_assets_integrations.csv` | yes | 235 | 0 |
| `06_infrastructure_platforms.csv` | `06_infrastructure_platforms.csv` | yes | 0 | 0 |
| `07_vendors_contracts.csv` | `07_vendors_contracts.csv` | yes | 100 | 0 |
| `08_spend_value.csv` | `08_spend_value.csv` | yes | 8 | 0 |
| `09_programs_initiatives.csv` | `09_programs_initiatives.csv` | yes | 80 | 0 |
| `10_ai_automation_use_cases.csv` | `10_ai_automation_use_cases.csv` | yes | 58 | 0 |
| `11_risks_controls.csv` | `11_risks_controls.csv` | yes | 135 | 0 |
| `12_relationships.csv` | `12_relationships.csv` | yes | 1713 | 0 |
| `13_evidence_sources.csv` | `13_evidence_sources.csv` | yes | 9 | 0 |
| `14_metrics_outcomes.csv` | `14_metrics_outcomes.csv` | yes | 108 | 0 |
| `15_industry_context_patterns.csv` | `15_industry_context_patterns.csv` | yes | 107 | 0 |
