...
| Money, counts, and metrics are deterministic and not model-invented | `FAIL` | 11 conflicting or divergent claim(s); see claim-reconciliation-matrix.csv. |
| Duplicate/conflicting claims are blocked pending reconciliation | `PASS` | 11 claim(s) recorded as blocked in the governed package blocked_claims.csv. |
