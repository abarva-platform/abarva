# Home Knowledge Full Cutover Proof
...
- Default Home uses Knowledge Layer: true
- Hidden preview only: false
- Legacy fallback still present: true
- Home/aVa Claude runtime changed: false
...
- getModuleContext first: true
- Supplier packet passed to HomeSurface: true
- Required tabs present: true
