# Airline Demo Synthetic Context Generation
...
- Source/template rows: 4,840
- Executive interview rows: 216
- Canonical records: 4,840
- Canonical facts: 9,680
- Entity profiles: 1,100
- Graph nodes: 1,600
- Graph edges: 2,600
- Context gaps: 2,100
- Evidence references: 140
