...
| Every fact carries source file / source row / evidence id where available | `PARTIAL`      | 13_evidence_sources carries 27 row(s); per-row evidence linkage is not verified by this script.                                                                                                                                                                             |
...
| Money, counts, and metrics are deterministic and not model-invented       | `FAIL`         | 24 conflicting or divergent claim(s); see claim-reconciliation-matrix.csv.                                                                                                                                                                                                  |
| Duplicate/conflicting claims are blocked pending reconciliation           | `PASS`         | 24 claim(s) recorded as blocked in the governed package blocked_claims.csv.                                                                                                                                                                                                 |
...
| `02_org_ownership.csv`                  | `02_org_ownership.csv`                  | yes          |       225 |                        0 |
| `03_workforce_roles.csv`                | `03_workforce_roles.csv`                | yes          |        45 |                        0 |
| `04_applications_systems.csv`           | `04_applications_systems.csv`           | yes          |       301 |                        0 |
...
| `07_vendors_contracts.csv`              | `07_vendors_contracts.csv`              | yes          |        72 |                        0 |
...
| `13_evidence_sources.csv`               | `13_evidence_sources.csv`               | yes          |        27 |                        0 |
