...
| Every fact carries source file / source row / evidence id where available | `PARTIAL`      | 13_evidence_sources carries 183 row(s); per-row evidence linkage is not verified by this script.                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| `02_org_ownership.csv`                  | `02_org_ownership.csv`                  | yes          |       153 |                        0 |
...
| `13_evidence_sources.csv`               | `13_evidence_sources.csv`               | yes          |       183 |                        0 |
