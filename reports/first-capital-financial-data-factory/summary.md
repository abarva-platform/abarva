...
- Template guidance and data dictionaries generated under `templates/first-capital-financial/`.
- Interview support files generated under `datasets/tenant-inputs/first-capital-financial/interviews/`.
...
- AbarVa-facing display label: FS Demo.
