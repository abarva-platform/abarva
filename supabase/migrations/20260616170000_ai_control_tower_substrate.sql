-- AI Control Tower substrate v1
--
-- Generic, client-scoped persistence for monthly AI Control Tower refreshes.
-- This complements the older Tower tables (`use_cases`, `tower_ai_tool_usage`,
-- `tower_dora_metrics`, etc.) with a stable substrate that can be populated
-- from workbook templates, API connectors, admin edits, Source events, and
-- Move events across every demo/client tenant.
