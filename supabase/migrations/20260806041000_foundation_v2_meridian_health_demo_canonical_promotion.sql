-- Meridian Health demo isolated Layer 3 canonical promotion substrate.
--
-- Scope:
--   Adds Meridian Health-only canonical promotion proof tables. These tables distinguish
...
CREATE TABLE IF NOT EXISTS foundation_v2_meridian_health_demo.canonical_entities (
...
CREATE TABLE IF NOT EXISTS foundation_v2_meridian_health_demo.canonical_promotion_decisions (
  ...
  FOREIGN KEY (candidate_id, tenant_key, test_namespace)
    REFERENCES foundation_v2_meridian_health_demo.knowledge_candidates(candidate_id, tenant_key, test_namespace)
    ON DELETE RESTRICT,
  FOREIGN KEY (source_record_id, tenant_key, test_namespace)
    REFERENCES foundation_v2_meridian_health_demo.source_records(source_record_id, tenant_key, test_namespace)
    ON DELETE RESTRICT,
...
GRANT SELECT, INSERT ON foundation_v2_meridian_health_demo.canonical_relationships TO foundation_v2_meridian_health_demo_writer;
GRANT SELECT, INSERT ON foundation_v2_meridian_health_demo.canonical_evidence_records TO foundation_v2_meridian_health_demo_writer;
GRANT SELECT, INSERT ON foundation_v2_meridian_health_demo.event_native_records TO foundation_v2_meridian_health_demo_writer;
GRANT SELECT, INSERT ON foundation_v2_meridian_health_demo.canonical_promotion_decisions TO foundation_v2_meridian_health_demo_writer;

GRANT SELECT ON foundation_v2_meridian_health_demo.canonical_entities TO foundation_v2_meridian_health_demo_reader;
GRANT SELECT ON foundation_v2_meridian_health_demo.canonical_observations TO foundation_v2_meridian_health_demo_reader;
GRANT SELECT ON foundation_v2_meridian_health_demo.canonical_relationships TO foundation_v2_meridian_health_demo_reader;
GRANT SELECT ON foundation_v2_meridian_health_demo.canonical_evidence_records TO foundation_v2_meridian_health_demo_reader;
GRANT SELECT ON foundation_v2_meridian_health_demo.event_native_records TO foundation_v2_meridian_health_demo_reader;
GRANT SELECT ON foundation_v2_meridian_health_demo.canonical_promotion_decisions TO foundation_v2_meridian_health_demo_reader;
...
DROP POLICY IF EXISTS meridian_health_demo_select ON foundation_v2_meridian_health_demo.canonical_entities;
CREATE POLICY meridian_health_demo_select ON foundation_v2_meridian_health_demo.canonical_entities
  FOR SELECT TO foundation_v2_meridian_health_demo_writer, foundation_v2_meridian_health_demo_reader
  USING (tenant_key='meridian_health_global'
...
CREATE POLICY meridian_health_demo_insert ON foundation_v2_meridian_health_demo.canonical_entities
  FOR INSERT TO foundation_v2_meridian_health_demo_writer
  WITH CHECK (tenant_key='meridian_health_global'
    AND current_setting('app.tenant_key', true)='meridian_health_global'
    AND test_namespace='meridian-health-source-volume-v1'
    AND current_setting('app.foundation_v2_test_namespace', true)='meridian-health-source-volume-v1'
    AND source_release_id='meridian-health-source-v1-202608:source-volume-v1:447910ac3c16'
...
CREATE POLICY meridian_health_demo_select ON foundation_v2_meridian_health_demo.canonical_observations
  FOR SELECT TO foundation_v2_meridian_health_demo_writer, foundation_v2_meridian_health_demo_reader
  USING (tenant_key='meridian_health_global'
    AND current_setting('app.tenant_key', true)='meridian_health_global'
    AND test_namespace='meridian-health-source-volume-v1'
...
CREATE POLICY meridian_health_demo_insert ON foundation_v2_meridian_health_demo.canonical_observations
  FOR INSERT TO foundation_v2_meridian_health_demo_writer
  WITH CHECK (tenant_key='meridian_health_global'
    AND current_setting('app.tenant_key', true)='meridian_health_global'
    AND test_namespace='meridian-health-source-volume-v1'
...
CREATE POLICY meridian_health_demo_select ON foundation_v2_meridian_health_demo.canonical_relationships
  FOR SELECT TO foundation_v2_meridian_health_demo_writer, foundation_v2_meridian_health_demo_reader
  USING (tenant_key='meridian_health_global'
    AND current_setting('app.tenant_key', true)='meridian_health_global'
    AND test_namespace='meridian-health-source-volume-v1'
...
CREATE POLICY meridian_health_demo_insert ON foundation_v2_meridian_health_demo.canonical_relationships
  FOR INSERT TO foundation_v2_meridian_health_demo_writer
  WITH CHECK (tenant_key='meridian_health_global'
    AND current_setting('app.tenant_key', true)='meridian_health_global'
    AND test_namespace='meridian-health-source-volume-v1'
...
CREATE POLICY meridian_health_demo_select ON foundation_v2_meridian_health_demo.canonical_evidence_records
  FOR SELECT TO foundation_v2_meridian_health_demo_writer, foundation_v2_meridian_health_demo_reader
  USING (tenant_key='meridian_health_global'
    AND current_setting('app.tenant_key', true)='meridian_health_global'
    AND test_namespace='meridian-health-source-volume-v1'
...
CREATE POLICY meridian_health_demo_insert ON foundation_v2_meridian_health_demo.canonical_evidence_records
  FOR INSERT TO foundation_v2_meridian_health_demo_writer
  WITH CHECK (tenant_key='meridian_health_global'
    AND current_setting('app.tenant_key', true)='meridian_health_global'
    AND test_namespace='meridian-health-source-volume-v1'
...
CREATE POLICY meridian_health_demo_select ON foundation_v2_meridian_health_demo.event_native_records
  FOR SELECT TO foundation_v2_meridian_health_demo_writer, foundation_v2_meridian_health_demo_reader
  USING (tenant_key='meridian_health_global'
    AND current_setting('app.tenant_key', true)='meridian_health_global'
    AND test_namespace='meridian-health-source-volume-v1'
...
CREATE POLICY meridian_health_demo_insert ON foundation_v2_meridian_health_demo.event_native_records
  FOR INSERT TO foundation_v2_meridian_health_demo_writer
  WITH CHECK (tenant_key='meridian_health_global'
    AND current_setting('app.tenant_key', true)='meridian_health_global'
    AND test_namespace='meridian-health-source-volume-v1'
...
CREATE POLICY meridian_health_demo_select ON foundation_v2_meridian_health_demo.canonical_promotion_decisions
  FOR SELECT TO foundation_v2_meridian_health_demo_writer, foundation_v2_meridian_health_demo_reader
  USING (tenant_key='meridian_health_global'
    AND current_setting('app.tenant_key', true)='meridian_health_global'
    AND test_namespace='meridian-health-source-volume-v1'
...
CREATE POLICY meridian_health_demo_insert ON foundation_v2_meridian_health_demo.canonical_promotion_decisions
  FOR INSERT TO foundation_v2_meridian_health_demo_writer
  WITH CHECK (tenant_key='meridian_health_global'
    AND current_setting('app.tenant_key', true)='meridian_health_global'
    AND test_namespace='meridian-health-source-volume-v1'
...
COMMENT ON TABLE foundation_v2_meridian_health_demo.canonical_entities IS
  'Meridian Health demo Layer 3 isolated canonical master entities.';
COMMENT ON TABLE foundation_v2_meridian_health_demo.canonical_observations IS
  'Meridian Health demo Layer 3 transactional and metric observations.';
COMMENT ON TABLE foundation_v2_meridian_health_demo.canonical_relationships IS
  'Meridian Health demo Layer 3 evidence-backed relationships.';
COMMENT ON TABLE foundation_v2_meridian_health_demo.canonical_evidence_records IS
  'Meridian Health demo Layer 3 accepted evidence span records.';
COMMENT ON TABLE foundation_v2_meridian_health_demo.event_native_records IS
  'Meridian Health demo Layer 3 sourcing-event-native records.';
COMMENT ON TABLE foundation_v2_meridian_health_demo.canonical_promotion_decisions IS
  'Meridian Health demo Layer 3 one-row-per-candidate deterministic promotion decisions.';
