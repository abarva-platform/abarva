-- PHS Healthcare demo isolated Layer 2 adapter/candidate substrate.
--
-- Scope:
--   Adds PHS-only normalized adapter outputs and candidate staging tables.
...
CREATE TABLE IF NOT EXISTS foundation_v2_phs_demo.normalized_objects (
...
CREATE TABLE IF NOT EXISTS foundation_v2_phs_demo.knowledge_candidates (
  ...
  FOREIGN KEY (normalized_object_id, tenant_key, test_namespace)
    REFERENCES foundation_v2_phs_demo.normalized_objects(normalized_object_id, tenant_key, test_namespace)
    ON DELETE RESTRICT,
  FOREIGN KEY (source_record_id, tenant_key, test_namespace)
    REFERENCES foundation_v2_phs_demo.source_records(source_record_id, tenant_key, test_namespace)
    ON DELETE RESTRICT,
...
GRANT SELECT, INSERT ON foundation_v2_phs_demo.normalized_objects TO foundation_v2_phs_demo_writer;
GRANT SELECT, INSERT ON foundation_v2_phs_demo.knowledge_candidates TO foundation_v2_phs_demo_writer;
GRANT SELECT ON foundation_v2_phs_demo.normalized_objects TO foundation_v2_phs_demo_reader;
GRANT SELECT ON foundation_v2_phs_demo.knowledge_candidates TO foundation_v2_phs_demo_reader;

ALTER TABLE foundation_v2_phs_demo.normalized_objects ENABLE ROW LEVEL SECURITY;
ALTER TABLE foundation_v2_phs_demo.normalized_objects FORCE ROW LEVEL SECURITY;
ALTER TABLE foundation_v2_phs_demo.knowledge_candidates ENABLE ROW LEVEL SECURITY;
ALTER TABLE foundation_v2_phs_demo.knowledge_candidates FORCE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS phs_demo_select ON foundation_v2_phs_demo.normalized_objects;
CREATE POLICY phs_demo_select ON foundation_v2_phs_demo.normalized_objects
  FOR SELECT
...
DROP POLICY IF EXISTS phs_demo_insert ON foundation_v2_phs_demo.normalized_objects;
CREATE POLICY phs_demo_insert ON foundation_v2_phs_demo.normalized_objects
  FOR INSERT
...
DROP POLICY IF EXISTS phs_demo_select ON foundation_v2_phs_demo.knowledge_candidates;
CREATE POLICY phs_demo_select ON foundation_v2_phs_demo.knowledge_candidates
  FOR SELECT
  TO foundation_v2_phs_demo_writer, foundation_v2_phs_demo_reader
  USING (
    tenant_key = 'phs_health_demo_global'
...
DROP POLICY IF EXISTS phs_demo_insert ON foundation_v2_phs_demo.knowledge_candidates;
CREATE POLICY phs_demo_insert ON foundation_v2_phs_demo.knowledge_candidates
  FOR INSERT
  TO foundation_v2_phs_demo_writer
  WITH CHECK (
    tenant_key = 'phs_health_demo_global'
...
COMMENT ON TABLE foundation_v2_phs_demo.normalized_objects IS
  'PHS Healthcare demo Layer 2 normalized adapter outputs; isolated candidates only.';

COMMENT ON TABLE foundation_v2_phs_demo.knowledge_candidates IS
  'PHS Healthcare demo candidate staging rows; not canonical promotion or product activation.';
