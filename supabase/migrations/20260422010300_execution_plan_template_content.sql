    ...
    "sections": [
      {
        ...
        "example_completed": "Target: reduce associate task-search time by 20% within the pilot cohort while improving same-store sales conversion and preserving labor compliance."
      },
      {
        ...
        "example_completed": "Within 30 days, the pilot stores should have workflow routing live, manager exception review active, and telemetry arriving daily for baseline comparison."
      },
      {
        ...
        "example_completed": "Workstreams: pilot configuration, store enablement, KPI instrumentation, policy approvals, and vendor delivery governance; each has a single named owner."
      },
      {
        ...
        "example_completed": "Milestones: design lock, pilot launch, first KPI review, wave-two scale decision, and verification checkpoint with explicit dates."
      },
      {
        ...
        "example_completed": "Critical path runs through device readiness, API access, manager enablement, and vendor configuration; labor-policy sign-off is the gating external dependency."
      },
      {
        "key": "risk_register",
        "title": "Risk Register",
        ...
        "example_completed": "Top risks: field-manager resistance, incomplete telemetry, and pilot-store staffing volatility. Each has a mitigation owner and escalation trigger."
      },
      {
        ...
        "example_completed": "Weekly workstream stand-up, biweekly sponsor review, and same-day escalation for timeline, cost, or labor-policy drift."
      },
      {
        ...
        "example_completed": "Execute is ready pending one remaining manager-enablement sign-off and two outstanding API credentials; all other start conditions are met."
      }
    ],
    "format": "markdown",
