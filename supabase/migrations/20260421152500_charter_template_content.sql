-- Migration 20260421152500 · charter deliverable template content
--
-- Why: seed a complete, sponsor-ready Program Charter template for deliverable_type
--       `charter`, including the prompt template and quality rubric needed by the
--       v2 generation pipeline.
-- Safety: additive-only, idempotent upsert, safe to replay on preview branches.
-- Depends on: deliverable_types (created in migration 040)
...
VALUES (
  'charter',
  'Program Charter',
  'Sponsor-ready program charter with scope, governance, milestones, and risk framing',
  ARRAY[1, 2],
  ARRAY[
  ...
  '{
    "sections": [
      ...
      },
      {
        ...
        "example_completed": "Returns costs have climbed to $41M annually, contact center wait times are rising, and leadership wants a single program that reduces avoidable volume before peak season."
      },
      {
        ...
        "example_completed": "Reduce avoidable contacts by 25%, cut average handle time by 15%, and show sponsor sign-off that service quality did not regress."
      },
      {
        ...
        "example_completed": "In scope: tier-1 chat, voice triage, and reporting. Out of scope: full CRM replacement, enterprise data platform redesign, and back-office process re-engineering."
      },
      {
      ...
      },
      {
        ...
        "example_completed": "Weekly working review, biweekly sponsor check-in, monthly steering review, and same-day escalation for scope, budget, or risk changes."
      },
      {
        "key": "key_risks",
        "title": "Key Risks",
        ...
        "example_completed": "Risks include sponsor drift, data access lag, change fatigue, and vendor dependency. Mitigations include named owners, milestone guards, and escalation thresholds."
      }
    ],
    "format": "markdown",
    "rendering_notes": "Preserve the section order exactly. Each section should render as markdown with a short explanation and a concrete completed example."
  }'::jsonb,
  '{
    "engagement": [
  ...
  '[
    ...
    },
    {
      ...
      "rationale": "Every factual claim, date, number, stakeholder name, and scope statement must be traceable to the intake conversation or clearly marked as a gap.",
      "severity": "blocker"
    },
    {
      "criterion": "sponsor_and_scope_specificity",
      "rationale": "The charter should name the sponsor and co-sponsor, describe the business context, and distinguish in-scope from out-of-scope work without generic filler.",
      "severity": "major"
    },
    {
      "criterion": "success_criteria_are_measurable",
      "rationale": "Success criteria need to be concrete enough that Verify can prove them later; vague aspirations do not support an accountable program.",
      "severity": "major"
    },
    {
      "criterion": "milestones_have_real_dates",
      "rationale": "Diagnose, Design, Execute, and Verify milestones must include explicit dates and sequence logically so the charter can be operationalized.",
      "severity": "major"
    },
    {
      "criterion": "risks_are_actionable",
      "rationale": "Risks should be specific to the program and paired with a mitigation, owner, or watchpoint instead of repeating generic project-management language.",
      "severity": "minor"
    }
  ]'::jsonb,
  $charter$
You are drafting a Program Charter in Markdown.
