...
CREATE TABLE IF NOT EXISTS foundation_v2_phs_demo.event_context_snapshots (
...
CREATE TABLE IF NOT EXISTS foundation_v2_phs_demo.projection_authority (
...
CREATE TABLE IF NOT EXISTS foundation_v2_phs_demo.projection_rows (
  ...
  FOREIGN KEY (projection_authority_id, tenant_key, test_namespace)
    REFERENCES foundation_v2_phs_demo.projection_authority(projection_authority_id, tenant_key, test_namespace)
    ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS foundation_v2_phs_demo.projection_field_lineage (
  ...
  FOREIGN KEY (projection_row_id, tenant_key, test_namespace)
    REFERENCES foundation_v2_phs_demo.projection_rows(projection_row_id, tenant_key, test_namespace)
    ON DELETE RESTRICT,
  ...
  FOREIGN KEY (source_field_value_id, tenant_key, test_namespace)
    REFERENCES foundation_v2_phs_demo.source_field_values(source_field_value_id, tenant_key, test_namespace)
    ON DELETE RESTRICT,
...
CREATE INDEX IF NOT EXISTS idx_phs_l4_projection_authority_name
  ON foundation_v2_phs_demo.projection_authority (tenant_key, test_namespace, projection_namespace, projection_name);
CREATE INDEX IF NOT EXISTS idx_phs_l4_projection_rows_authority
  ON foundation_v2_phs_demo.projection_rows (tenant_key, test_namespace, projection_authority_id);
CREATE INDEX IF NOT EXISTS idx_phs_l4_projection_rows_business
  ON foundation_v2_phs_demo.projection_rows (tenant_key, test_namespace, projection_namespace, projection_name, business_grain, business_key);
CREATE INDEX IF NOT EXISTS idx_phs_l4_projection_lineage_row
  ON foundation_v2_phs_demo.projection_field_lineage (tenant_key, test_namespace, projection_row_id);

GRANT SELECT, INSERT, DELETE ON foundation_v2_phs_demo.event_context_snapshots TO foundation_v2_phs_demo_writer;
GRANT SELECT, INSERT, DELETE ON foundation_v2_phs_demo.projection_authority TO foundation_v2_phs_demo_writer;
GRANT SELECT, INSERT, DELETE ON foundation_v2_phs_demo.projection_rows TO foundation_v2_phs_demo_writer;
GRANT SELECT, INSERT, DELETE ON foundation_v2_phs_demo.projection_field_lineage TO foundation_v2_phs_demo_writer;

GRANT SELECT ON foundation_v2_phs_demo.event_context_snapshots TO foundation_v2_phs_demo_reader;
GRANT SELECT ON foundation_v2_phs_demo.projection_authority TO foundation_v2_phs_demo_reader;
GRANT SELECT ON foundation_v2_phs_demo.projection_rows TO foundation_v2_phs_demo_reader;
GRANT SELECT ON foundation_v2_phs_demo.projection_field_lineage TO foundation_v2_phs_demo_reader;
...
BEGIN
  FOREACH rel IN ARRAY ARRAY[
    'foundation_v2_phs_demo.event_context_snapshots'::regclass,
    'foundation_v2_phs_demo.projection_authority'::regclass,
    'foundation_v2_phs_demo.projection_rows'::regclass,
    'foundation_v2_phs_demo.projection_field_lineage'::regclass
  ]
  LOOP
...
COMMENT ON TABLE foundation_v2_phs_demo.event_context_snapshots IS
  'PHS Healthcare demo Layer 4 immutable event-context snapshots for sourcing events.';
COMMENT ON TABLE foundation_v2_phs_demo.projection_authority IS
  'PHS Healthcare demo Layer 4 typed projection authorities for governed consumption surfaces.';
COMMENT ON TABLE foundation_v2_phs_demo.projection_rows IS
  'PHS Healthcare demo Layer 4 typed business-grain projection rows; products must not read generic observations directly.';
COMMENT ON TABLE foundation_v2_phs_demo.projection_field_lineage IS
  'PHS Healthcare demo Layer 4 projection field lineage to source records, fields, canonical entities, relationships and evidence refs.';
