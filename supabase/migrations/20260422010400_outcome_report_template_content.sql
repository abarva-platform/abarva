    ...
    "sections": [
      {
        ...
        "example_completed": "The pilot met its core outcome target: associates recovered task time, conversion improved, and field leadership approved scaling to the next wave of stores."
      },
      {
        ...
        "example_completed": "Objective: 20% task-time reduction. Result: 23% reduction in pilot stores, with the largest gains in replenishment and exception handling."
      },
      {
        ...
        "example_completed": "Baseline vs actual: task-search time 23m → 17.7m, on-time replenishment 61% → 74%, same-store sales conversion +1.6 points in pilot cohort."
      },
      {
        "key": "value_realized",
        ...
        "example_completed": "Realized value: $4.2M annualized labor and sales impact, medium confidence pending a full seasonal cycle."
      },
      {
        "key": "what_worked",
        "title": "What Worked",
        ...
        "example_completed": "What worked: bounded pilot scope, strong store-manager championing, exception telemetry from day one, and weekly sponsor review discipline."
      },
      {
        ...
        "example_completed": "Gap: exception handling improved less than expected in smaller-format stores because device readiness lagged the pilot baseline."
      },
      {
        ...
        "example_completed": "Next actions: lock telemetry ownership, codify manager enablement, and stage a second-wave rollout to 180 stores only after device-readiness issues close."
      },
      {
        ...
        "example_completed": "Verification used four weeks of pilot telemetry and finance-reviewed labor assumptions; final scale decision requires CFO and Store Ops sponsor sign-off."
      }
    ],
    "format": "markdown",
